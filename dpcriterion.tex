...
Using the parameters $\sigma_m$, $\tau_m$, $a=-\sqrt{3}\tan\uptheta$, ${\III}_1({\bm \sigma})$ 
...
%\]
%and since $p=\frac{1}{3}{\III}_1({\bm \sigma})$:
%\begin{mdframed}[backgroundcolor=blue!5]
%\begin{equation}
...
Note that Saramito \cite{sara21} proposes a new brittle-elastoviscoplastic fluid 
based on the Drucker–Prager plasticity.
