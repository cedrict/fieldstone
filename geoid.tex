...
Geoid undulations = differences, in meters, between the geoid reference ellipsoid (= geoid ``height'').
...
{\captionfont Taken from \cite{mogu96}. 
Idealized 2D slab calculations for each viscosity model: geoid and geoid filtered 
