...
\verb"$ git remote add upstream https://github.com/cedrict/aspect"
...
\node[align=left] at (3.75,10.25) {Cedric's repository "upstream"\\ \footnotesize \verb"https://github.com/cedrict/aspect"};
