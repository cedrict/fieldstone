...
element type & $Q_2\times Q_1$ & && $Q_1\times P_0 - Q_1$& ? & $Q_1\times Q_1$-stab\\ 
mixed or penalty  & mixed & && mixed\\ 
matrix storage & full & && lil \\ 
...
Add. feature & & &&.&\\
\hline
Description & Burstedde benchmark \ref{mms3} & && Busse &\\ 
\hline
Status & OK & && ?&\\ 
\hline
\end{tabular}
...
\hline
geometry & Box & & \\ 
element type & $Q_1\times P_0$ \& $Q_2\times Q_1$ & \\ 
mixed or penalty  & mixed &  \\ 
matrix storage & full &  \\ 
outer solver (N.A., direct, SchurComp) & N.A. & \\ 
\hline
3 dimensions 			& . &  \\ 
compressible (Y/N)  		& . &  \\ 
...
\hline
Description & T-R instability \cite{vaks97} & \\
\hline
Status & OK &   \\
\hline
\end{tabular}
