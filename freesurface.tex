...
\begin{center}
\frame{\includegraphics[width=4.5cm]{images/freesurface/ball00}}
\frame{\includegraphics[width=4.5cm]{images/freesurface/ball01}}
\frame{\includegraphics[width=4.5cm]{images/freesurface/ball02}}\\
\frame{\includegraphics[width=4.5cm]{images/freesurface/ball03}}
\frame{\includegraphics[width=4.5cm]{images/freesurface/ball05}}
\frame{\includegraphics[width=4.5cm]{images/freesurface/ball07}}\\
\frame{\includegraphics[width=4.5cm]{images/freesurface/ball08}}
\frame{\includegraphics[width=4.5cm]{images/freesurface/ball09}}
\frame{\includegraphics[width=4.5cm]{images/freesurface/ball10}}\\
...
\todo[inline]{Anne says that in ASPECT Q1 functions are used and not Q2 ?}
