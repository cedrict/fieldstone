...
\begin{center}
\includegraphics[width=5cm]{images/meshes/guyr16}\\
{\captionfont 3D finite element grid in Damintun area, including prescribed faults. Guo et al, 2016 \cite{guyr16}.}
\end{center}
...
\begin{center}
\includegraphics[height=5cm]{images/meshes/vaks15}
\includegraphics[height=5cm]{images/meshes/depl96}
\includegraphics[height=5cm]{images/meshes/habo04}\\
\includegraphics[height=5cm]{images/meshes/kott05}
\includegraphics[height=5cm]{images/meshes/specfem}
{\captionfont 
From left to right: \cite{vaks15}; \cite{depl96}; \cite{habo04}; \cite{kott05}; Specfem manual}
\end{center}

\Literature: \cite{gari09,habo04,anbo09,nifo13,nifo13b}
...
This approach is used in Stone 67 (\ref{f67}).
...
the ying-yang grid \cite{kasa04,yoka04,yoka06,kaks08,tack08,crta14,crta16},
the ying-yang-zhong grid \cite{haka16}, the spiral grid \cite{hust08}, 
...
{\captionfont Taken from \cite{kaks08}}
\end{center}
