...
\begin{center}
\includegraphics[width=10cm]{images/thermal_expansion/civj17a}\\
{\captionfont Taken from \textcite{civj17}.}
\end{center}
...
\begin{center}
\includegraphics[width=6cm]{images/thermal_expansion/chbo92}\\
{\captionfont Taken from \textcite{chbo92}.}
\end{center}
