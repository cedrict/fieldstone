...
%.........................
\subsubsection{Relevant Python library code: Harmonica}

\url{https://www.fatiando.org/harmonica/v0.5.1/index.html}

It includes common processing steps, like calculation of Bouguer and 
terrain corrections, reduction to the pole, upward continuation, equivalent 
sources, and more. There are forward modeling functions for basic 
geometric shapes, like point sources, prisms and tesseroids.
