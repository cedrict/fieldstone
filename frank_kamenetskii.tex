...
$T\in[0,1]$):
At the surface, $T=0$, so that $\eta=\eta_0 \exp (A/2)$
and at the bottom $T=1$ so that $\eta=\eta_0 \exp (-A/2)$, and then 
the ratio is $\eta_0 \exp (A/2)/\eta_0 \exp (-A/2)=\exp (A) \simeq 10^4$.
