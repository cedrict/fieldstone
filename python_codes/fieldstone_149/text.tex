...
The Stokes equations are not solved: the velocity field is instead
prescribed analytically everywhere in the domain, using the corner flow solution 
in the mantle wedge (see \stone~\ref{f68}).
...
There is however a problem with this approach: the velocity is prescribed on the 
boundary and imposes an influx or outflux on parts of the boundary. 
Unfortunately, because of the discretised nature of the flow, the in/outflux
balance is not zero and this yields a solution that is often nonsensical.

\begin{center}
\includegraphics[width=8cm]{python_codes/fieldstone_149/results/case1b/diagT.pdf}
\includegraphics[width=8cm]{python_codes/fieldstone_149/results/case1b/diagP.pdf}\\
