...
if benchmark==5: # shortening block 2 
   rho=0
   cohesion=30e6
   phi=30./180*np.pi
   psi=0./180*np.pi
...
for iter in range(0,niter):
   ...
   for iel in range(0,nel):
       ...
       for jq in [0,1,2]:
           for iq in [0,1,2]:
               ...
               #if iter>5:
               #   etaq[counter]+=(etaq[counter]-etaq_mem[counter])*0.5
               #   if etaq[counter]>1e24:
               #      etaq[counter]=1e24
               #   if etaq[counter]<1e17:
               #      etaq[counter]=1e17
   ...
   if benchmark==4 or benchmark==5: #shortening block has p nullspace
