...
\begin{center}
\includegraphics[width=6cm]{python_codes/fieldstone_39/sr}
\includegraphics[width=6cm]{python_codes/fieldstone_39/etaeff}\\
{\small von Mises case, results with FieldStone, 144x36}
\end{center}
