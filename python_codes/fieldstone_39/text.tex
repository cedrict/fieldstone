...
\begin{center}
\includegraphics[width=.8\linewidth]{python_codes/fieldstone_39/velx}\\
\includegraphics[width=.8\linewidth]{python_codes/fieldstone_39/vely}\\
...
\begin{center}
\includegraphics[width=.8\linewidth]{python_codes/fieldstone_39/conv}
\end{center}
