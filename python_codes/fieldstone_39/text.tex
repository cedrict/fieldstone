...
\begin{flushright} {\tiny {\color{gray} python\_codes/fieldstone\_39/text.tex}} \end{flushright}

\par\noindent\rule{\textwidth}{0.4pt}

\begin{center}
\inpython
{\small Code: \url{https://github.com/cedrict/fieldstone/tree/master/python_codes/fieldstone_39}}
\end{center}
...
\begin{remark}
Outside of this stone, we note that the standard momentum equation contains 
the term $\vec\nabla \cdot (2 \eta \dot{\bm \varepsilon}^d$,
i.e. a term with the deviatoric strain rate.
In practice the  ${\bm C}$ matrix that should be used in any case is the ${\bm C}_{method\; 2}$.
When the flow is incompressible then the strain rate and deviatoric strain rate tensors are 
identical and then using ${\bm C}_{method\; 1}$ or ${\bm C}_{method\; 2}$ does not 
matter in practice. However, in this case it does matter!
\end{remark}


\newpage 
%..........................................................
\section*{Benchmark \#1 - The simple brick}
...
The 2D Cartesian domain is filled with a 
single rigid-plastic material characterised by a cohesion $c=10~\si{\mega\pascal}$, an 
angle of friction $\phi$, a dilation angle $\psi$ and a density $\rho=2800~\si{\kg\per\cubic\km}$.
...
The effective visco-viscoplastic viscosity is computed as follows:
\begin{lstlisting}
...
Three angles are mechanically stable (e.g. \textcite{kaus10}, 2010):
\begin{eqnarray}
\theta&=&\frac{\pi}{4}\pm \frac{\psi}{2} \qquad \text{Roscoe angle} \nn\\
\theta&=&\frac{\pi}{4}\pm \frac{\phi}{2} \qquad \text{Coulomb angle}\nn\\
\theta&=&\frac{\pi}{4}\pm \frac{\phi+\psi}{4} \qquad \text{Arthur angle}\nn
\end{eqnarray}
...
\newpage
\subsection*{Compression - nonlinear convergence}

\begin{center}
\includegraphics[width=.3\linewidth]{python_codes/fieldstone_39/results/benchmark1/compression/conv_phi0_psi0_etam0.pdf}
\includegraphics[width=.3\linewidth]{python_codes/fieldstone_39/results/benchmark1/compression/conv_phi30_psi0_etam0.pdf}
\includegraphics[width=.3\linewidth]{python_codes/fieldstone_39/results/benchmark1/compression/conv_phi30_psi30_etam0.pdf} \\
\includegraphics[width=.3\linewidth]{python_codes/fieldstone_39/results/benchmark1/compression/conv_phi0_psi0_etam18.pdf}
\includegraphics[width=.3\linewidth]{python_codes/fieldstone_39/results/benchmark1/compression/conv_phi30_psi0_etam18.pdf}
\includegraphics[width=.3\linewidth]{python_codes/fieldstone_39/results/benchmark1/compression/conv_phi30_psi30_etam18.pdf} \\
\includegraphics[width=.3\linewidth]{python_codes/fieldstone_39/results/benchmark1/compression/conv_phi0_psi0_etam19.pdf}
\includegraphics[width=.3\linewidth]{python_codes/fieldstone_39/results/benchmark1/compression/conv_phi30_psi0_etam19.pdf}
\includegraphics[width=.3\linewidth]{python_codes/fieldstone_39/results/benchmark1/compression/conv_phi30_psi30_etam19.pdf} \\
\includegraphics[width=.3\linewidth]{python_codes/fieldstone_39/results/benchmark1/compression/conv_phi0_psi0_etam20.pdf}
\includegraphics[width=.3\linewidth]{python_codes/fieldstone_39/results/benchmark1/compression/conv_phi30_psi0_etam20.pdf}
\includegraphics[width=.3\linewidth]{python_codes/fieldstone_39/results/benchmark1/compression/conv_phi30_psi30_etam20.pdf} \\
{\captionfont From left to right: von Mises ($\phi=\Psi=0$), non-associated Drucker-Prager ($\phi=30^o,\Psi=0$), 
associated Drucker-Prager ($\phi=\Psi=30$).\\ From top to bottom: $\eta_m=0,10^{18},10^{19},10^{20}$.}
\end{center}


\newpage
\subsection*{Compression - strain rate on line}

\begin{center}
\includegraphics[width=.3\linewidth]{python_codes/fieldstone_39/results/benchmark1/compression/line_sr_phi0_psi0_etam0.pdf}
\includegraphics[width=.3\linewidth]{python_codes/fieldstone_39/results/benchmark1/compression/line_sr_phi30_psi0_etam0.pdf}
\includegraphics[width=.3\linewidth]{python_codes/fieldstone_39/results/benchmark1/compression/line_sr_phi30_psi30_etam0.pdf}\\
\includegraphics[width=.3\linewidth]{python_codes/fieldstone_39/results/benchmark1/compression/line_sr_phi0_psi0_etam18.pdf}
\includegraphics[width=.3\linewidth]{python_codes/fieldstone_39/results/benchmark1/compression/line_sr_phi30_psi0_etam18.pdf}
\includegraphics[width=.3\linewidth]{python_codes/fieldstone_39/results/benchmark1/compression/line_sr_phi30_psi30_etam18.pdf}\\
\includegraphics[width=.3\linewidth]{python_codes/fieldstone_39/results/benchmark1/compression/line_sr_phi0_psi0_etam19.pdf}
\includegraphics[width=.3\linewidth]{python_codes/fieldstone_39/results/benchmark1/compression/line_sr_phi30_psi0_etam19.pdf}
\includegraphics[width=.3\linewidth]{python_codes/fieldstone_39/results/benchmark1/compression/line_sr_phi30_psi30_etam19.pdf}\\
\includegraphics[width=.3\linewidth]{python_codes/fieldstone_39/results/benchmark1/compression/line_sr_phi0_psi0_etam20.pdf}
\includegraphics[width=.3\linewidth]{python_codes/fieldstone_39/results/benchmark1/compression/line_sr_phi30_psi0_etam20.pdf}
\includegraphics[width=.3\linewidth]{python_codes/fieldstone_39/results/benchmark1/compression/line_sr_phi30_psi30_etam20.pdf}\\
{\captionfont From left to right: von Mises ($\phi=\Psi=0$), non-associated Drucker-Prager ($\phi=30^o,\Psi=0$), 
associated Drucker-Prager ($\phi=\Psi=30$).\\ From top to bottom: $\eta_m=0,10^{18},10^{19},10^{20}$.}
\end{center}
...
\newpage
\subsection*{Compression - viscosity on line}

\begin{center}
\includegraphics[width=.3\linewidth]{python_codes/fieldstone_39/results/benchmark1/compression/line_eta_phi0_psi0_etam0.pdf}
\includegraphics[width=.3\linewidth]{python_codes/fieldstone_39/results/benchmark1/compression/line_eta_phi30_psi0_etam0.pdf}
\includegraphics[width=.3\linewidth]{python_codes/fieldstone_39/results/benchmark1/compression/line_eta_phi30_psi30_etam0.pdf}\\
\includegraphics[width=.3\linewidth]{python_codes/fieldstone_39/results/benchmark1/compression/line_eta_phi0_psi0_etam18.pdf}
\includegraphics[width=.3\linewidth]{python_codes/fieldstone_39/results/benchmark1/compression/line_eta_phi30_psi0_etam18.pdf}
\includegraphics[width=.3\linewidth]{python_codes/fieldstone_39/results/benchmark1/compression/line_eta_phi30_psi30_etam18.pdf}\\
\includegraphics[width=.3\linewidth]{python_codes/fieldstone_39/results/benchmark1/compression/line_eta_phi0_psi0_etam19.pdf}
\includegraphics[width=.3\linewidth]{python_codes/fieldstone_39/results/benchmark1/compression/line_eta_phi30_psi0_etam19.pdf}
\includegraphics[width=.3\linewidth]{python_codes/fieldstone_39/results/benchmark1/compression/line_eta_phi30_psi30_etam19.pdf}\\
\includegraphics[width=.3\linewidth]{python_codes/fieldstone_39/results/benchmark1/compression/line_eta_phi0_psi0_etam20.pdf}
\includegraphics[width=.3\linewidth]{python_codes/fieldstone_39/results/benchmark1/compression/line_eta_phi30_psi0_etam20.pdf}
\includegraphics[width=.3\linewidth]{python_codes/fieldstone_39/results/benchmark1/compression/line_eta_phi30_psi30_etam20.pdf}\\
{\captionfont From left to right: von Mises ($\phi=\Psi=0$), non-associated Drucker-Prager ($\phi=30^o,\Psi=0$), 
associated Drucker-Prager ($\phi=\Psi=30$).\\ From top to bottom: $\eta_m=0,10^{18},10^{19},10^{20}$.}
\end{center}
...
\newpage
\subsection*{Compression - right shear band}

\begin{center}
\includegraphics[width=.3\linewidth]{python_codes/fieldstone_39/results/benchmark1/compression/shear_band_phi0_psi0_etam0.pdf}
\includegraphics[width=.3\linewidth]{python_codes/fieldstone_39/results/benchmark1/compression/shear_band_phi30_psi0_etam0.pdf}
\includegraphics[width=.3\linewidth]{python_codes/fieldstone_39/results/benchmark1/compression/shear_band_phi30_psi30_etam0.pdf}\\
\includegraphics[width=.3\linewidth]{python_codes/fieldstone_39/results/benchmark1/compression/shear_band_phi0_psi0_etam18.pdf}
\includegraphics[width=.3\linewidth]{python_codes/fieldstone_39/results/benchmark1/compression/shear_band_phi30_psi0_etam18.pdf}
\includegraphics[width=.3\linewidth]{python_codes/fieldstone_39/results/benchmark1/compression/shear_band_phi30_psi30_etam18.pdf}\\
\includegraphics[width=.3\linewidth]{python_codes/fieldstone_39/results/benchmark1/compression/shear_band_phi0_psi0_etam19.pdf}
\includegraphics[width=.3\linewidth]{python_codes/fieldstone_39/results/benchmark1/compression/shear_band_phi30_psi0_etam19.pdf}
\includegraphics[width=.3\linewidth]{python_codes/fieldstone_39/results/benchmark1/compression/shear_band_phi30_psi30_etam19.pdf}\\
\includegraphics[width=.3\linewidth]{python_codes/fieldstone_39/results/benchmark1/compression/shear_band_phi0_psi0_etam20.pdf}
\includegraphics[width=.3\linewidth]{python_codes/fieldstone_39/results/benchmark1/compression/shear_band_phi30_psi0_etam20.pdf}
\includegraphics[width=.3\linewidth]{python_codes/fieldstone_39/results/benchmark1/compression/shear_band_phi30_psi30_etam20.pdf}\\
{\captionfont From left to right: von Mises ($\phi=\Psi=0$), non-associated Drucker-Prager ($\phi=30^o,\Psi=0$), 
associated Drucker-Prager ($\phi=\Psi=30$).\\ From top to bottom: $\eta_m=0,10^{18},10^{19},10^{20}$.}
\end{center}
...
\newpage
\subsection*{Extension - nonlinear convergence}

\begin{center}
\includegraphics[width=.3\linewidth]{python_codes/fieldstone_39/results/benchmark1/extension/conv_phi0_psi0_etam0.pdf}
\includegraphics[width=.3\linewidth]{python_codes/fieldstone_39/results/benchmark1/extension/conv_phi30_psi0_etam0.pdf}
\includegraphics[width=.3\linewidth]{python_codes/fieldstone_39/results/benchmark1/extension/conv_phi30_psi30_etam0.pdf} \\
\includegraphics[width=.3\linewidth]{python_codes/fieldstone_39/results/benchmark1/extension/conv_phi0_psi0_etam18.pdf}
\includegraphics[width=.3\linewidth]{python_codes/fieldstone_39/results/benchmark1/extension/conv_phi30_psi0_etam18.pdf}
\includegraphics[width=.3\linewidth]{python_codes/fieldstone_39/results/benchmark1/extension/conv_phi30_psi30_etam18.pdf} \\
\includegraphics[width=.3\linewidth]{python_codes/fieldstone_39/results/benchmark1/extension/conv_phi0_psi0_etam19.pdf}
\includegraphics[width=.3\linewidth]{python_codes/fieldstone_39/results/benchmark1/extension/conv_phi30_psi0_etam19.pdf}
\includegraphics[width=.3\linewidth]{python_codes/fieldstone_39/results/benchmark1/extension/conv_phi30_psi30_etam19.pdf} \\
\includegraphics[width=.3\linewidth]{python_codes/fieldstone_39/results/benchmark1/extension/conv_phi0_psi0_etam20.pdf}
\includegraphics[width=.3\linewidth]{python_codes/fieldstone_39/results/benchmark1/extension/conv_phi30_psi0_etam20.pdf}
\includegraphics[width=.3\linewidth]{python_codes/fieldstone_39/results/benchmark1/extension/conv_phi30_psi30_etam20.pdf} \\
{\captionfont From left to right: von Mises ($\phi=\Psi=0$), non-associated Drucker-Prager ($\phi=30^o,\Psi=0$), 
associated Drucker-Prager ($\phi=\Psi=30$).\\ From top to bottom: $\eta_m=0,10^{18},10^{19},10^{20}$.}
\end{center}

\newpage
\subsection*{Extension - strain rate on line}

\begin{center}
\includegraphics[width=.3\linewidth]{python_codes/fieldstone_39/results/benchmark1/extension/line_sr_phi0_psi0_etam0.pdf}
\includegraphics[width=.3\linewidth]{python_codes/fieldstone_39/results/benchmark1/extension/line_sr_phi30_psi0_etam0.pdf}
\includegraphics[width=.3\linewidth]{python_codes/fieldstone_39/results/benchmark1/extension/line_sr_phi30_psi30_etam0.pdf}\\
\includegraphics[width=.3\linewidth]{python_codes/fieldstone_39/results/benchmark1/extension/line_sr_phi0_psi0_etam18.pdf}
\includegraphics[width=.3\linewidth]{python_codes/fieldstone_39/results/benchmark1/extension/line_sr_phi30_psi0_etam18.pdf}
\includegraphics[width=.3\linewidth]{python_codes/fieldstone_39/results/benchmark1/extension/line_sr_phi30_psi30_etam18.pdf}\\
\includegraphics[width=.3\linewidth]{python_codes/fieldstone_39/results/benchmark1/extension/line_sr_phi0_psi0_etam19.pdf}
\includegraphics[width=.3\linewidth]{python_codes/fieldstone_39/results/benchmark1/extension/line_sr_phi30_psi0_etam19.pdf}
\includegraphics[width=.3\linewidth]{python_codes/fieldstone_39/results/benchmark1/extension/line_sr_phi30_psi30_etam19.pdf}\\
\includegraphics[width=.3\linewidth]{python_codes/fieldstone_39/results/benchmark1/extension/line_sr_phi0_psi0_etam20.pdf}
\includegraphics[width=.3\linewidth]{python_codes/fieldstone_39/results/benchmark1/extension/line_sr_phi30_psi0_etam20.pdf}
\includegraphics[width=.3\linewidth]{python_codes/fieldstone_39/results/benchmark1/extension/line_sr_phi30_psi30_etam20.pdf}\\
{\captionfont From left to right: von Mises ($\phi=\Psi=0$), non-associated Drucker-Prager ($\phi=30^o,\Psi=0$), 
associated Drucker-Prager ($\phi=\Psi=30$).\\ From top to bottom: $\eta_m=0,10^{18},10^{19},10^{20}$.}
\end{center}

\newpage
\subsection*{Extension - viscosity on line}

\begin{center}
\includegraphics[width=.3\linewidth]{python_codes/fieldstone_39/results/benchmark1/extension/line_eta_phi0_psi0_etam0.pdf}
\includegraphics[width=.3\linewidth]{python_codes/fieldstone_39/results/benchmark1/extension/line_eta_phi30_psi0_etam0.pdf}
\includegraphics[width=.3\linewidth]{python_codes/fieldstone_39/results/benchmark1/extension/line_eta_phi30_psi30_etam0.pdf}\\
\includegraphics[width=.3\linewidth]{python_codes/fieldstone_39/results/benchmark1/extension/line_eta_phi0_psi0_etam18.pdf}
\includegraphics[width=.3\linewidth]{python_codes/fieldstone_39/results/benchmark1/extension/line_eta_phi30_psi0_etam18.pdf}
\includegraphics[width=.3\linewidth]{python_codes/fieldstone_39/results/benchmark1/extension/line_eta_phi30_psi30_etam18.pdf}\\
\includegraphics[width=.3\linewidth]{python_codes/fieldstone_39/results/benchmark1/extension/line_eta_phi0_psi0_etam19.pdf}
\includegraphics[width=.3\linewidth]{python_codes/fieldstone_39/results/benchmark1/extension/line_eta_phi30_psi0_etam19.pdf}
\includegraphics[width=.3\linewidth]{python_codes/fieldstone_39/results/benchmark1/extension/line_eta_phi30_psi30_etam19.pdf}\\
\includegraphics[width=.3\linewidth]{python_codes/fieldstone_39/results/benchmark1/extension/line_eta_phi0_psi0_etam20.pdf}
\includegraphics[width=.3\linewidth]{python_codes/fieldstone_39/results/benchmark1/extension/line_eta_phi30_psi0_etam20.pdf}
\includegraphics[width=.3\linewidth]{python_codes/fieldstone_39/results/benchmark1/extension/line_eta_phi30_psi30_etam20.pdf}\\
{\captionfont From left to right: von Mises ($\phi=\Psi=0$), non-associated Drucker-Prager ($\phi=30^o,\Psi=0$), 
associated Drucker-Prager ($\phi=\Psi=30$).\\ From top to bottom: $\eta_m=0,10^{18},10^{19},10^{20}$.}
\end{center}
...
\newpage
\subsection*{Extension - right shear band}

\begin{center}
\includegraphics[width=.3\linewidth]{python_codes/fieldstone_39/results/benchmark1/extension/shear_band_phi0_psi0_etam0.pdf}
\includegraphics[width=.3\linewidth]{python_codes/fieldstone_39/results/benchmark1/extension/shear_band_phi30_psi0_etam0.pdf}
\includegraphics[width=.3\linewidth]{python_codes/fieldstone_39/results/benchmark1/extension/shear_band_phi30_psi30_etam0.pdf}\\
\includegraphics[width=.3\linewidth]{python_codes/fieldstone_39/results/benchmark1/extension/shear_band_phi0_psi0_etam18.pdf}
\includegraphics[width=.3\linewidth]{python_codes/fieldstone_39/results/benchmark1/extension/shear_band_phi30_psi0_etam18.pdf}
\includegraphics[width=.3\linewidth]{python_codes/fieldstone_39/results/benchmark1/extension/shear_band_phi30_psi30_etam18.pdf}\\
\includegraphics[width=.3\linewidth]{python_codes/fieldstone_39/results/benchmark1/extension/shear_band_phi0_psi0_etam19.pdf}
\includegraphics[width=.3\linewidth]{python_codes/fieldstone_39/results/benchmark1/extension/shear_band_phi30_psi0_etam19.pdf}
\includegraphics[width=.3\linewidth]{python_codes/fieldstone_39/results/benchmark1/extension/shear_band_phi30_psi30_etam19.pdf}\\
\includegraphics[width=.3\linewidth]{python_codes/fieldstone_39/results/benchmark1/extension/shear_band_phi0_psi0_etam20.pdf}
\includegraphics[width=.3\linewidth]{python_codes/fieldstone_39/results/benchmark1/extension/shear_band_phi30_psi0_etam20.pdf}
\includegraphics[width=.3\linewidth]{python_codes/fieldstone_39/results/benchmark1/extension/shear_band_phi30_psi30_etam20.pdf}\\
{\captionfont From left to right: von Mises ($\phi=\Psi=0$), non-associated Drucker-Prager ($\phi=30^o,\Psi=0$), 
associated Drucker-Prager ($\phi=\Psi=30$).\\ From top to bottom: $\eta_m=0,10^{18},10^{19},10^{20}$.}
\end{center}
...
The domain has dimensions $L_x=128\si{\kilo\metre}$, $L_y=L_x/4$. 
...
\begin{center}
\includegraphics[width=7.5cm]{python_codes/fieldstone_39/results_shortening_block/line}
\includegraphics[width=7.5cm]{python_codes/fieldstone_39/results_shortening_block/angles}\\
