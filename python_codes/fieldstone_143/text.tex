...
NOTE THE FORMULA ABOVE NOT CORRECT
...
\begin{center}
\includegraphics[width=12cm]{python_codes/fieldstone_143/images/fig4}\\
...
Positive values of  $\dot{\varepsilon}_{xx}$ correspond to compression\footnote{explain pb}. 
...
Left: from the paper. Right: obtained with this  {\tt script\_fig5}.}
\end{center}

\begin{center}
\includegraphics[width=7cm]{python_codes/fieldstone_143/images/fig6}
\includegraphics[width=10cm]{python_codes/fieldstone_143/results/fig6/fig6a}\\
{\captionfont 
...
Left: Taken from \cite{yahb13}, Right: obtained with this  {\tt script\_fig6}.}
\end{center}


Testing influence of resolution
...
{\captionfont Reference model, nelx=300.}
\end{center}
