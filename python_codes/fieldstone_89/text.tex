...
\draw[thick,dashed] (1,1) -- (3,1) -- (3,3) -- (1,3) -- cycle;
\draw[thin,->]   (1,1) -- (5,1) ;
\draw[thin,->]   (1,1) -- (1,4) ;
...
\draw[fill=gray!11,gray!11](0,0) rectangle (5.5,4.5);
\draw[step=1cm,gray,very thin] (0,0) grid (5.5,4.5); 
\draw[fill=gray!33,thick,dashed] (1,1) -- (3,1) -- (3,3) -- (1,3) -- cycle;
\draw[thick] (1,1) -- (3,2) -- (3,4) -- (1,3) -- cycle;
\draw[thin,->]   (1,1) -- (5.5,1) ;
\draw[thin,->]   (1,1) -- (1,4.5) ;
\node[] at (4.8,0.7) {$x$};
\node[] at (0.7,3.8) {$y$};
...
\draw[step=1cm,gray,very thin] (0,0) grid (5.5,4.5); 
\draw[fill=gray!33,thick,dashed] (1,1) -- (3,1) -- (3,3) -- (1,3) -- cycle;
\draw[thick] (1,1) -- (3,2) -- (4,4) -- (2,3) -- cycle;
\draw[thin,->]   (1,1) -- (5.5,1) ;
\draw[thin,->]   (1,1) -- (1,4.5) ;
\node[] at (4.8,0.7) {$x$};
\node[] at (0.7,3.8) {$y$};
...
\draw[fill=gray!33,thick,dashed] (1,1) -- (3,1) -- (3,3) -- (1,3) -- cycle;
\draw[thick] (1,1) -- (3.5,2.5) -- (5,5) -- (2.5,3.5) -- cycle;
\draw[thin,->]   (1,1) -- (5.5,1) ;
\draw[thin,->]   (1,1) -- (1,4.5) ;
\node[] at (4.8,0.7) {$x$};
\node[] at (0.7,3.8) {$y$};
...
\right)
\]
where ${\bm U}$ is the right stretch tensor, or as \index{general}{Right stretch Tensor} 
\[
{\bm F} = {\bm V} \cdot {\bm R}
=
\left(
...
\begin{center}
\includegraphics[width=5.cm]{python_codes/fieldstone_89/results/pureshear/principal_angle.pdf}
\includegraphics[width=5.cm]{python_codes/fieldstone_89/results/pureshear/principal_strains.pdf}
\includegraphics[width=5.cm]{python_codes/fieldstone_89/results/pureshear/area.pdf}\\
\includegraphics[width=5.cm]{python_codes/fieldstone_89/results/pureshear/R.pdf}
\includegraphics[width=5.cm]{python_codes/fieldstone_89/results/pureshear/V.pdf}
\includegraphics[width=5.cm]{python_codes/fieldstone_89/results/pureshear/maximum_shear.pdf}\\
{\captionfont Time evolution of the principal angle $\theta_\varepsilon$, 
the strain principal values, the relative area change of the target cell, 
the components of ${\bm R}$, the components of ${\bm V}$ and the maximum
possible shear.}
