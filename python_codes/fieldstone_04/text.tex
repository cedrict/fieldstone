...
\begin{center}
\includegraphics[width=7cm]{python_codes/fieldstone_04/results/p64.pdf}
\includegraphics[width=7cm]{python_codes/fieldstone_04/results/q64.pdf}\\
\includegraphics[width=7cm]{python_codes/fieldstone_04/results/p100.pdf}
\includegraphics[width=7cm]{python_codes/fieldstone_04/results/q100.pdf}\\
{\captionfont Left: pressure $p$ at $y=L_y$; Right: smoothed pressure $q$ at $y=L_y$.}
\end{center}

\newpage
\begin{center}
\includegraphics[width=13cm]{python_codes/fieldstone_04/results/velocities}\\
\includegraphics[width=13cm]{python_codes/fieldstone_04/results/pressures}\\
\includegraphics[width=13cm]{python_codes/fieldstone_04/results/strainrates}
\end{center}
