...
\index{stopics}{$Q_4\times Q_3$}
\index{stopics}{Donea \& Huerta mms}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

In this experiment we consider 4 different finite elements. The idea behind 
this stone is to build a code which code(the FEM build and assembly) is common 
to all. The setup is the Donea \& Huerta benchmark (Section~\ref{MMM-mms1}), 
which has been modified so that the pressure is zero at the top right corner.
