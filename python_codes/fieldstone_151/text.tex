...
mapping, quadratur, solving, etc ...
The fluid is isothermal and incompressible.
...
By default all node are placed on concentric circles. However the {\python trapezes}
boolean ensures that all mid-edges nodes are then placed exactly in the middle of the 
corresponding corner nodes when set to True (obviously the middle node is then also 
...
\item explore the importance of straight edge elts vs curved ones.
\end{itemize}
...
It is a hydrostatic pressure and a rotational velocity given by $\vec{\upnu}=r \; \vec{e}_\theta$.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section*{test \#4: sinking blob - free slip}

$\delta \rho/\rho_0=0.01$
centered at (90,1.5), radius 0.25

\begin{center}
\includegraphics[width=5.6cm]{python_codes/fieldstone_151/results/test5/e_rr}
\includegraphics[width=5.6cm]{python_codes/fieldstone_151/results/test5/e_tt}
\includegraphics[width=5.6cm]{python_codes/fieldstone_151/results/test5/e_rt}\\
\includegraphics[width=5.6cm]{python_codes/fieldstone_151/results/test5/e_rr2}
\includegraphics[width=5.6cm]{python_codes/fieldstone_151/results/test5/e_tt2}
\includegraphics[width=5.6cm]{python_codes/fieldstone_151/results/test5/e_rt2}\\
