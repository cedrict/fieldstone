...
\begin{center}
\includegraphics[width=8.5cm]{python_codes/fieldstone_40/RESULTS/vel}
\includegraphics[width=8.5cm]{python_codes/fieldstone_40/RESULTS/p}
\end{center}
...
In this experiment the density {\it differences} are driving the flow and
the 'background lithostatic' pressure is neutral/irrelevant. 
As such I have rerun the script with a version of the density
function that now assigns $\rho=300$ in the upper half of the domain and 
$\rho=0$ in the lower half. 
We find that results are more accurate:

\begin{center}
\includegraphics[width=5.7cm]{python_codes/fieldstone_40/RESULTS/plot24x24_reduced}
\includegraphics[width=5.7cm]{python_codes/fieldstone_40/RESULTS/plot32x32_reduced}
\includegraphics[width=5.7cm]{python_codes/fieldstone_40/RESULTS/plot48x48_reduced}\\
{\captionfont Resolution 48$\times$48.} 
\end{center}
