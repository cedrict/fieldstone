...
Let me know if you have any questions about the setup, etc. I could also find the actual 
values that are plotted in this figure, if you want to compare things in more detail.
\end{verbatim}
...
\includegraphics[width=8cm]{python_codes/fieldstone_54/RESULTS/exp10/tau_f.pdf}
\end{center}
We find that the lines do not curve down for large wavelengths as in Clint's figure.
It seems that the depth of the model plays a role in this, 
...
\item proper linear fit of $f \tau$
\end{itemize}
