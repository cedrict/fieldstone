...
\begin{center}
\includegraphics[width=9cm]{python_codes/fieldstone_13/markers} 
\end{center}
...
\begin{center}
\includegraphics[width=13cm]{python_codes/fieldstone_13/markers2}\\
...
\begin{center}
\includegraphics[width=5.7cm]{python_codes/fieldstone_13/vrms_rand_proj1} 
\includegraphics[width=5.7cm]{python_codes/fieldstone_13/vrms_poissondisc_proj1} 
\includegraphics[width=5.7cm]{python_codes/fieldstone_13/vrms_reg_proj1}\\ 
\includegraphics[width=5.7cm]{python_codes/fieldstone_13/vrms_rand_proj2} 
\includegraphics[width=5.7cm]{python_codes/fieldstone_13/vrms_poissondisc_proj2} 
\includegraphics[width=5.7cm]{python_codes/fieldstone_13/vrms_reg_proj2}\\ 
\includegraphics[width=5.7cm]{python_codes/fieldstone_13/vrms_rand_proj3} 
\includegraphics[width=5.7cm]{python_codes/fieldstone_13/vrms_poissondisc_proj3} 
\includegraphics[width=5.7cm]{python_codes/fieldstone_13/vrms_reg_proj3}\\
\includegraphics[width=5.7cm]{python_codes/fieldstone_13/vrms_rand_proj4} 
\includegraphics[width=5.7cm]{python_codes/fieldstone_13/vrms_poissondisc_proj4} 
\includegraphics[width=5.7cm]{python_codes/fieldstone_13/vrms_reg_proj4}\\
...
\begin{center}
\includegraphics[width=5.7cm]{python_codes/fieldstone_13/vrms_am} 
\includegraphics[width=5.7cm]{python_codes/fieldstone_13/vrms_gm} 
\includegraphics[width=5.7cm]{python_codes/fieldstone_13/vrms_hm}\\
