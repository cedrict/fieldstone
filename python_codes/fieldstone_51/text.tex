...
{\sl This stone was developed in collaboration with L. van de Wiel (meshing).} 
...
I have run the model for various values of $\gamma$ for $n=25$ (which 
controls the resolution), and results are shown on the 
...
\begin{tabular}{llll}
\hline
resolution $(n)$ & $\upnu_{rms}$ & Nu & $\langle T \rangle$ \\
\hline
\hline
