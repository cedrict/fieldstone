...
nodes inside the domain is perturbed by a small random value (b).
Finally, in order to generate a mesh which is more isotropic some edges between 
triangles can be flipped (c). In what follows I denote by $h$ the distance between nodes
