...
function OnePlot(variable,plotX,plotY,title,labelX,labelY, extVal, limitX,limitY,colorMap)
    im=axes[plotX,plotY].imshow(reverse(variable,dims=1),extent=extVal,cmap=colorMap, interpolation="nearest")
    axes[plotX,plotY].set_title(label=title,fontsize=10, y=1.01)
    if limitX!=0.
...
# for iel = 1:nel
#     println("iel=",iel)
#     println("node 1 ",icon[1,iel]," at pos. ",x[icon[1,iel]]," , ", y[icon[1,iel]])
#     println("node 2 ",icon[2,iel]," at pos. ",x[icon[2,iel]]," , ", y[icon[2,iel]])
#     println("node 3 ",icon[3,iel]," at pos. ",x[icon[3,iel]]," , ", y[icon[3,iel]])
#     println("node 4 ",icon[4,iel]," at pos. ",x[icon[4,iel]]," , ", y[icon[4,iel]])
# end
...
println("Setup: boundary conditions array   ",time1 ,"   sec")
...
println("","Build FE matrix                    ", time1, "  sec")
...
println("Impose boundary conditions         ", time, "  sec")
...
println("compute pressure                   ", time1, "  sec")
...
println("compute nodal error for plot       ", time1, "  sec")
...
println("nel = ", nel,"     error v = ", errv,"     error p = ", errp)
end

println("compute errors                     ", time1, "  sec")
...
println("naive depth averaging              ", time1, "  sec")

if visu == 1
    filename = "errorplot.vtu"
