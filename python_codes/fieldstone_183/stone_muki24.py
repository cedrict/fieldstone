...
for E in (117e3, 350e3):
    for coeff in (1.0, 1.1, 1.2):
        for age in (50e6, 100e6, 200e6, 300e6):
            ...
            np.savetxt(
                "T_" + str(int(coeff * 10)) + "_" + str(int(age / 1e6)) + ".ascii",
                np.array([r, T]).T,
            )
            ...
            np.savetxt(
                "rho_" + str(int(coeff * 10)) + "_" + str(int(age / 1e6)) + ".ascii",
                np.array([r, rho]).T,
            )
            ...
            np.savetxt(
                "p_" + str(int(coeff * 10)) + "_" + str(int(age / 1e6)) + ".ascii",
                np.array([r, p]).T,
            )
