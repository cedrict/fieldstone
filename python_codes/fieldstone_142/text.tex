...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%5
\section*{Exp1: Circular inclusion and comparison with analytical solution}
...
why change the radius inside the figure??
...
\begin{center}
\includegraphics[width=5.7cm]{python_codes/fieldstone_142/results/exp2/inclusion}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%5
\section*{Exp3: Power-law viscous matrix and weak elliptical inclusion}




\begin{center}
\includegraphics[width=8cm]{python_codes/fieldstone_142/images/hams22_d}
\includegraphics[width=8cm]{python_codes/fieldstone_142/images/hams22_dd}\\
\captionfont{Taken from \cite{hams22}.
...
\begin{center}
\includegraphics[width=5.7cm]{python_codes/fieldstone_142/results/exp3/inclusion}
