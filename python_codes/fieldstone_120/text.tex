...
Following \textcite{bocg12} (2012), I use a symmetric grid for triangular elements:
\begin{center} 
\includegraphics[width=8cm]{python_codes/fieldstone_120/images/bocg12}\\
...
\begin{tabular}{p{1cm}p{2cm}p{4cm}p{12cm}}
\hline
...
12&$DSSY_1\times Q_0$    &                  & Section~\ref{ss:dssy_2D}\\
13&$DSSY_2\times Q_0$    &                  & Section~\ref{ss:dssy_2D}\\
...
20&$P_2\times (P_1+P_0)$ &                  & Section~\ref{ss:p2p1p0}\\
21&$P_1^{NC}\times P_0$  &                  & Section~\ref{ss:p1ncp0}\\
22&$P_1\times P_0$       &                  & Section~\ref{ss:p1p0}\\ 
\hline
\end{tabular}
...
Conclusions:
\begin{itemize}
\item $Q_1\times Q_0$ pressure is plagued by checkeboard mode
...
- why P1NC-P0 not work?

- why P2-P1+P0 not work?
