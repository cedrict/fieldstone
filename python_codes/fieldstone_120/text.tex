...
26&$Q_4\times Q_3$       &                  & Section~\ref{ss:q42d}\\
27&$P_4\times P_3$       &                  & Section~\ref{ss:p42d}\\
\hline
\end{tabular}
\end{center}
...
$P_3^+\times P_{-2}$, $Q_3\times P_{-2}$, $P_4\times P_3$, $Q_4 \times P_{-3}$.
...
\hline
Pspace $\downarrow$ | Vspace $\rightarrow$   
         & $P_1$    & $P_2$     & $P_3$     & $P_4$    & $P_1^+$   & $P_2^+$   & $P_1^{NC}$  \\
