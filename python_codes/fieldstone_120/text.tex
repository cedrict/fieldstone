...
\includegraphics[width=3cm]{python_codes/fieldstone_120/spaces/Q1}
\includegraphics[width=3cm]{python_codes/fieldstone_120/spaces/Q1+}
\includegraphics[width=3cm]{python_codes/fieldstone_120/spaces/Q2}
\includegraphics[width=3cm]{python_codes/fieldstone_120/spaces/Q3}
\includegraphics[width=3cm]{python_codes/fieldstone_120/spaces/Q4}

\includegraphics[width=3cm]{python_codes/fieldstone_120/spaces/P1}
\includegraphics[width=3cm]{python_codes/fieldstone_120/spaces/P1+}
\includegraphics[width=3cm]{python_codes/fieldstone_120/spaces/P2}
\includegraphics[width=3cm]{python_codes/fieldstone_120/spaces/P2+}
