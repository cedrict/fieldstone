...
#------------------------------------------------------------------------------
#
# P0, Q1, P1, P1+, Q2, Q2s, P2, P2+, Q3, P3, P4, Q4, DSSY1, DSSY2, RT1, RT2
#
#------------------------------------------------------------------------------
# notes/remarks:
...
def NNN_r(space):
    ...
    if space=='Q0':
       ...
       val = np.zeros(15,dtype=np.float64)
       val[:]=[0,0.25,0.5,0.75,1,0,0.25,0.5,0.75,0,0.25,0.5,0,0.25,0]
...
def NNN_s(space):
    ...
    if space=='Q0':
       ...
       val = np.zeros(15,dtype=np.float64)
       val[:]=[0,0,0,0,0,0.25,0.25,0.25,0.25,0.5,0.5,0.5,0.75,0.75,1]
...
def visualise_nodes(space):
    ...
    elif space=='P1' or space=='P2' or space=='P1+' or space=='P2+' or space=='P3' or\
         space=='P4' or space=='P1NC':
       plt.xlim([-0.1,+1.1])
       plt.ylim([-0.1,+1.1])
