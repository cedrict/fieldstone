...
\begin{flushright} {\tiny {\color{gray} python\_codes/fieldstone\_65/text.tex}} \end{flushright}
...
\begin{center}
\inpython
{\small Code: \url{https://github.com/cedrict/fieldstone/tree/master/python_codes/fieldstone_65}}
\end{center}

\par\noindent\rule{\textwidth}{0.4pt}

Last revision: September 14th, 2026.
...
We wish to solve the advection-diffusion problem presented in Section~\ref{MMM-ss:advdiff}:
\begin{equation}
...
\newpage
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section*{Experiment 2 - advection skew to the mesh}
...
\newpage
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section*{Experiment 3 - DG book setup}
...
\newpage
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section*{Experiment 4 - Heat flow around a cylinder} 
...
\begin{center}
\includegraphics[width=7cm]{python_codes/fieldstone_65/results/exp4/vel}
\end{center}
...
on a $250\times 100$ grid are shown here:

\begin{center}
\includegraphics[width=7cm]{python_codes/fieldstone_65/results/exp4/temps}
\end{center}
