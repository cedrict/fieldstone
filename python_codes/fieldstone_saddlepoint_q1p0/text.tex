...
\includegraphics[width=16cm]{python_codes/fieldstone_saddlepoint_q1p0/solution.pdf}
...
\begin{center}
\includegraphics[width=7cm]{python_codes/fieldstone_saddlepoint_q1p0/doneahuerta}
\includegraphics[width=7cm]{python_codes/fieldstone_saddlepoint_q1p0/mine}\\
