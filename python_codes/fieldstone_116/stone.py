...
def visc_avrg2(eta1,eta2):
    val=max(eta1,eta2)
    return val

def visc_avrg4(eta1,eta2,eta3,eta4):
    val=max(eta1,eta2,eta3,eta4)
    return val
...
for iel in range(0, nel):
    ...
    xc[iel] = (x[icon[0,iel]]+x[icon[2,iel]])/2
    yc[iel] = (y[icon[0,iel]]+y[icon[2,iel]])/2
...
if stabilisation==2: #global
   ...
   for j in range(0, nely):
       for i in range(0, nelx):
           ...
           if i_left!=-1:
              A_mat[NfemV+ counter, NfemV+ elt_left]+=epsi*hx*hy/visc_avrg2(counter,elt_left)
              A_mat[NfemV+ counter, NfemV+ counter] -=epsi*hx*hy/visc_avrg2(counter,elt_left)
           if i_right!=nelx:
              A_mat[NfemV+ counter, NfemV+ elt_right]+=epsi*hx*hy/visc_avrg2(counter,elt_right)
              A_mat[NfemV+ counter, NfemV+ counter]  -=epsi*hx*hy/visc_avrg2(counter,elt_right)
           if j_bot!=-1:
              A_mat[NfemV+ counter, NfemV+ elt_bot]+=epsi*hx*hy/visc_avrg2(counter,elt_bot)
              A_mat[NfemV+ counter, NfemV+ counter]-=epsi*hx*hy/visc_avrg2(counter,elt_bot)
           if j_top!=nely:
              A_mat[NfemV+ counter, NfemV+ elt_top]+=epsi*hx*hy/visc_avrg2(counter,elt_top)
              A_mat[NfemV+ counter, NfemV+ counter]-=epsi*hx*hy/visc_avrg2(counter,elt_top)
           counter += 1
       #end for
   #end for
   ...
   for j in range(0, nely):
       for i in range(0, nelx):
           if j%2==0 and i%2==0:
              ...
              A_mat[NfemV+ elt_LL, NfemV+ elt_LR] +=epsi*hx*hy/visc_avrg2(elt_LL,elt_LR)
              A_mat[NfemV+ elt_LL, NfemV+ elt_LL] -=epsi*hx*hy/visc_avrg2(elt_LL,elt_LR)
              A_mat[NfemV+ elt_LL, NfemV+ elt_UL] +=epsi*hx*hy/visc_avrg2(elt_LL,elt_UL)
              A_mat[NfemV+ elt_LL, NfemV+ elt_LL] -=epsi*hx*hy/visc_avrg2(elt_LL,elt_UL)
              #lower right element LR
              A_mat[NfemV+ elt_LR, NfemV+ elt_LL] +=epsi*hx*hy/visc_avrg2(elt_LR,elt_LR)
              A_mat[NfemV+ elt_LR, NfemV+ elt_LR] -=epsi*hx*hy/visc_avrg2(elt_LR,elt_LR)
              A_mat[NfemV+ elt_LR, NfemV+ elt_UR] +=epsi*hx*hy/visc_avrg2(elt_LR,elt_UR)
              A_mat[NfemV+ elt_LR, NfemV+ elt_LR] -=epsi*hx*hy/visc_avrg2(elt_LR,elt_UR)
              #upper left element LL
              A_mat[NfemV+ elt_UL, NfemV+ elt_UR] +=epsi*hx*hy/visc_avrg2(elt_UL,elt_UR)
              A_mat[NfemV+ elt_UL, NfemV+ elt_UL] -=epsi*hx*hy/visc_avrg2(elt_UL,elt_UR)
              A_mat[NfemV+ elt_UL, NfemV+ elt_LL] +=epsi*hx*hy/visc_avrg2(elt_UL,elt_LL)
              A_mat[NfemV+ elt_UL, NfemV+ elt_UL] -=epsi*hx*hy/visc_avrg2(elt_UL,elt_LL)
              #upper right element UR
              A_mat[NfemV+ elt_UR, NfemV+ elt_UL] +=epsi*hx*hy/visc_avrg2(elt_UR,elt_UL)
              A_mat[NfemV+ elt_UR, NfemV+ elt_UR] -=epsi*hx*hy/visc_avrg2(elt_UR,elt_UL)
              A_mat[NfemV+ elt_UR, NfemV+ elt_LR] +=epsi*hx*hy/visc_avrg2(elt_UR,elt_LR)
              A_mat[NfemV+ elt_UR, NfemV+ elt_UR] -=epsi*hx*hy/visc_avrg2(elt_UR,elt_LR)
           counter += 1
       #end for
   #end for
   ...
   for j in range(0, nely):
       for i in range(0, nelx):
           if j%2==0 and i%2==0:
              ...
              elt_UL=counter+nelx
              elt_UR=counter+nelx+1
              eta_avrg=visc_avrg4(eta[elt_LL],eta[elt_LR],eta[elt_UL],eta[elt_UR])
              #lower left element LL
              A_mat[NfemV+ elt_LL, NfemV+ elt_LL] -=epsi*hx*hy/eta_avrg
              A_mat[NfemV+ elt_LL, NfemV+ elt_LR] +=epsi*hx*hy/eta_avrg
              A_mat[NfemV+ elt_LL, NfemV+ elt_UL] +=epsi*hx*hy/eta_avrg
              A_mat[NfemV+ elt_LL, NfemV+ elt_UR] -=epsi*hx*hy/eta_avrg
              #lower right element LR
              A_mat[NfemV+ elt_LR, NfemV+ elt_LR] -=epsi*hx*hy/eta_avrg
              A_mat[NfemV+ elt_LR, NfemV+ elt_LL] +=epsi*hx*hy/eta_avrg
              A_mat[NfemV+ elt_LR, NfemV+ elt_UR] +=epsi*hx*hy/eta_avrg
              A_mat[NfemV+ elt_LR, NfemV+ elt_UL] -=epsi*hx*hy/eta_avrg
              #upper left element LL
              A_mat[NfemV+ elt_UL, NfemV+ elt_UL] -=epsi*hx*hy/eta_avrg
              A_mat[NfemV+ elt_UL, NfemV+ elt_UR] +=epsi*hx*hy/eta_avrg
              A_mat[NfemV+ elt_UL, NfemV+ elt_LL] +=epsi*hx*hy/eta_avrg
              A_mat[NfemV+ elt_UL, NfemV+ elt_LR] -=epsi*hx*hy/eta_avrg
              #upper right element UR
              A_mat[NfemV+ elt_UR, NfemV+ elt_UR] -=epsi*hx*hy/eta_avrg
              A_mat[NfemV+ elt_UR, NfemV+ elt_UL] +=epsi*hx*hy/eta_avrg
              A_mat[NfemV+ elt_UR, NfemV+ elt_LR] +=epsi*hx*hy/eta_avrg
              A_mat[NfemV+ elt_UR, NfemV+ elt_LL] -=epsi*hx*hy/eta_avrg
           counter += 1
       #end for
   #end for
