...
\todo{Describe experiment - add figures}



\includegraphics[width=5cm]{python_codes/fieldstone_152/exp1/vel_16}
\includegraphics[width=5cm]{python_codes/fieldstone_152/exp1/vel_32}
\includegraphics[width=5cm]{python_codes/fieldstone_152/exp1/vel_64}
\includegraphics[width=5cm]{python_codes/fieldstone_152/exp1/vel_128}

\noindent
\includegraphics[width=5cm]{python_codes/fieldstone_152/exp1/sr2_16}
\includegraphics[width=5cm]{python_codes/fieldstone_152/exp1/sr2_32}
\includegraphics[width=5cm]{python_codes/fieldstone_152/exp1/sr2_64}
\includegraphics[width=5cm]{python_codes/fieldstone_152/exp1/sr2_128}

\noindent
\includegraphics[width=5cm]{python_codes/fieldstone_152/exp1/err_16}
\includegraphics[width=5cm]{python_codes/fieldstone_152/exp1/err_32}
\includegraphics[width=5cm]{python_codes/fieldstone_152/exp1/err_64}
\includegraphics[width=5cm]{python_codes/fieldstone_152/exp1/err_128}

\noindent
\includegraphics[width=5cm]{python_codes/fieldstone_152/exp1/qqq_16}
\includegraphics[width=5cm]{python_codes/fieldstone_152/exp1/qqq_32}
\includegraphics[width=5cm]{python_codes/fieldstone_152/exp1/qqq_64}
\includegraphics[width=5cm]{python_codes/fieldstone_152/exp1/qqq_128}

\noindent
\includegraphics[width=5cm]{python_codes/fieldstone_152/exp1/d_t_16}
\includegraphics[width=5cm]{python_codes/fieldstone_152/exp1/d_t_32}
\includegraphics[width=5cm]{python_codes/fieldstone_152/exp1/d_t_64}
\includegraphics[width=5cm]{python_codes/fieldstone_152/exp1/d_t_128}

\includegraphics[width=5cm]{python_codes/fieldstone_152/exp1/v_r_128}
\includegraphics[width=5cm]{python_codes/fieldstone_152/exp1/v_t_128}

%\begin{center}
%\includegraphics[width=8cm]{exp1/vel_80}
%\includegraphics[width=8cm]{exp1/sr2_80}\\
%\includegraphics[width=8cm]{exp1/err_80}
%\includegraphics[width=8cm]{exp1/qqq_80}\\
%\includegraphics[width=14cm]{exp1/d_t_80}
%\end{center}

Conclusions:
\begin{itemize}
\item Experiment not very conclusive
\item Reassuringly the dyn topo is less than 2cm at the surface 
\item it looks like xi=5 is best?
\end{itemize}
...
%\begin{center}
%\includegraphics[width=8cm]{exp2_0p001/rho}
%\includegraphics[width=8cm]{exp2_0p001/vel}
%\end{center}



\noindent
\includegraphics[width=5cm]{python_codes/fieldstone_152/exp2_0p001/vel_16}
\includegraphics[width=5cm]{python_codes/fieldstone_152/exp2_0p001/vel_32}
\includegraphics[width=5cm]{python_codes/fieldstone_152/exp2_0p001/vel_48}
\includegraphics[width=5cm]{python_codes/fieldstone_152/exp2_0p001/vel_64}
\includegraphics[width=5cm]{python_codes/fieldstone_152/exp2_0p001/vel_80}
\includegraphics[width=5cm]{python_codes/fieldstone_152/exp2_0p001/vel_96}
\includegraphics[width=5cm]{python_codes/fieldstone_152/exp2_0p001/vel_112}
\includegraphics[width=5cm]{python_codes/fieldstone_152/exp2_0p001/vel_128}

\noindent
\includegraphics[width=5cm]{python_codes/fieldstone_152/exp2_0p001/sr2_16}
\includegraphics[width=5cm]{python_codes/fieldstone_152/exp2_0p001/sr2_32}
\includegraphics[width=5cm]{python_codes/fieldstone_152/exp2_0p001/sr2_48}
\includegraphics[width=5cm]{python_codes/fieldstone_152/exp2_0p001/sr2_64}
\includegraphics[width=5cm]{python_codes/fieldstone_152/exp2_0p001/sr2_80}
\includegraphics[width=5cm]{python_codes/fieldstone_152/exp2_0p001/sr2_96}
\includegraphics[width=5cm]{python_codes/fieldstone_152/exp2_0p001/sr2_112}
\includegraphics[width=5cm]{python_codes/fieldstone_152/exp2_0p001/sr2_128}

\noindent
\includegraphics[width=5cm]{python_codes/fieldstone_152/exp2_0p001/err_16}
\includegraphics[width=5cm]{python_codes/fieldstone_152/exp2_0p001/err_32}
\includegraphics[width=5cm]{python_codes/fieldstone_152/exp2_0p001/err_48}
\includegraphics[width=5cm]{python_codes/fieldstone_152/exp2_0p001/err_64}
\includegraphics[width=5cm]{python_codes/fieldstone_152/exp2_0p001/err_80}
\includegraphics[width=5cm]{python_codes/fieldstone_152/exp2_0p001/err_96}
\includegraphics[width=5cm]{python_codes/fieldstone_152/exp2_0p001/err_112}
\includegraphics[width=5cm]{python_codes/fieldstone_152/exp2_0p001/err_128}

\noindent
\includegraphics[width=5cm]{python_codes/fieldstone_152/exp2_0p001/qqq_16}
\includegraphics[width=5cm]{python_codes/fieldstone_152/exp2_0p001/qqq_32}
\includegraphics[width=5cm]{python_codes/fieldstone_152/exp2_0p001/qqq_48}
\includegraphics[width=5cm]{python_codes/fieldstone_152/exp2_0p001/qqq_64}
\includegraphics[width=5cm]{python_codes/fieldstone_152/exp2_0p001/qqq_80}
\includegraphics[width=5cm]{python_codes/fieldstone_152/exp2_0p001/qqq_96}
\includegraphics[width=5cm]{python_codes/fieldstone_152/exp2_0p001/qqq_112}
\includegraphics[width=5cm]{python_codes/fieldstone_152/exp2_0p001/qqq_128}

\noindent
\includegraphics[width=5cm]{python_codes/fieldstone_152/exp2_0p001/d_t_16}
\includegraphics[width=5cm]{python_codes/fieldstone_152/exp2_0p001/d_t_32}
\includegraphics[width=5cm]{python_codes/fieldstone_152/exp2_0p001/d_t_48}
\includegraphics[width=5cm]{python_codes/fieldstone_152/exp2_0p001/d_t_64}
\includegraphics[width=5cm]{python_codes/fieldstone_152/exp2_0p001/d_t_80}
\includegraphics[width=5cm]{python_codes/fieldstone_152/exp2_0p001/d_t_96}
\includegraphics[width=5cm]{python_codes/fieldstone_152/exp2_0p001/d_t_112}
\includegraphics[width=5cm]{python_codes/fieldstone_152/exp2_0p001/d_t_128}

\begin{center}
\includegraphics[width=8cm]{python_codes/fieldstone_152/exp2_0p001/vel_160}
\includegraphics[width=8cm]{python_codes/fieldstone_152/exp2_0p001/sr2_160}\\
\includegraphics[width=8cm]{python_codes/fieldstone_152/exp2_0p001/err_160}
\includegraphics[width=8cm]{python_codes/fieldstone_152/exp2_0p001/qqq_160}\\
\includegraphics[width=8cm]{python_codes/fieldstone_152/exp2_0p001/d_t_160_left}
\includegraphics[width=8cm]{python_codes/fieldstone_152/exp2_0p001/d_t_160_right}\\
\includegraphics[width=14cm]{python_codes/fieldstone_152/exp2_0p001/d_t_160}
\end{center}


Remarks \& Conclusions:
\begin{itemize}
\item so far all previous experiments had density contrasts that followed element boundaries.
Here, the blob does not does not fit with any edge element and some elements have quadrature points
that have different densities.
\item nelr=80 not enough to guarantee resolution-independent results
\item nelr=96 substantially better, with xi>6 
\item right value of xi not really clear from all those experiments
\item looks like xi=6,8 almost consistently perform worse than higher xi values
\end{itemize}
...
script\_normals2, nq=3, Q4 mapping.

a) $g_x=0$, $g_y=-g_0$, offset=1

\begin{center}
\includegraphics[width=5cm]{python_codes/fieldstone_152/results/exp6a/vel}
\includegraphics[width=5cm]{python_codes/fieldstone_152/results/exp6a/err}
\includegraphics[width=5cm]{python_codes/fieldstone_152/results/exp6a/qqq}
\end{center}

d) $g_x=0$, $g_y=-g_0$, offset=0

\begin{center}
\includegraphics[width=5cm]{python_codes/fieldstone_152/results/exp6d/vel}
\includegraphics[width=5cm]{python_codes/fieldstone_152/results/exp6d/err}
\includegraphics[width=5cm]{python_codes/fieldstone_152/results/exp6d/qqq}
\end{center}

b) $g_x=g_0$, $g_y=0$, offset=1

\begin{center}
\includegraphics[width=5cm]{python_codes/fieldstone_152/results/exp6b/vel}
\includegraphics[width=5cm]{python_codes/fieldstone_152/results/exp6b/err}
\includegraphics[width=5cm]{python_codes/fieldstone_152/results/exp6b/qqq}
\end{center}

c) $g_x=g_0$, $g_y=0$, offset=0

\begin{center}
\includegraphics[width=5cm]{python_codes/fieldstone_152/results/exp6c/vel}
\includegraphics[width=5cm]{python_codes/fieldstone_152/results/exp6c/err}
\includegraphics[width=5cm]{python_codes/fieldstone_152/results/exp6c/qqq}
\end{center}
