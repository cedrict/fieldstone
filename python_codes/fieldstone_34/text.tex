\lstinputlisting[language=bash,basicstyle=\small]{python_codes/fieldstone_34/keywords}
...
\includegraphics[width=5cm]{python_codes/fieldstone_34/results/exp1/eyy}
\end{center}
