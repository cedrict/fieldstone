...
The velocity field is linear and can therefore be represented exactly 
by the basis functions. The recovered errors are then zero down to machine precision.
...
or, 
\begin{eqnarray}
{\sigma}_{xx}&=&\frac{p_0}{\pi}\left[ \theta - \frac{1}{2}\sin 2\theta  \right]^{\theta_2}_{\theta_1} 
= \frac{p_0}{\pi} \left( \Theta - \frac{1}{2} ( \sin 2\theta_2 - \sin 2\theta_1)  \right) \nn\\
{\sigma}_{zz}&=&\frac{p_0}{\pi}\left[ \theta + \frac{1}{2}\sin 2\theta  \right]^{\theta_2}_{\theta_1} 
= \frac{p_0}{\pi} \left( \Theta + \frac{1}{2} ( \sin 2\theta_2 - \sin 2\theta_1) \right)  \nn\\
{\sigma}_{xz}&=&\frac{p_0}{\pi}\left[ \sin^2 \theta  \right]^{\theta_2}_{\theta_1} 
= \frac{p_0}{\pi}  \sin^2 \theta_2 - \sin^2 \theta_1 \nn
\end{eqnarray}
...
\newpage
%---------------------------------------
\section*{Experiment 5: Strip load (again)}

This is a variant of Experiment 4. It was made during the 2026 ASPECT hackathon:
...
\begin{center}
\includegraphics[width=8cm]{python_codes/fieldstone_34/results/exp5/disp.png}
\includegraphics[width=8cm]{python_codes/fieldstone_34/results/exp5/divv.png}
\end{center}


ToDo: When the cookbook is merged in ASPECT, make a link.
