    ...
    for iel in range(0,nel):
        for iq in range(0,nq_per_dim):
            for jq in range(0,nq_per_dim):
                ...
                vq=np.dot(N_V,v[icon_V[:,iel]])
                rhoq=np.dot(N_V,rho[icon_V[:,iel]])
                work_grav[istep]+=(rhoq-rho0)*gy*vq*JxWq 
            #end for jq
        #end for iq
    #end for iel
\end{lstlisting}
...
\]
From the second equation we get $\alpha=\frac{\Dinb C_p}{g L}$, which we can insert in the first one:
\[
...
In the case of the setup described hereabove, and 
when choosing $Ra=10^4$ and $Di=0.5$, we get:
\begin{verbatim}
-> Ra 1.000000e+04 
-> Di 5.000000e-01 
-> kappa 8.000000e-07 
...
\end{verbatim}
when choosing $Ra=10^5$ and $Di=0.5$, we get:
\begin{verbatim}
-> Ra 1.000000e+05 
-> Di 5.000000e-01 
-> kappa 8.000000e-07 
...
-> reftime 1.125000e+19 
-> refvel 2.666667e-13 
-> refPress 7.500000e+04 
\end{verbatim}
and finally when choosing $Ra=10^6$ and $Di=0.5$, we get:
\begin{verbatim}
-> Ra 1.000000e+06 
-> Di 5.000000e-01 
-> kappa 8.000000e-07 
...
(see also p210 of \textcite{malvern}).
...
[wiki] In geophysics, the Rayleigh number is of fundamental importance: 
it indicates the presence and strength of convection within a fluid body 
such as the Earth's mantle. The mantle is a solid that behaves as a fluid over geological time scales.
...
ToDo: 
\begin{itemize}
\item heat flux is at the moment elemental, so Nusselt and heat flux 
on boundaries measurements not as accurate as could be.
...
\item run Ra=1e6 for BA
\end{itemize}


\newpage
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section*{NEW Results - Q2Q1 - BA - Ra=1e4 CFL=0.75}

Note that the $\upnu_{rms}$ is normalised with the reference velocity
above and can therefore be compared to the value in \textcite{blbc89}.

\begin{center}
\includegraphics[width=5cm]{python_codes/fieldstone_24/RESULTS/BA_1e4/adiabatic_heating.pdf}
\includegraphics[width=5cm]{python_codes/fieldstone_24/RESULTS/BA_1e4/gravitational_energy.pdf}
\includegraphics[width=5cm]{python_codes/fieldstone_24/RESULTS/BA_1e4/kinetic_energy.pdf}\\
\includegraphics[width=5cm]{python_codes/fieldstone_24/RESULTS/BA_1e4/mass.pdf}
\includegraphics[width=5cm]{python_codes/fieldstone_24/RESULTS/BA_1e4/Nu.pdf}
\includegraphics[width=5cm]{python_codes/fieldstone_24/RESULTS/BA_1e4/Tavrg.pdf}\\
\includegraphics[width=5cm]{python_codes/fieldstone_24/RESULTS/BA_1e4/thermal_energy.pdf}
\includegraphics[width=5cm]{python_codes/fieldstone_24/RESULTS/BA_1e4/total_heat_flux.pdf}
\includegraphics[width=5cm]{python_codes/fieldstone_24/RESULTS/BA_1e4/velocity_stats.pdf}\\
\includegraphics[width=5cm]{python_codes/fieldstone_24/RESULTS/BA_1e4/viscous_dissipation.pdf}
\includegraphics[width=5cm]{python_codes/fieldstone_24/RESULTS/BA_1e4/vrms_adim.pdf}
\includegraphics[width=5cm]{python_codes/fieldstone_24/RESULTS/BA_1e4/work_against_gravity.pdf}
\end{center}


Is viscous dissipation equal to the work against gravity (see Eq.~\eqref{ba003}) ? YES

\begin{center}
\includegraphics[width=8cm]{python_codes/fieldstone_24/RESULTS/BA_1e4/energy_check1.pdf}
\end{center}
...
\newpage
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section*{NEW Results - Q2Q1 - BA - Ra=1e6 CFL=0.75}

\begin{center}
\includegraphics[width=5cm]{python_codes/fieldstone_24/RESULTS/BA_1e6/adiabatic_heating.pdf}
\includegraphics[width=5cm]{python_codes/fieldstone_24/RESULTS/BA_1e6/gravitational_energy.pdf}
\includegraphics[width=5cm]{python_codes/fieldstone_24/RESULTS/BA_1e6/kinetic_energy.pdf}\\
\includegraphics[width=5cm]{python_codes/fieldstone_24/RESULTS/BA_1e6/mass.pdf}
\includegraphics[width=5cm]{python_codes/fieldstone_24/RESULTS/BA_1e6/Nu.pdf}
\includegraphics[width=5cm]{python_codes/fieldstone_24/RESULTS/BA_1e6/Tavrg.pdf}\\
\includegraphics[width=5cm]{python_codes/fieldstone_24/RESULTS/BA_1e6/thermal_energy.pdf}
\includegraphics[width=5cm]{python_codes/fieldstone_24/RESULTS/BA_1e6/total_heat_flux.pdf}
\includegraphics[width=5cm]{python_codes/fieldstone_24/RESULTS/BA_1e6/velocity_stats.pdf}\\
\includegraphics[width=5cm]{python_codes/fieldstone_24/RESULTS/BA_1e6/viscous_dissipation.pdf}
\includegraphics[width=5cm]{python_codes/fieldstone_24/RESULTS/BA_1e6/vrms_adim.pdf}
\includegraphics[width=5cm]{python_codes/fieldstone_24/RESULTS/BA_1e6/work_against_gravity.pdf}
\end{center}
...
\begin{center}
\includegraphics[width=8cm]{python_codes/fieldstone_24/RESULTS/BA_1e6/energy_check1.pdf}
\end{center}
...
\newpage
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section*{NEW Results - Q2Q1 - EBA - Ra=1e4 CFL=0.75}

\begin{center}
\includegraphics[width=5cm]{python_codes/fieldstone_24/RESULTS/EBA_1e4/adiabatic_heating.pdf}
\includegraphics[width=5cm]{python_codes/fieldstone_24/RESULTS/EBA_1e4/gravitational_energy.pdf}
\includegraphics[width=5cm]{python_codes/fieldstone_24/RESULTS/EBA_1e4/kinetic_energy.pdf}\\
\includegraphics[width=5cm]{python_codes/fieldstone_24/RESULTS/EBA_1e4/mass.pdf}
\includegraphics[width=5cm]{python_codes/fieldstone_24/RESULTS/EBA_1e4/Nu.pdf}
\includegraphics[width=5cm]{python_codes/fieldstone_24/RESULTS/EBA_1e4/Tavrg.pdf}\\
\includegraphics[width=5cm]{python_codes/fieldstone_24/RESULTS/EBA_1e4/thermal_energy.pdf}
\includegraphics[width=5cm]{python_codes/fieldstone_24/RESULTS/EBA_1e4/total_heat_flux.pdf}
\includegraphics[width=5cm]{python_codes/fieldstone_24/RESULTS/EBA_1e4/velocity_stats.pdf}\\
\includegraphics[width=5cm]{python_codes/fieldstone_24/RESULTS/EBA_1e4/viscous_dissipation.pdf}
\includegraphics[width=5cm]{python_codes/fieldstone_24/RESULTS/EBA_1e4/vrms_adim.pdf}
\includegraphics[width=5cm]{python_codes/fieldstone_24/RESULTS/EBA_1e4/work_against_gravity.pdf}
\end{center}
...
\begin{center}
\includegraphics[width=8cm]{python_codes/fieldstone_24/RESULTS/EBA_1e4/energy_check1.pdf}
\end{center}

\newpage
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section*{NEW Results - Q2Q1 - EBA - Ra=1e6 CFL=0.75}

\begin{center}
\includegraphics[width=5cm]{python_codes/fieldstone_24/RESULTS/EBA_1e6/adiabatic_heating.pdf}
\includegraphics[width=5cm]{python_codes/fieldstone_24/RESULTS/EBA_1e6/gravitational_energy.pdf}
\includegraphics[width=5cm]{python_codes/fieldstone_24/RESULTS/EBA_1e6/kinetic_energy.pdf}\\
\includegraphics[width=5cm]{python_codes/fieldstone_24/RESULTS/EBA_1e6/mass.pdf}
\includegraphics[width=5cm]{python_codes/fieldstone_24/RESULTS/EBA_1e6/Nu.pdf}
\includegraphics[width=5cm]{python_codes/fieldstone_24/RESULTS/EBA_1e6/Tavrg.pdf}\\
\includegraphics[width=5cm]{python_codes/fieldstone_24/RESULTS/EBA_1e6/thermal_energy.pdf}
\includegraphics[width=5cm]{python_codes/fieldstone_24/RESULTS/EBA_1e6/total_heat_flux.pdf}
\includegraphics[width=5cm]{python_codes/fieldstone_24/RESULTS/EBA_1e6/velocity_stats.pdf}\\
\includegraphics[width=5cm]{python_codes/fieldstone_24/RESULTS/EBA_1e6/viscous_dissipation.pdf}
\includegraphics[width=5cm]{python_codes/fieldstone_24/RESULTS/EBA_1e6/vrms_adim.pdf}
\includegraphics[width=5cm]{python_codes/fieldstone_24/RESULTS/EBA_1e6/work_against_gravity.pdf}
\end{center}
...
\begin{center}
\includegraphics[width=8cm]{python_codes/fieldstone_24/RESULTS/EBA_1e6/energy_check1.pdf}
\end{center}
