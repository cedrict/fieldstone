...
\textcite{scpo03} (2003) derived a simple analytic solution for the pressure and 
velocity fields for a circular inclusion under simple shear and it was used 
in (for example) \cite{deka08,sunh10,dumg11,krhb12,gemd13}.
...
\textcite{deka08} (2008) thoroughly investigated this problem with various 
...
\textcite{dumg11} (2011) obtained a first order convergence for both pressure and velocity, 
while \textcite{krhb12} (2012) and \textcite{gemd13} (2013) showed that the 
use of adaptive mesh refinement in respectively the FEM and FDM 
yields convergence rates which depend on refinement strategies. 

\newpage
The code is run for resolutions $8\times 8$ up to $128\times 128$ and the 
discretization errors are shown hereunder:

\begin{center}
\includegraphics[width=10cm]{python_codes/fieldstone_07/results/errors}\\
{\captionfont Velocity and pressure error convergence as a function of mesh size.}
\end{center}

\begin{center}
\includegraphics[width=10cm]{python_codes/fieldstone_07/results/pressbottom}\\
\includegraphics[width=10cm]{python_codes/fieldstone_07/results/veldiag}\\
