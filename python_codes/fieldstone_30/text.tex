...
\begin{center}
\includegraphics[width=8cm]{python_codes/fieldstone_30/results_dh/markercount_cvi}
\includegraphics[width=8cm]{python_codes/fieldstone_30/results_dh/stdev_cvi}\\
{\captionfont Ref model + influence of CVI.}
\end{center}
