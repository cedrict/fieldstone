...
because python is slow. Most of what follows only goes up to 256x256.   
...
Convergence rate for Q2P1 very suspicious. My guess is that I never implement Q2P1 
outside of square/rectangular elements and I must be doing something quite not 
right here.
...
Also as mentioned before the rates for Q2P1 for D \& H with randomised mesh are weird.
...
\item should I run SolKz with randomised mesh?
