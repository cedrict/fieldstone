...
This \stone takes its origin in the MSc work of Daniel about the subduction interface and
aims at replicating \fullcite{stuw98}.\\ 
In the paper the author proposes a simple mathematical model for the influence 
...
Let us consider Fig.~6 of the paper, where three different sets of rheological constants are used
for $A$ and $Q$.
...
we arrive at the following temperature profiles for values of strain rate 
$10^{-12,-13,-14,-15,-16}~\si{\per\second}$:
...
I have digitized\footnote{\url{https://plotdigitizer.com/app}} the lines of Fig.~6 of the paper
...
Also, by doing so we also find that the lines in the paper are probably for strainrates 
...
When Kelvin units are used, we find that the zero of the function is approximately equal 
