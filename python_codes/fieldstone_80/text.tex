...
%---------------------------------------------------------------
\subsubsection*{The lid driven cavity}
...
\begin{center}
\includegraphics[width=5.6cm]{python_codes/fieldstone_80/results/sphere1p000/bodyforce}
\includegraphics[width=5.6cm]{python_codes/fieldstone_80/results/sphere1p000/vel}
\includegraphics[width=5.6cm]{python_codes/fieldstone_80/results/sphere1p000/p}\\
{\caption velocity and pressure fields for $\delta \rho=1$}
\end{center}

\begin{center}
\includegraphics[width=9cm]{python_codes/fieldstone_80/results/sphere1p000/vrms}\\
