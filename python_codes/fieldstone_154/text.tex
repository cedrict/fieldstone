...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section*{Manufactured solution benchmark}
...
In what follows I set $L_y=1$ for simplicity.
Let us no prescribe $u(y)=y(1-y)$ on the inlet, i.e. a flow with a parabolic profile. 
...
Another avenue could be to think about the first PDE $\Delta \Psi = -\omega$.
