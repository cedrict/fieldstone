...
\begin{flushright} {\tiny {\color{gray} python\_codes/fieldstone\_72/text.tex}} \end{flushright}
...
\begin{center}
\inpython
{\small Code: \url{https://github.com/cedrict/fieldstone/tree/master/python_codes/fieldstone_72}}
\end{center}
...
Use {\tt script\_run\_mms} to run models.
