...
Last revision: January 11th, 2026.
...
\textcite{raab07} (2007),
\textcite{bufs08} (2008).
It has been used to draw a parallel with the tectonics of eastern China in the context of the 
...
In what follows I show results of the rough and smooth punch for a $124\times 68$ mesh. 
The difference between the two lies in the nature of the kinematic boundary conditions 
under the punched area. 'rough' means that the indentor 
...
Note that this code is rather naive: the boundary conditions are applied on the 
fully assembled FE matrix and right hand side. Furthermore the storage of said matrix 
is not sparse. This limits considerably the performance as well as the 
maximum resolution attainable. 



\newpage
%................................................................................
\subsection*{Rough punch} 

\begin{center}
\includegraphics[width=8cm]{python_codes/fieldstone_08/results/rough/velocity.pdf}
\includegraphics[width=8cm]{python_codes/fieldstone_08/results/rough/pressure.pdf}\\
\includegraphics[width=8cm]{python_codes/fieldstone_08/results/rough/strainrate.pdf}
\includegraphics[width=8cm]{python_codes/fieldstone_08/results/rough/stress.pdf}\\
\includegraphics[width=8cm]{python_codes/fieldstone_08/results/rough/u_stats.pdf}
\includegraphics[width=8cm]{python_codes/fieldstone_08/results/rough/v_stats.pdf}\\
\includegraphics[width=8cm]{python_codes/fieldstone_08/results/rough/residual.pdf}
\includegraphics[width=8cm]{python_codes/fieldstone_08/results/rough/diff_uv.pdf}\\
{\captionfont a,b,c,d) velocity, pressure, strainrate and stress at the top of the domain; 
e,f) min/max value of $u$ and $v$; g,h) residual and normalised velocity difference.}
\end{center}
...
%................................................................................
\newpage
\subsection*{Smooth punch}

\begin{center}
\includegraphics[width=8cm]{python_codes/fieldstone_08/results/smooth/velocity.pdf}
\includegraphics[width=8cm]{python_codes/fieldstone_08/results/smooth/pressure.pdf}\\
\includegraphics[width=8cm]{python_codes/fieldstone_08/results/smooth/strainrate.pdf}
\includegraphics[width=8cm]{python_codes/fieldstone_08/results/smooth/stress.pdf}\\
\includegraphics[width=8cm]{python_codes/fieldstone_08/results/smooth/u_stats.pdf}
\includegraphics[width=8cm]{python_codes/fieldstone_08/results/smooth/v_stats.pdf}\\
\includegraphics[width=8cm]{python_codes/fieldstone_08/results/smooth/residual.pdf}
\includegraphics[width=8cm]{python_codes/fieldstone_08/results/smooth/diff_uv.pdf}\\
{\captionfont a,b,c,d) velocity, pressure, strainrate and stress at the top of the domain; 
e,f) min/max value of $u$ and $v$; g,h) residual and normalised velocity difference.}
\end{center}
...
\begin{center}
\includegraphics[width=8cm]{python_codes/fieldstone_08/results/exx}
\includegraphics[width=8cm]{python_codes/fieldstone_08/results/exy}\\
\includegraphics[width=8cm]{python_codes/fieldstone_08/results/sr}
\includegraphics[width=8cm]{python_codes/fieldstone_08/results/vel}\\
\includegraphics[width=8cm]{python_codes/fieldstone_08/results/p}
\includegraphics[width=8cm]{python_codes/fieldstone_08/results/q}
\end{center}
