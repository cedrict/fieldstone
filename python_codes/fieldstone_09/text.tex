\fbox{\parbox{16cm}{{\bf keywords:} \input{python_codes/fieldstone_09/keywords}}}
...
\begin{center}
\includegraphics[width=6cm]{python_codes/fieldstone_09/psi}
\includegraphics[width=6cm]{python_codes/fieldstone_09/psi_arrows}\\
