...
All additional fields ($J$, $\tau$, $\dot\varepsilon$ are computed/stored 
...
Previous versions are available in the folder. 
...
ToDo: remove matrix blocks and normalisation

ToDo: implement pressure normalisation as postprocessor

Remain to explore: 
types of averaging for Z? etaeff ?
...
\newpage
\begin{center}
\includegraphics[width=7cm]{python_codes/fieldstone_64/results/geryaslab/70x70_08_RK1/particles.0000.png}
\includegraphics[width=7cm]{python_codes/fieldstone_64/results/geryaslab/70x70_08_RK1/particles.0005.png}\\
\includegraphics[width=7cm]{python_codes/fieldstone_64/results/geryaslab/70x70_08_RK1/particles.0010.png}
\includegraphics[width=7cm]{python_codes/fieldstone_64/results/geryaslab/70x70_08_RK1/particles.0015.png}\\
\includegraphics[width=7cm]{python_codes/fieldstone_64/results/geryaslab/70x70_08_RK1/particles.0020.png}
\includegraphics[width=7cm]{python_codes/fieldstone_64/results/geryaslab/70x70_08_RK1/particles.0025.png}\\
\includegraphics[width=9cm]{python_codes/fieldstone_64/results/geryaslab/flagged_particles.pdf}
\end{center}

We find that at number of particles constant the difference between RK1 and RK2 is extremely 
small, most likely because the 200yr time step corresponds to a CFL number $<0.05$.
Also the difference between 8x8 and 10x10 particles is negligible (not shown).
Increasing resolution from 50x50 to 60x60 or 70x70 does not seem to yield different results.
...
\newpage
%.......................................................
\subsection*{Stress build-up in viscoelastic Maxwell body}
