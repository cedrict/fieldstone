...
\begin{flushright} {\tiny {\color{gray} python\_codes/fieldstone\_64/text.tex}} \end{flushright}
...
%.......................................................
\paragraph{Disclaimer about this code}
There has been multiple versions of this stone. 
The current one relies on the Particle-in-Cell method. 
All additional fields ($J$, $\tau$, $\dot\varepsilon_{ij}$ are computed/stored 
in the middle of each element. 
...
1st or 2nd order in space) to carry out material tracking/advection and 
of course the elasto-viscous rheology.
Previous versions are still available in the folder. 

Particle properties and coordinates are stored in large arrays 
coined {\tt swarm\_xxx} of size {\tt nparticle}. 
\begin{lstlisting}
...
\end{lstlisting}
Most fields are self-explanatory, but I here recall:
\[
\eta_{eff} = \frac{\eta \;  \delta t}{\delta t + \eta/\mu}
Z = \frac{\eta_{eff}}{\mu \; \delta t}
\]
At the beginning the particles are set on a regular grid inside each element
controlled by the {\tt nparticle\_per\_dim} parameter and a small 
random perturbation is added.
Only particles carry a record of the stress state. Eulerian fields (in this case elemental
fields) are only a projection of marker fields onto the mesh. 

It is also worth noting that experiments 11 and 12 are 
attractive since they are analytical benchmarks, 
but they only involve a single type of material (no averaging of 
properties) and the computed strain rate components are constant in 
space.


ToDo: implement pressure normalisation as postprocessor

As it is now the code is rather slow, asssembly could be 
improved, and probably some parts of the pic components.

\newpage
%.......................................................
\subsection*{Stress build-up in viscoelastic Maxwell body - analytical solution}

{\color{red} ToDo: relocate to chapter on elasto-viscosity?}
...
\newpage
%.......................................................
\subsection*{Experiment=11: Stress build-up in viscoelastic Maxwell body under simple shear }
...
viscoelastic materials gradually build-up stress when sheared after which a 
transition to viscous deformation occurs.  
...
\begin{center}
\includegraphics[width=12cm]{python_codes/fieldstone_64/results/buildup_11/tauxx}\\
{\captionfont $\tau_{xx}$ as a function of time.}
\end{center}


\begin{center}
\includegraphics[width=5.7cm]{python_codes/fieldstone_64/results/buildup_11/tau}
\includegraphics[width=5.7cm]{python_codes/fieldstone_64/results/buildup_11/strainrate}
\includegraphics[width=5.7cm]{python_codes/fieldstone_64/results/buildup_11/velocity}
\end{center}
...
\newpage
%.......................................................
\subsection*{Experiment=12: Stress build-up in viscoelastic Maxwell body under simple shear}
...
\newpage
%.................................
\subsection*{Experiment=2: Bending of elastic slab}
...
The results are calculated on a grid with a resolution of $50\times 50$ elements containing 64 randomly 
...
\begin{center}
\includegraphics[height=4cm]{python_codes/fieldstone_64/images/gerya1}
\includegraphics[height=4cm]{python_codes/fieldstone_64/images/gerya2}
\includegraphics[height=4cm]{python_codes/fieldstone_64/images/gerya3}\\
%\includegraphics[height=4cm]{python_codes/fieldstone_64/results/slab/markers0000}
%\includegraphics[height=4cm]{python_codes/fieldstone_64/results/slab/markers0100}\\
...
\begin{center}
\includegraphics[width=5.2cm]{python_codes/fieldstone_64/results/geryaslab/init/vel}
\includegraphics[width=5.2cm]{python_codes/fieldstone_64/results/geryaslab/init/u}
\includegraphics[width=5.2cm]{python_codes/fieldstone_64/results/geryaslab/init/v}\\
\includegraphics[width=5.2cm]{python_codes/fieldstone_64/results/geryaslab/init/exx}
\includegraphics[width=5.2cm]{python_codes/fieldstone_64/results/geryaslab/init/eyy}
\includegraphics[width=5.2cm]{python_codes/fieldstone_64/results/geryaslab/init/exy}\\
\includegraphics[width=5.2cm]{python_codes/fieldstone_64/results/geryaslab/init/q}
\includegraphics[width=5.2cm]{python_codes/fieldstone_64/results/geryaslab/init/etaeff}
\includegraphics[width=5.2cm]{python_codes/fieldstone_64/results/geryaslab/init/rho}\\
{\captionfont these figs are old, should be redone with latest version of code.}
\end{center}
...
\newpage
\begin{center}
\includegraphics[width=8cm]{python_codes/fieldstone_64/results/geryaslab/stats_u.pdf}
\includegraphics[width=8cm]{python_codes/fieldstone_64/results/geryaslab/stats_v.pdf}\\
\includegraphics[width=8cm]{python_codes/fieldstone_64/results/geryaslab/stats_u_zoom.pdf}
\includegraphics[width=8cm]{python_codes/fieldstone_64/results/geryaslab/stats_v_zoom.pdf}\\
\includegraphics[width=8cm]{python_codes/fieldstone_64/results/geryaslab/stats_tau.pdf}
\includegraphics[width=8cm]{python_codes/fieldstone_64/results/geryaslab/stats_swarm_tau.pdf}\\
\includegraphics[width=8cm]{python_codes/fieldstone_64/results/geryaslab/stats_J.pdf}
\includegraphics[width=8cm]{python_codes/fieldstone_64/results/geryaslab/stats_wxy.pdf}
\end{center}

\newpage
\begin{center}
\includegraphics[width=6cm]{python_codes/fieldstone_64/results/geryaslab/70x70_08_RK1/particles.0000.png}
\includegraphics[width=6cm]{python_codes/fieldstone_64/results/geryaslab/70x70_08_RK1/particles.0005.png}\\
\includegraphics[width=6cm]{python_codes/fieldstone_64/results/geryaslab/70x70_08_RK1/particles.0010.png}
\includegraphics[width=6cm]{python_codes/fieldstone_64/results/geryaslab/70x70_08_RK1/particles.0015.png}\\
\includegraphics[width=6cm]{python_codes/fieldstone_64/results/geryaslab/70x70_08_RK1/particles.0020.png}
\includegraphics[width=6cm]{python_codes/fieldstone_64/results/geryaslab/70x70_08_RK1/particles.0025.png}\\
\includegraphics[width=9cm]{python_codes/fieldstone_64/results/geryaslab/flagged_particles.pdf}
\end{center}

We find that 
\begin{itemize}
\item at number of particles constant, the difference between RK1 and RK2 is extremely 
small, most likely because the 200yr time step corresponds to a CFL number $<0.05$.
\item the difference between $8^2$ and $10^2$ particles is negligible (not shown).
\item increasing resolution from 50x50 to 60x60 or 70x70 does not seem to yield different results.
\item using harmonic averaging on $Z$ does not change results much, statistics look a bit less smooth.
(not shown)
\end{itemize}
...
\begin{center}
\includegraphics[width=5cm]{python_codes/fieldstone_64/results/geryaslab/gerya2/markers_0000_Myr}
\includegraphics[width=5cm]{python_codes/fieldstone_64/results/geryaslab/gerya2/stress_0000_Myr}
\includegraphics[width=5cm]{python_codes/fieldstone_64/results/geryaslab/gerya2/velocity_0000_Myr}\\
\includegraphics[width=5cm]{python_codes/fieldstone_64/results/geryaslab/gerya2/markers_0010_Myr}
\includegraphics[width=5cm]{python_codes/fieldstone_64/results/geryaslab/gerya2/stress_0010_Myr}
\includegraphics[width=5cm]{python_codes/fieldstone_64/results/geryaslab/gerya2/velocity_0010_Myr}\\
\includegraphics[width=5cm]{python_codes/fieldstone_64/results/geryaslab/gerya2/markers_0020_Myr}
\includegraphics[width=5cm]{python_codes/fieldstone_64/results/geryaslab/gerya2/stress_0020_Myr}
\includegraphics[width=5cm]{python_codes/fieldstone_64/results/geryaslab/gerya2/velocity_0020_Myr}\\
\includegraphics[width=5cm]{python_codes/fieldstone_64/results/geryaslab/gerya2/markers_0030_Myr}
\includegraphics[width=5cm]{python_codes/fieldstone_64/results/geryaslab/gerya2/stress_0030_Myr}
\includegraphics[width=5cm]{python_codes/fieldstone_64/results/geryaslab/gerya2/velocity_0030_Myr}\\
\includegraphics[width=5cm]{python_codes/fieldstone_64/results/geryaslab/gerya2/markers_0040_Myr}
\includegraphics[width=5cm]{python_codes/fieldstone_64/results/geryaslab/gerya2/stress_0040_Myr}
\includegraphics[width=5cm]{python_codes/fieldstone_64/results/geryaslab/gerya2/velocity_0040_Myr}\\
\includegraphics[width=5cm]{python_codes/fieldstone_64/results/geryaslab/gerya2/markers_0100_Myr}
\includegraphics[width=5cm]{python_codes/fieldstone_64/results/geryaslab/gerya2/stress_0100_Myr}
\includegraphics[width=5cm]{python_codes/fieldstone_64/results/geryaslab/gerya2/velocity_0100_Myr}\\
...
\newpage
%.......................................................
\subsection*{Experiment=3: Stress build-up in viscoelastic Maxwell body}

{\color{red} presented results were obtained with previous version of code}

This benchmark comes from Appendix B of \textcite{kemk13} (2013).
...
\newpage
%.......................................................
\paragraph{Experiment=4: Flexure of elastic plate}
...
\newpage
%.......................................................
\section*{Experiment=5: Ice sheet load}
