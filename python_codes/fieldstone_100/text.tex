...
\begin{center}
\includegraphics[width=7cm]{python_codes/fieldstone_100/results/one/topography}
\includegraphics[width=7cm]{python_codes/fieldstone_100/results/one/cell_volume}\\
...
\begin{center}
\includegraphics[width=7cm]{python_codes/fieldstone_100/results/half/topography}
\includegraphics[width=7cm]{python_codes/fieldstone_100/results/half/cell_volume}\\
