...
\begin{center}
\inpython
{\small Code: \url{https://github.com/cedrict/fieldstone/tree/master/python_codes/fieldstone_42}}
\end{center}
...
\begin{center}
\includegraphics[width=7cm]{python_codes/fieldstone_42/results/vrms.pdf}
\includegraphics[width=7cm]{python_codes/fieldstone_42/results/prms.pdf}
\end{center}
