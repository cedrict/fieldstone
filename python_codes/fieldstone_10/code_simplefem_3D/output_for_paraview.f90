subroutine output_for_paraview (np,nel,x,y,z,Vx,Vy,Vz,p,icon,eldens)
implicit none
integer np,nel
real(8), dimension(np)    :: x,y,z,Vx,Vy,Vz,p_nodal
real(8), dimension(nel)   :: p,divv,elvisc,eldens
