...
\begin{center}
\includegraphics[width=17.5cm]{python_codes/fieldstone_86/images/setup}\\
...
\begin{center}
\includegraphics[width=8cm]{python_codes/fieldstone_86/results/mats}
\includegraphics[width=8cm]{python_codes/fieldstone_86/results/T}\\
\includegraphics[width=8cm]{python_codes/fieldstone_86/results/dTdy}
\includegraphics[width=8cm]{python_codes/fieldstone_86/results/heatflux}
\end{center}


ToDo: implement heat source ! it is implemented, but not benchmarked, and 
one now needs to find appropriate heat prod values for crustal layers.
