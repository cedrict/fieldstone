...
\begin{center}
\includegraphics[width=8cm]{python_codes/fieldstone_41/RESULTS/exp1/vrms_RK.pdf}
\includegraphics[width=8cm]{python_codes/fieldstone_41/RESULTS/exp1/vrms_RES.pdf}\\
\includegraphics[width=8cm]{python_codes/fieldstone_41/RESULTS/exp1/vrms_CFL.pdf}
\includegraphics[width=8cm]{python_codes/fieldstone_41/RESULTS/exp1/vrms_nmarker.pdf}\\
...
\begin{center}
\includegraphics[width=7cm]{python_codes/fieldstone_41/RESULTS/exp1/mass.pdf}
\includegraphics[width=7cm]{python_codes/fieldstone_41/RESULTS/exp1/nmarker.pdf}
\end{center}

\begin{center}
\includegraphics[width=5cm]{python_codes/fieldstone_41/RESULTS/exp1/64x64_10_RK3/markers0000}
\includegraphics[width=5cm]{python_codes/fieldstone_41/RESULTS/exp1/64x64_10_RK3/markers0143}
\includegraphics[width=5cm]{python_codes/fieldstone_41/RESULTS/exp1/64x64_10_RK3/rho_nodal_0143}\\
