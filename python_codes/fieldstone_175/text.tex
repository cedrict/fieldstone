...
\newpage
%-----------------------------------------------------
\section*{A not so simple approach - moving to 2d}

{\color{red} I need to merge this section with the next one, they kinda both contain the 
same info!!!}
...
\includegraphics[width=9cm]{python_codes/fieldstone_175/results/exp3/vel2.png}\\
{\captionfont Analytical $\vec{\upnu}_d$ - I need to produce better figs, not sure which 
dilation bands thickness I have used here.}
\end{center}
...
{\captionfont pressure should be normalised. will do so asap.}
\end{center}
