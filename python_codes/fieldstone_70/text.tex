...
\begin{flushright} {\tiny {\color{gray} python\_codes/fieldstone\_70/text.tex}} \end{flushright}

%\lstinputlisting[language=bash,basicstyle=\small]{python_codes/fieldstone_70/keywords.ascii}

\begin{center}
\inpython
{\small Code: \url{https://github.com/cedrict/fieldstone/tree/master/python_codes/fieldstone_70}}
\end{center}

\par\noindent\rule{\textwidth}{0.4pt}

Last revision: March 7th, 2026.
...
\begin{center}
\includegraphics[width=8cm]{python_codes/fieldstone_70/images/fig2}\\
{\captionfont Figure taken from \cite{dudy20}}
\end{center}
...
\subsection*{resolution 100x30 elements}
\begin{center}
\includegraphics[width=7cm]{python_codes/fieldstone_70/RESULTS/100x30/conv_compression.pdf}
\includegraphics[width=7cm]{python_codes/fieldstone_70/RESULTS/100x30/conv_extension.pdf}\\
\includegraphics[width=7cm]{python_codes/fieldstone_70/RESULTS/100x30/exy_compression.pdf}
\includegraphics[width=7cm]{python_codes/fieldstone_70/RESULTS/100x30/exy_extension.pdf}\\
\includegraphics[width=7cm]{python_codes/fieldstone_70/RESULTS/100x30/pressure_compression.pdf}
\includegraphics[width=7cm]{python_codes/fieldstone_70/RESULTS/100x30/pressure_extension.pdf}
\end{center}

\subsection*{resolution 150x45 elements}
\begin{center}
\includegraphics[width=7cm]{python_codes/fieldstone_70/RESULTS/150x45/conv_compression.pdf}
\includegraphics[width=7cm]{python_codes/fieldstone_70/RESULTS/150x45/conv_extension.pdf}\\
\includegraphics[width=7cm]{python_codes/fieldstone_70/RESULTS/150x45/exy_compression.pdf}
\includegraphics[width=7cm]{python_codes/fieldstone_70/RESULTS/150x45/exy_extension.pdf}\\
\includegraphics[width=7cm]{python_codes/fieldstone_70/RESULTS/150x45/pressure_compression.pdf}
\includegraphics[width=7cm]{python_codes/fieldstone_70/RESULTS/150x45/pressure_extension.pdf}
\end{center}
