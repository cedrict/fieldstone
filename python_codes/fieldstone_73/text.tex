...
%...............................................
\subsection*{Building the connectivity array}
...
In the end we can look at timings for matrix building, 
applying boundary conditions, solving the system and 
computing discretisation errors (simply use {\tt script}):

\begin{center}
\includegraphics[width=8cm]{./python_codes/fieldstone_73/RESULTS/times.pdf}
\includegraphics[width=8cm]{./python_codes/fieldstone_73/RESULTS/errors.pdf}
\end{center}

It is obvious that the current way of 
imposing boundary conditions on the whole assembled
FE matrix is inefficient.
