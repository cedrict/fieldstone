...
import time as time
import matplotlib.pyplot as plt #------------------------------------------------------------> additional import
    ...
    for ic in case_loop:
        for ir in res_loop: 
                    ...
                    for iiter in range(0,niter):
                        ...
                        np.savetxt('xi.ascii',np.array([xi[0:iiter]]).T,header='# xi')
                    ...
                    if xi[iiter]>tol: 
                        nonconverged.append('niter=%s, tol=%s, case=%s, nelx=%s' % (niter, it, ic, ir))
                    #end for iter
                    ...
                    np.savetxt('horizontal_case=%s_nelx=%s.ascii' % (ic, ir),np.array([xp,yp,rhop,etap,exxp,eyyp,exyp,exxp2,eyyp2,exyp2]).T,header='# x,y,rho,eta')
                    ...
                    np.savetxt('vertical_case%s_nelx=%s.ascii' % (ic, ir),np.array([xp,yp,rhop,etap,exxp,eyyp,exyp,exxp2,eyyp2,exyp2]).T,header='# x,y,rho,eta')
                    ...
                    if matplotlib:
                        ...
                        plt.savefig('y-axisplot_tol=e'+str(int(np.log(it))))
                    ...
                    if visu==1:
                       ...
                       vtufile.write("</DataArray>\n")
                       #--
                       vtufile.write("<DataArray type='Float32' NumberOfComponents='1' Name='exx'> \n")
                       for iel in range (0,nel):
                           vtufile.write("%10e\n" % exx[iel])
                       vtufile.write("</DataArray>\n")
                       #--
                       vtufile.write("<DataArray type='Float32' NumberOfComponents='1' Name='eyy'> \n" )
                       for iel in range (0,nel):
                           vtufile.write("%10e\n" % eyy[iel])
                       vtufile.write("</DataArray>\n")
                       #--
                       vtufile.write("<DataArray type='Float32' NumberOfComponents='1' Name='exy'> \n")
                       for iel in range (0,nel):
                           vtufile.write("%10e\n" % exy[iel])
                       vtufile.write("</DataArray>\n")
                       #--
                       vtufile.write("<DataArray type='Float32' NumberOfComponents='1' Name='density'> \n")
                       for iel in range(0,nel):
                           vtufile.write("%5e \n" % rho[iel])
                       vtufile.write("</DataArray>\n")
                       #--
                       vtufile.write("<DataArray type='Float32' NumberOfComponents='1' Name='viscosity'> \n")
                       for iel in range(0,nel):
                           vtufile.write("%5e \n" % eta[iel])
                       vtufile.write("</DataArray>\n")
                       #--
                       ...
                       #--
                       vtufile.write("<DataArray type='Float32' NumberOfComponents='3' Name='velocity (cm/year)'> \n" )
                       for i in range(0,NV):
                           vtufile.write("%10e %10e %10e \n" %(u[i]*year/cm,v[i]*year/cm,0.))
                       vtufile.write("</DataArray>\n")
                       #--
                       vtufile.write("<DataArray type='Float32' Name='exx'> \n" )
                       for i in range(0,NV):
                           vtufile.write("%10e \n" % exxn[i] )
                       vtufile.write("</DataArray>\n")
                       #--
                       vtufile.write("<DataArray type='Float32' Name='eyy'> \n" )
                       for i in range(0,NV):
                           vtufile.write("%10e \n" % eyyn[i] )
                       vtufile.write("</DataArray>\n")
                       #--
                       vtufile.write("<DataArray type='Float32' Name='exy'> \n" )
                       for i in range(0,NV):
                           vtufile.write("%10e \n" % exyn[i] )
                       vtufile.write("</DataArray>\n")
                       #--
                       vtufile.write("<DataArray type='Float32' Name='p'> \n" )
                       for i in range(0,NV):
                           vtufile.write("%10e \n" % q[i] )
                       vtufile.write("</DataArray>\n")
                       #--
                       ...
                       vtufile.write("</DataArray>\n")
                       #--
                       vtufile.write("<DataArray type='Int32' Name='types'>\n" )
                       for iel in range (0,nel):
                           vtufile.write("%d \n" %9)
                       vtufile.write("</DataArray>\n")
                       #--
