...
def dNNVdr(rq,sq,CR):
    if CR:
       ...
       arr=np.array([dNVdr_0,dNVdr_1,dNVdr_2,dNVdr_3,dNVdr_4,dNVdr_5,dNVdr_6])
       return arr
    else:
       dNVdr_0= -3+4*rq+4*sq 
       dNVdr_1= -1+4*rq
       ...
       dNVdr_4= 4*sq
       dNVdr_5= -4*sq
       arr=np.array([dNVdr_0,dNVdr_1,dNVdr_2,dNVdr_3,dNVdr_4,dNVdr_5])
       return arr
...
def dNNVds(rq,sq,CR):
    if CR:
       ...
       arr=np.array([dNVds_0,dNVds_1,dNVds_2,dNVds_3,dNVds_4,dNVds_5,dNVds_6])
       return arr
    else:
       dNVds_0= -3+4*rq+4*sq 
       dNVds_1= 0
       ...
       dNVds_4= +4*rq
       dNVds_5= 4-4*rq-8*sq
       arr=np.array([dNVds_0,dNVds_1,dNVds_2,dNVds_3,dNVds_4,dNVds_5])
       return arr
