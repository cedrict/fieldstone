...
\begin{center}
\includegraphics[width=5cm]{python_codes/fieldstone_96/images/rho}
\includegraphics[width=5cm]{python_codes/fieldstone_96/images/eta}
\includegraphics[width=5cm]{python_codes/fieldstone_96/images/mesh}
\end{center}
