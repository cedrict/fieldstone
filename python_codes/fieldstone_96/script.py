...
for x in list_x:
    sys.argv = ["stone.py",x,2385e3,3200,1e21,1,'solutions/R_blob/%s/'%(x),40e3,'4layer',R_outer-60e3,R_outer-450e3,3100,3400,1e21,3500]
...
for x in list_x:
    sys.argv = ["stone",200e3, x ,3200,1e21,1,'solutions/z_blob/%s/'%(x),40e3,'4layer',R_outer-60e3,R_outer-450e3,3100,3400,1e21,3500]
    exec(open("./stone.py").read())

## blob rho ## 
list_x = np.linspace(3000,4000, num=11, endpoint=True )
for x in list_x:
    sys.argv = ["stone",200e3, 2385e3 , x,1e21,1,'solutions/rho_blob/%s/'%(x),40e3,'4layer',R_outer-60e3,R_outer-450e3,3100,3400,1e21,3500]
    exec(open("./stone.py").read())

## blob eta ##
list_x = [1e19,1e20,6e20,1e21,5e21,1e22,5e22,1e23,5e23,1e24,5e24,1e25]
for x in list_x:
    sys.argv = ["stone",200e3, 2385e3 , 3200, x,1,'solutions/eta_blob/%s/'%(x),40e3,'4layer',R_outer-60e3,R_outer-450e3,3100,3400,1e21,3500]
    exec(open("./stone.py").read())
    
## blob eccentricity ##
list_x = np.linspace(0.5,1,num=11,endpoint=True)
for x in list_x:
...
for x in list_x:
    sys.argv = ["stone.py",200e3,2385e3,3200,1e21,1,'solutions/Resolution/%s/'%(x),x,'4layer',R_outer-60e3,R_outer-450e3,3100,3400,1e21,3500]
    exec(open("./stone.py").read())

# radial_model ##
list_x = ['4layer','steinberger','samuelA','samuelB'] #
for x in list_x:
    sys.argv = ["stone.py",200e3,2385e3,3200,1e21,1,'solutions/Profiles/%s/'%(x),40e3,x,R_outer-60e3,R_outer-450e3,3100,3400,1e21,3500]
    exec(open("./stone.py").read())
...
for x in list_x:
    sys.argv = ["stone.py",200e3,2385e3,3200,1e21,1,'solutions/R_disc1/%s/'%(x),40e3,'4layer',x,R_outer-450e3,3100,3400,1e21,3500]
    exec(open("./stone.py").read())   

## lithosphere thickness ##
list_x = np.linspace(R_outer-400e3,R_outer-600e3,num=11,endpoint=True)
for x in list_x:
    sys.argv = ["stone.py",200e3,2385e3,3200,1e21,1,'solutions/R_disc2/%s/'%(x),40e3,'4layer',R_outer-60e3,x,3100,3400,1e21,3500]
    exec(open("./stone.py").read()) 

## Crustal density ##
list_x = np.linspace(2700,3300,num=7,endpoint=True)
for x in list_x:
    sys.argv = ["stone.py",200e3,2385e3,3200,1e21,1,'solutions/rho_crust/%s/'%(x),40e3,'4layer',R_outer-60e3,R_outer-450e3,x,3400,1e21,3500]
    exec(open("./stone.py").read()) 
    
## Lithosphere density ##
list_x = np.linspace(3300,3500,num=11,endpoint=True)
for x in list_x:
    sys.argv = ["stone.py",200e3,2385e3,3200,1e21,1,'solutions/rho_lith/%s/'%(x),40e3,'4layer',R_outer-60e3,R_outer-450e3,3100,x,1e21,3500]
    exec(open("./stone.py").read()) 
...
for x in list_x:
    sys.argv = ["stone.py",200e3,2385e3,3200,1e21,1,'solutions/eta_lith/%s/'%(x),40e3,'4layer',R_outer-60e3,R_outer-450e3,3100,3400,x,3500]
    exec(open("./stone.py").read()) 
    
## Mantle density ##
list_x = np.linspace(3300,3500,num=11,endpoint=True)
for x in list_x:
    sys.argv = ["stone.py",200e3,2385e3,3200,1e21,1,'solutions/rho_mantle/%s/'%(x),40e3,'4layer',R_outer-60e3,R_outer-450e3,3100,3400,1e21,x]
    exec(open("./stone.py").read())
