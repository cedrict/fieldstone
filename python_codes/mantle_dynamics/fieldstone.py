...
for istep in range(0,nstep):
    ...
    print("T conv, T_diff, <T>: " , T_diff<tol*Tavrg,T_diff,Tavrg)
    print("u conv, u_diff, <u>: " , u_diff<tol*vrms,u_diff,vrms)
    print("v conv, v_diff, <v>: " , v_diff<tol*vrms,v_diff,vrms)
