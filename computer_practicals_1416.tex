...
{\small
\begin{verbatim}
https://raw.githubusercontent.com/cedrict/fieldstone/master/python_codes/md/fieldstone.py
\end{verbatim}
}
...
\item Explore the effect of the aspect ratio of the domain on $\Ranb_c$ and the slope $\beta$.
...
\item Bonus: change the viscosity function so that the viscosity 1 in the lower half of the domain 
