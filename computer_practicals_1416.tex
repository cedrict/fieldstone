...
also \textcite{fuky07} (2007), \textcite{kore03} (2003) and \textcite{olso87} (1987)).
...
download icon indicating 'Download raw file'. Save the downloaded file in a dedicated folder. 
...
plots with python (matplotlib) or gnuplot ({\it no} excel). They need to be 
labeled, captioned, and their axes captioned too.  
You will find help in Chapter~\ref{app_gnuplot} and \ref{app:paraview}. 

Have a good look at the code, read {\bf all} instructions, and carry out the following tasks:
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%FILE containing solution plots !!!!
%\input{1416}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
