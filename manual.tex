...
\newcommand{\Literature}{\includegraphics[height=4mm]{images/lit} {\sffamily Literature}}
...
{\scriptsize With contributions from: Wolfgang Bangerth, Eric van den Hoogen, Job Mos, Erik van der Wiel, Lukas van de Wiel, Alraune Zech, Wim Spakman. }
\newpage
...
\subsection{What is a fieldstone?} \input{whatisafieldstone} %-----------------
...
\subsection{Bibliography} \input{mybib} %--------------------------------------
...
\newpage %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Topics in (computational) geodynamics} \label{app:topics} \input{topics}%%%%%%%%
\newpage %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\printindex{stones}{Codes features} %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
