...
\input{python_codes/fieldstone_saddlepoint_q1p0/text}

\newpage
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{{\tt fieldstone}: solving the full saddle point problem with Schur complement approach \label{sec_fspq1p0sc}}
\input{python_codes/fieldstone_saddlepoint_q1p0_schurcomplement/text}
...
\input{python_codes/fieldstone_slab_detachment1/text}
