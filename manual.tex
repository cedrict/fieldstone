...
17 & $Q_2 \times Q_1$ & saddle point & mixed   & Burstedde benchmark         & 3 &       &        & &\\ 
   &                  & + full matrix& &&&&&&\\    
\hline
18 & $Q_2 \times Q_1$ & saddle point & mixed   & analytical benchmark        & 2 &       &        & &\\ 
   &                  & + full matrix& &&&&&&\\    
\hline
19 & $Q_3 \times Q_2$ & saddle point & mixed   & analytical benchmark        & 2 &       &        & &\\ 
   &                  & + full matrix& &&&&&&\\    
\hline
20 & $Q_1 \times P_0$ &              & penalty & Busse convection            & 3 & $\dag$& $\dag$ & &\\ 
\hline
21 & Rannacher-Turek  &              & penalty & analytical benchmark        & 2 &       &        & &\\ 
\hline
22 & $Q_1 \times Q_1$-stab & saddle point  & mixed & analytical benchmark    & 2 &       &        & &\\ 
   &                  & + full matrix& &&&&&&\\    
\hline
...
\hline
25 & $Q_1 \times P_0$ & saddle point & mixed  & Rayleigh-Taylor instability  & 2 &       &        & & \\ 
   &                  & + full matrix& &&&&&&\\    
\hline
26 & $Q_1 \times P_0$ & saddle point & mixed  & Slab detachment              & 2 &       &        & $\dag$ & \\ 
   &                  & + full matrix& &&&&&&\\
\hline
\hline
\end{tabular}
