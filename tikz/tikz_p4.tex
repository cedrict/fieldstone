...
\node[] at (0.2,0.2) {\scriptsize $1$};
\node[] at (1.2,0.2) {\scriptsize $2$};
\node[] at (2.2,0.2) {\scriptsize $3$};
\node[] at (3.2,0.2) {\scriptsize $4$};
\node[] at (4.2,0.2) {\scriptsize $5$};

\node[] at (0.2,1.2) {\scriptsize $6$};
\node[] at (1.2,1.2) {\scriptsize $7$};
\node[] at (2.2,1.2) {\scriptsize $8$};
\node[] at (3.2,1.2) {\scriptsize $9$};

\node[] at (0.2,2.2) {\scriptsize $10$};
\node[] at (1.2,2.2) {\scriptsize $11$};
\node[] at (2.2,2.2) {\scriptsize $12$};

\node[] at (0.2,3.2) {\scriptsize $13$};
\node[] at (1.2,3.2) {\scriptsize $14$};

\node[] at (0.2,4.2) {\scriptsize $15$};
