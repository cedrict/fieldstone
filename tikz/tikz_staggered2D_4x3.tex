...
\node[] at (0.8,2.8) {\tiny \color{teal} 5};
\node[] at (2.8,2.8) {\tiny \color{teal} 6};
\node[] at (4.8,2.8) {\tiny \color{teal} 7};
\node[] at (6.8,2.8) {\tiny \color{teal} 8};

\node[] at (0.8,4.8) {\tiny \color{teal} 9};
\node[] at (2.8,4.8) {\tiny \color{teal} 10};
\node[] at (4.8,4.8) {\tiny \color{teal} 11};
\node[] at (6.8,4.8) {\tiny \color{teal} 12};
...
\node[] at (-0.2,2.8) {\tiny \color{violet} 6};
\node[] at (1.8,2.8) {\tiny \color{violet} 7};
\node[] at (3.8,2.8) {\tiny \color{violet} 8};
\node[] at (5.8,2.8) {\tiny \color{violet} 9};
\node[] at (7.8,2.8) {\tiny \color{violet} 10};

\node[] at (-0.2,4.8){\tiny \color{violet} 11};
\node[] at (1.8,4.8) {\tiny \color{violet} 12};
\node[] at (3.8,4.8) {\tiny \color{violet} 13};
\node[] at (5.8,4.8) {\tiny \color{violet} 14};
\node[] at (7.8,4.8) {\tiny \color{violet} 15};
...
\node[] at (0.8,1.8) {\tiny \color{orange} 5};
\node[] at (2.8,1.8) {\tiny \color{orange} 6};
\node[] at (4.8,1.8) {\tiny \color{orange} 7};
\node[] at (6.8,1.8) {\tiny \color{orange} 8};

\node[] at (0.8,3.8) {\tiny \color{orange} 9};
\node[] at (2.8,3.8) {\tiny \color{orange} 10};
\node[] at (4.8,3.8) {\tiny \color{orange} 11};
\node[] at (6.8,3.8) {\tiny \color{orange} 12};

\node[] at (0.8,5.8) {\tiny \color{orange} 13};
\node[] at (2.8,5.8) {\tiny \color{orange} 14};
\node[] at (4.8,5.8) {\tiny \color{orange} 15};
\node[] at (6.8,5.8) {\tiny \color{orange} 16};
...
\node[] at (-0.2,1.8){\tiny 6};
\node[] at (1.8,1.8) {\tiny 7};
\node[] at (3.8,1.8) {\tiny 8};
\node[] at (5.8,1.8) {\tiny 9};
\node[] at (7.8,1.8) {\tiny 10};

\node[] at (-0.2,3.8){\tiny 11};
\node[] at (1.8,3.8) {\tiny 12};
\node[] at (3.8,3.8) {\tiny 13};
\node[] at (5.8,3.8) {\tiny 14};
\node[] at (7.8,3.8) {\tiny 15};

\node[] at (-0.2,5.8){\tiny 16};
\node[] at (1.8,5.8) {\tiny 17};
\node[] at (3.8,5.8) {\tiny 18};
\node[] at (5.8,5.8) {\tiny 19};
\node[] at (7.8,5.8) {\tiny 20};
