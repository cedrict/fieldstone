...
%\node[] at (2.9,3.1) {2};
%\node[] at (0.9,3.2) {3};
\draw[violet] (1,0.5) circle (4pt);
\draw[violet] (3.25,0.75) circle (4pt);
\draw[violet] (4,1.5) circle (4pt);
\draw[violet] (2,1.75) circle (4pt);
\draw[violet] (0.5,2.5) circle (4pt);
\draw[violet] (3,3) circle (4pt);
\draw[violet] (4.25,3.75) circle (4pt);
\draw[violet] (1.75,3.5) circle (4pt);
