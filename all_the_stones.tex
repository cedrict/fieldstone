...
\chapter{Solving the diagenetic A-D-R equations with the Method of Lines \label{f158}} %%%%%%%%%%%%%%%%%%%%%% 158
...
\chapter{Implementing the $Q_{k+1,k}\times Q_{k,k+1} \times Q_{k}^-$ element \label{f161}} %%%%%%%%%%%%%%%%%% 161
