...
\begin{remark}
What follows is automatically generated by running the extract\_lists\_by\_pictogram bash script.
\end{remark}

\input{PICTO_LIST.tex}
...
\chapter{Solving the full saddle point problem in 2d ($Q_2\times Q_1$) \label{f18}} %%%%%%%%%%%%%%%%%%%%%%%%% 18
...
\chapter{compressible flow (1) - analytical benchmark ($Q_1\times P_0$, $Q_2\times Q_1$)\label{f23}} %%%%%%%% 23
...
\chapter{Stokes flow, Particle-in-Cell and structural restoration (\QtwoQone) \label{f41}} %%%%%%%% 41
...
\chapter{Elasto-viscous benchmarks ($Q_2\times Q_1$)\label{f64}} %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 64
...
\chapter{the corner flow - Subduction benchmark ($P_2^+\times P_{-1}$)  \label{f68}} %%%%%%%%%%%%%%%%%%%%%%%%% 68
...
\chapter{Fast Stokes solver using python functionalities (\QonePzero + penalty)\label{f73}} %%%%%%%%%%%%%%%%%% 73
...
\chapter{Boussinesq, Love magma chamber 3d elastic problems ($Q_1$)\label{f123}} %%%%%%%%%%%%%%%%%%%%%%%%%%%% 123
...
\chapter{Solving the Stokes system 23 different ways ($Q_2\times Q_1$)} %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 147
\input{python_codes/fieldstone_147/text} %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\chapter{Viscous coupling at mid-oceanic ridges \label{f148}} %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 148
\input{python_codes/fieldstone_148/text} %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\chapter{van Keken et al 2008 benchmark with bespoke quad mesh ($Q_1^+\times Q_1$) \label{f149}} %%%%%%%%%%%% 149
...
\chapter{A faster way to assemble FEM matrices - a new take ($Q_2\times Q_1$, 2d) \label{f182}} %%%%%%%%%%%%% 182
\input{python_codes/fieldstone_182/text} %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\chapter{Initial temperature and pressure profiles for planets \label{f183}} %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 183
\input{python_codes/fieldstone_183/text} %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\chapter{Compressible convection in 2d ($Q_1\times P_0$) \label{f184}} %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 184
\input{python_codes/fieldstone_184/text} %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\chapter{Stress around a borehole in 3d ($Q_1$) \label{f185}} %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 185
\input{python_codes/fieldstone_185/text} %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
