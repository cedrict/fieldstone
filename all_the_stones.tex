...
\newpage %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section*{
Stone 65: steady-state advection-diffusion ($Q_1$)
\label{f65}} 
\addcontentsline{toc}{section}{\protect\numberline{} 
Stone 65: steady-state advection-diffusion ($Q_1$)
}
...
\newpage %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section*{
Stone 70: Visco-Viscoplastic rheology in crustal model with inclusion ($Q_2\times Q_1$)
\label{f70}} 
\addcontentsline{toc}{section}{\protect\numberline{} 
Stone 70: Visco-Viscoplastic rheology in crustal model with inclusion ($Q_2\times Q_1$)
}
...
%\newpage %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\section*{
%Stone 72: quadrilateral MINI - the $Q_1^+\times Q_1$ element
%\label{f72}} 
%\addcontentsline{toc}{section}{\protect\numberline{} 
%Stone 72: quadrilateral MINI - the $Q_1^+\times Q_1$ element
%}
...
\newpage %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section*{
Stone 83: Thermal structure of oceanic and continental lithosphere ($Q_1,Q_2$)
\label{f83}}
\addcontentsline{toc}{section}{\protect\numberline{} 
Stone 83: Thermal structure of oceanic and continental lithosphere ($Q_1,Q_2$)
}
...
\newpage %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section*{
Stone 118: subduction initiation in the 80's ($Q_2\times Q_1$) 
\label{f118}}
\addcontentsline{toc}{section}{\protect\numberline{} 
Stone 118: subduction initiation in the 80's ($Q_2\times Q_1$) 
}
...
\newpage %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section*{
Stone 125: Building Voronoi cells 
\label{f125}}
\addcontentsline{toc}{section}{\protect\numberline{} 
Stone 125: Building Voronoi cells 
}
...
\newpage %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section*{
Stone 127: circular inclusion in simple shear ($P_2^+\times P_{-1}$)
\label{f127}}
\addcontentsline{toc}{section}{\protect\numberline{} 
Stone 127: circular inclusion in simple shear ($P_2^+\times P_{-1}$)
}
...
\newpage %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section*{
Stone 128: fluid flow in porous media - Simpson book chapter 10 ($Q_1$)
\label{f128}}
\addcontentsline{toc}{section}{\protect\numberline{} 
Stone 128: fluid flow in porous media - Simpson book chapter 10 ($Q_1$)
}
...
\newpage %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section*{
Stone 129: Visco-elastic materials - Simpson book chapter 12 ($Q_2$)
\label{f129}}
\addcontentsline{toc}{section}{\protect\numberline{} 
Stone 129: Visco-elastic materials - Simpson book chapter 12 ($Q_2$)
}
...
\newpage %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section*{
Stone 130: Reaction-diffusion ($Q_1$) - Simpson book chapter 7
\label{f130}}
\addcontentsline{toc}{section}{\protect\numberline{} 
Stone 130: Reaction-diffusion ($Q_1$) - Simpson book chapter 7
}
...
\newpage %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section*{
Stone 131: creating triangular meshes with python 
\label{f131}}
\addcontentsline{toc}{section}{\protect\numberline{} 
Stone 131: creating triangular meshes with python 
}
...
\newpage %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section*{
Stone 132: gravity field of a mass circle
\label{f132}}
\addcontentsline{toc}{section}{\protect\numberline{} 
Stone 132: gravity field of a mass circle
}
...
\newpage %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section*{
Stone 133: gravity field of an asteroid
\label{f133}}
\addcontentsline{toc}{section}{\protect\numberline{} 
Stone 133: gravity field of an asteroid
}
...
\newpage %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section*{
Stone 135: SLAB2 data visualisation
\label{f135}}
\addcontentsline{toc}{section}{\protect\numberline{} 
Stone 135: SLAB2 data visualisation
}
...
\newpage %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section*{
Stone 136: RUM slabs visualisation
\label{f136}}
\addcontentsline{toc}{section}{\protect\numberline{} 
Stone 136: RUM slabs visualisation
}
...
\newpage %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section*{
Stone 139: Evolution of a 1D River Profile
\label{f139}}
\addcontentsline{toc}{section}{\protect\numberline{} 
Stone 139: Evolution of a 1D River Profile 
}
...
\newpage %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section*{
Stone 140: Evolution of a Fluvially Dissected Landscape 
\label{f140}}
\addcontentsline{toc}{section}{\protect\numberline{} 
Stone 140: Evolution of a Fluvially Dissected Landscape 
}
...
\newpage %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section*{
Stone 141: The 'Beaumont' mantle temperature trick 
\label{f141}}
\addcontentsline{toc}{section}{\protect\numberline{} 
Stone 141: The 'Beaumont' mantle temperature trick 
}
