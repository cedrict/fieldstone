...
\chapter{A new way to assemble FEM matrices ($Q_1\times P_0$+penalty, 2d) \label{f176}} %%%%%%%%%%%%%%%%%%%%% 176
\input{python_codes/fieldstone_176/text} %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\chapter{A 'new' way to build FEM matrices for the energy equation ($Q_1$, 2d) \label{f177}} %%%%%%%%%%%%%%%% 177
...
\chapter{Elastic deformation in 2d L-shaped domain ($P_1$) \label{f179}} %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 179
