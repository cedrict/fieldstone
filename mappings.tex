...
We have seen in Section~\ref{XXX} that since
\[
x(r,s)=\sum_i N_i(r,s) x_i 
\qquad
y(r,s)=\sum_i N_i(r,s) y_i 
\]
we have 
\begin{eqnarray}
\frac{\partial N_i}{\partial r} &=&
\frac{\partial N_i}{\partial x}\frac{\partial x}{\partial r}
+\frac{\partial N_i}{\partial y}\frac{\partial y}{\partial r} \\
\frac{\partial N_i}{\partial s} &=&
\frac{\partial N_i}{\partial x}\frac{\partial x}{\partial s}
+\frac{\partial N_i}{\partial y}\frac{\partial y}{\partial s}
\end{eqnarray}
or in matrix form:
\[
\left(
