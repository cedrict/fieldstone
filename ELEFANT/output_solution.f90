...
write(123,*) '<DataArray type="Float32" Name="left" Format="ascii">'
do iel=1,nel
...
write(123,*) '<DataArray type="Float32" Name="right" Format="ascii">'
do iel=1,nel
...
write(123,*) '<DataArray type="Float32" Name="bottom" Format="ascii">'
do iel=1,nel
...
write(123,*) '<DataArray type="Float32" Name="top" Format="ascii">'
do iel=1,nel
   ...
   do iel=1,nel
      do i=1,4
         write(123,*) mesh(iel)%a_rho+&
                      mesh(iel)%b_rho*mesh(iel)%xV(i)+&
                      mesh(iel)%c_rho*mesh(iel)%yV(i)
         end do
   end do
else
   do iel=1,nel
