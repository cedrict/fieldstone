...
if (ndim==2) then
   ...
   call compute_dNdx_dNdy(rc,sc,dNNNUdx,dNNNUdy,dNNNVdx,dNNNVdy,jcob)
   ...
   write(*,'(a,2es10.3)') shift//'exx (m/M):',exx_min,exx_max
   write(*,'(a,2es10.3)') shift//'exx (m/M):',eyy_min,eyy_max
   write(*,'(a,2es10.3)') shift//'exx (m/M):',exy_min,exy_max
   ...
   write(*,'(a,2es10.3)') shift//'exx (m/M):',exx_min,exx_max
   write(*,'(a,2es10.3)') shift//'exx (m/M):',eyy_min,eyy_max
   write(*,'(a,2es10.3)') shift//'exx (m/M):',ezz_min,ezz_max
   write(*,'(a,2es10.3)') shift//'exx (m/M):',exy_min,exy_max
   write(*,'(a,2es10.3)') shift//'exx (m/M):',exz_min,exz_max
   write(*,'(a,2es10.3)') shift//'exx (m/M):',eyz_min,eyz_max
