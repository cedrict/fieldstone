...
integer :: mVel                   ! number of velocity dofs per element
...
integer :: NfemVel                ! total number of velocity dofs
...
real(8) :: CFL_nb                 ! CFL number
real(8) :: inner_radius           ! inner radius of annulus or shell 
real(8) :: outer_radius           ! outer radius of annulus or shell 
...
implicit none
write(*,'(a,2i10)')    ' ndim,ndim2              =',ndim,ndim
...
write(*,'(a,6i10)')    ' mU,mV,mW,mP,mT,mVel     =',mU,mV,mW,mP,mT,mVel
