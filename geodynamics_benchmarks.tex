...
\cite{zihl75,zihp95,chpe01,chan99,huhy99,yuti06,bufs08,raab07,gltf18} and has been used to draw a parallel with the tectonics of eastern China in the context of the 
India-Eurasia collision \cite{tamo76,mota77,engl82}.
...
The following parameters are used: $L_x=1$, $L_y=0.5$, $\mu_{min}=0.01$, $\mu_{max}=10^4$, $v_p=1$, $\delta=0.123456789$ 
