...
\newpage
%====================================================================
\section{Rayleigh–Taylor wave instability benchmark \label{ss:rtwave}}
\input{benchmark_rtwave}
...
\paragraph{In two dimensions} The time dependent version of 
the experiment is for instance to be found 
in \textcite{gery10} and the same is repeated in \textcite{thie11} (2011).
See also Appendix D of \textcite{momy26} (2026).
...
There are many variants of this problem: 2D in Turek \cite{turek}, 
3D in John \cite{john02}.
...
%................................................................................
\section{Viscous flow around many cylinders in 2D} \label{sec:flowcyls}
\input{flow_kotd19}
...
\end{eqnarray}
Note that the coordinates in the equation above are actually centered on 
the middle of the cylinder (this also means that we never divide by zero outside
the cylinder!)
