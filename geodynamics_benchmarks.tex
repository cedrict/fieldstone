...
\begin{center}
\includegraphics[width=6cm]{images/benchmark_ldc_anal/velo.png}
\includegraphics[width=6cm]{images/benchmark_ldc_anal/press.png}
\end{center}
...
\begin{center}
\includegraphics[width=5cm]{images/benchmark_heatcyl/u.png}
\includegraphics[width=5cm]{images/benchmark_heatcyl/w.png}
\includegraphics[width=5cm]{images/benchmark_heatcyl/vel.png}
\end{center}
