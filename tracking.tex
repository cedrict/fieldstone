...
It has been implemented in ASPECT \cite{gahl18} and the inherent load balancing issues arising from the parallel implementation as well as from the use of Adaptive Mesh Refinement are discussed. It has also been implemented in the MILAMIN code \cite{daks08} to study LLSVPs \cite{musd15}.
...
This probably explains why the Particle-In-Cell method was later implemented in this code \cite{XXX}.
