...
\chapter{Review papers} \input{topics_big}

\chapter{Geodynamics} \input{topics}

\chapter{Celestial bodies} \input{topics_celestial_bodies}

\chapter{Geological areas on Earth} \input{topics_areas}

%\chapter{Numerical methods} \input{topics_numerical_methods}

\chapter{Codes in geodynamics } \input{codes}

%\chapter{My publications} \input{mypapers}

%\chapter{A \fantom, an \elefant and a \ghost} \input{mycodes}
