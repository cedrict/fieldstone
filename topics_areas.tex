...
\begin{small}
\begin{itemize}
\item[2015] \fullcite{samp15}
\item[2026] \fullcite{stcm26}
\end{itemize}
\end{small}
...
\section{Eifel massif, plume}

\begin{small}
\begin{itemize}
\item[2026] \fullcite{lisb26}
\end{itemize}
\end{small}
...
\section{Newfoundland (West Iberia-Newfoundland Conjugate Margins)}

\begin{small}
\begin{itemize}
\item[1998] \fullcite{elbj98}
\item[2006] \fullcite{lama06}
\item[2016] \fullcite{jekm16}
\item[2017] \fullcite{brhc17}
\item[2023] \fullcite{moml23} 
\item[2025] \fullcite{walb25}
\end{itemize}
\end{small}
...
\section{Tyrrhenian basin, Tyrrhenian sea} 
\begin{small}
\begin{itemize}
\item[1995] \fullcite{masa95}
\item[1996] \fullcite{gisb96}
\item[2022] \fullcite{cobf22}
\item[2026] \fullcite{sull26}
\end{itemize}
\end{small}
