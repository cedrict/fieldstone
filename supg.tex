...
{\color{red}TODO?} It is compared to other methods in the context of mantle convection in 
...
\right] = f
\]
and we show in Stone~65 that the solution is far from accurate for $\Penb>1$. Let us ask ourselves the 
...
\[
\rho_0 C_p u \frac{dT}{dx}
- \rho_0 C_p \tilde{\kappa} \frac{d^2T}{dx^2} 
- k \frac{d^2T}{dx^2} = f
\]
\[
\rho_0 C_p u \frac{dT}{dx}
...
The SUPG-stabilised pure advection equation is extensively tested in the 
\stone~43.
