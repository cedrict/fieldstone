...
\Literature \cite{brhu82,brbf92,teos00,humm86}
...
%------------------------------
\subsubsection{About the choice of the parameter $\tau$}

\begin{itemize}
\item The approach used in step-63 and subsequently in ASPECT is the one in John \& Knobloch \cite{jokn06,knob08}:
\[
...
and this value is attributed to \cite{raga76}.
