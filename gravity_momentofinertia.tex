...
\begin{problem}
 {\small \it
  ...
  where $I_x$ is the moment of inertia with respect to a rotation axis coiinciding
  with the $x$-axis.
 }
\end{problem}
\end{minipage}
...
{\small \it
  Derive from (\ref{mominert_uniform_sphere}) the value of the 
...
Compute the average density and arrive at:
  ...
  \begin{equation} 
    \left < \rho \right > = \frac{3}{R^3} \int_0^R \rho r^2 dr
  \end{equation} 

Use $I=fMR^2$ and the total mass to arrive at:
  \begin{equation} 
    f R^5 \left < \rho \right > = 2 \int_0^R \rho r^4 dr
  \end{equation} 
