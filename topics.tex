...
\cite{copo98}
\cite{vapy01}
\cite{mumh02}\cite{modm02}
\cite{hukm03}\cite{wabu03}
\cite{mure05}
\cite{kapo06}\cite{mudm06}
\cite{kabe07}
\cite{baso08}\cite{fukk08}
\cite{qurj09}
\cite{bepo10}
\cite{gerb12}
\cite{wahd13}
...
\cite{thkp15}
\cite{bafl16}\cite{jads16}\cite{olbm16}\cite{bafl16}
\cite{dusd18}
...
1999: \cite{will99b}\cite{bird99}\cite{clbp99}\cite{fugo99}\cite{mole99}\\
2000: \cite{hanl00}\cite{labp00}\cite{lemm00}\cite{gumm00}\\
