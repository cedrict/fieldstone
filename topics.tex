...
2014: \cite{hebr14}\cite{lige14}\cite{brun14}\cite{kobf14}\cite{ebva14}\cite{puge14}\\
...
2005: \cite{jalo05}\cite{lahb05}\cite{gowo05}\cite{enbs05}\cite{artd05}\cite{gowo05}\cite{mage05}\\
2006: \cite{degw06}\cite{rohu06}\cite{masr06}\cite{gest06}\cite{fump06}\\
2007: \cite{artd07}\cite{yaab07}\cite{cubh07}\cite{civv07}\cite{masp07}\cite{camg07}\cite{gogg07}\\
...
2009: \cite{yahb09}\cite{bill09}\cite{fagb09}\cite{bejb09}\cite{kecw09}\cite{gecm09}\cite{gefc09}\cite{famg09}\\
2010: \cite{hagr10}\cite{lobh10}\cite{mamb10}\cite{camg10}\cite{casm10}\cite{ligb10}\\
...
\cite{magc13}\cite{musi13}\cite{mibg13}\cite{grpy13}\cite{vagd13b}\cite{cavg13}\\
2014: \cite{robn14}\cite{hond14}\cite{ronc14}\cite{mobm14}\cite{famc14}\cite{fogm14}\cite{frba14}
\cite{gagd14}\cite{voge14}\cite{voge14b}\cite{lidr14}\cite{bocj04}\cite{bagb14}\cite{stjm14}\cite{basc14}\\
2015: \cite{bemm15}\cite{bomv15}\cite{bogf15}\cite{ceag15}\cite{kifr15}\cite{vami15}\\
2016: \cite{tomy16}\cite{gukt16}
