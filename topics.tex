...
\twothousandtwenty: Sandiford et al \cite{sams20}, Lau et al \cite{lahh20}
\end{scriptsize}
...
\nineteenninetynine: Schott et al \cite{scys99} \\
...
\nineteeneightyeight: Hansen \& Ebel \cite{haeb88}, Glatzmaier \cite{glat88}, Gurnis \cite{gurn88}\\ 
\nineteeneightynine: \cite{besg89}\cite{schm89}\cite{sthe89},\cite{rivi89}\\
...
\nineteenninetyone: Jarvis \cite{jarv91}, Christensen \& Harder \cite{chha91},
                    Machetel \& Weber \cite{mawe91}, Gable et al \cite{gaot91},
                    van den Berg et al \cite{vayv91}, Hansen \& Yuen \cite{hayk91}\\
\nineteenninetytwo: Davies \& Richards \cite{dari92}, \cite{besg92}\cite{mayw92}\cite{vayv92}\cite{chri92}\cite{haym92}, Richards \& Engebretson \cite{rien92}\\
\nineteenninetythree: Balachandar et al \cite{bayr93}, \cite{zhch93},
                      \cite{jarv93}, \cite{tack93},
                      \cite{bucc93}, \cite{carm93},
                      \cite{vavy93}, \cite{tasg93},
                      \cite{zhgu93}, \cite{mamc93},
                      Zebib \cite{zebi93}, van Keken et al \cite{vayv93}, 
                      Hansen et al \cite{hayk93}, Hansen \& Yuen \cite{hayu93},
                      Honda et al \cite{hoyb93}\\
\nineteenninetyfour: Yuen et al \cite{yurb94}, Balachandar \& Yuen \cite{bayu94}, \cite{haeb94}
                     \cite{chho94}\cite{tasg94}\cite{itki94}\cite{leka94}\cite{scha94}\\
\nineteenninetyfive: Balachandar et al \cite{bayr95,bayr95b}, \cite{zhgu95}
...
\twothousand: \cite{albe00}\cite{hayu00}\cite{devv00b}\cite{tack00}\cite{tack00b}\cite{tack00c}\cite{tack00d}
      \cite{zhzm00}\cite{legm00}\cite{conr00}\cite{somo00},  Dubuffet et al \cite{duyu00,duyy00}\\
...
\twothousandfour: Thomas et al \cite{thkl04}, \cite{vavv04b}\cite{xita04b}\cite{xita04}\cite{nata04b}\cite{vayr04}\cite{brws04}\cite{stsh04}i
      \cite{scbh04}\\
\twothousandfive: Reese et al \cite{resb05}, \cite{taxn05}\cite{bupc05}\cite{grlt05}\cite{lemj05}\cite{kogk05}\cite{mczh05b}\cite{vary05}
...
\nineteenninetythree: Kellogg \& King \cite{keki93}\\
...
\nineteenninetyseven: van Keken \cite{vank97}, Kellogg \& King\cite{keki97},
                      Larsen et al \cite{laym97}, Larsen \& Yuen \cite{layu97},
                      Manga \cite{mang97}\\
...
\twothousandthree: Bonini et al \cite{bocs03}\\
\twothousandtwelve: Wang et al \cite{wahh12}\\
\twothousandthirteen: van Dinther et al \cite{vagd13a,vagd13b}, Mikhailov \cite{milp13},
                      Myhill \cite{myhi13}\\
\twothousandfourteen: van Dinther et al \cite{vamd14}\\
\twothousandfifteen: Herrendorfer et al \cite{hevg15}\\
\twothousandeighteen: Govers et al \cite{gofv18}, Herman et al \cite{hefg18}, 
                      Herrendorfer et al \cite{hegv18}, Dal Zilio et al \cite{davg18}\\
\twothousandnineteen: van Zelst et al \cite{vawg19} van Zelst phd thesis \cite{vanzelst}\\
\twothousandtwenty: Brizzi et al \cite{brvf20}, Petrini et al \cite{pegy20}, 
                    D'acquisto et al \cite{dadm20}
\end{scriptsize}
...
\cite{kicd20}\cite{mugu20}\cite{gatt20}\cite{pust20}, Billen \cite{bill20},Roda et al \cite{rozr20}, Regorda et al \cite{relr20}, Tang et al \cite{tacm20}, Kiraly et al \cite{kiph20}, Sandiford et al \cite{sams20}, Grima et al \cite{grlc20}, Peral et al \cite{perz20}, Crameri et al \cite{crmd20}, Perchuk et al \cite{pegz20}, Assanelli et al \cite{aslr20}
\end{scriptsize}
...
\twothousandeleven: \cite{gokg11}, Reese et al \cite{reos11}\\
...
\twothousandtwenty: Kiss et al \cite{kids20}, Roda et al \cite{rozr20}, Regorda et al \cite{relr20},
                    Assanelli et al \cite{aslr20}
\end{scriptsize}
