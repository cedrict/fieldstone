...
\begin{itemize}
\item[\nineteensixtyseven] 
\textcite{tuox67} \cite{tuox67}\\
\item[\nineteenseventyone] 
\textcite{totu71} \cite{totu71}\\
\item[\nineteenseventytwo] 
\textcite{pelt72} \cite{pelt72}\\
\item[\nineteenseventyfour] 
\textcite{youn74} \cite{youn74}\\
\textcite{mcrw74} \cite{mcrw74}\\
\item[\nineteenseventyfive] 
\textcite{hemw75} \cite{hemw75}\\
\textcite{buss75} \cite{buss75}\\
\item[\nineteenseventysix] 
\textcite{mcri76} \cite{mcri76}\\
\textcite{sath76} \cite{sath76}\\
\item[\nineteenseventyseven] 
\textcite{yusc77} \cite{yusc77}\\
\item[\nineteenseventyeight] 
\textcite{mahz78} \cite{mahz78}\\ 
\textcite{hsui78} \cite{hsui78}\\
\textcite{haoc78} \cite{haoc78}\\
\textcite{pamc78} \cite{pamc78}\\
\textcite{rimc78} \cite{rimc78}\\
\item[\nineteenseventynine] 
\textcite{ludt79} \cite{ludt79}\\ 
\textcite{buss79} \cite{buss79}\\
\textcite{shpe79} \cite{shpe79}\\
\textcite{phiv79} \cite{phiv79}\\
\item[\nineteeneighty] 
\textcite{olco80} \cite{olco80}\\
\textcite{jamc80} \cite{jamc80}\\
\textcite{scsc80} \cite{scsc80}\\
\textcite{zess80} \cite{zess80}\\
\textcite{daly80} \cite{daly80}\\
\item[\nineteeneightyone] 
\textcite{yups81} \cite{yups81}\\
\textcite{buss81} \cite{buss81}\\
\textcite{jasc81} \cite{jasc81}\\
\textcite{haoc81} \cite{haoc81}\\
\textcite{cotu81} \cite{cotu81}\\
...
\textcite{stbl92} \citetitle{stbl92}\\
\item[2000]
\cite{honk00}, \cite{lors00}
\item[2006]
\cite{besb06}, \cite{legs06},
\item[2018]
\cite{pehu18}
\item[2021]
\cite{chap21}
