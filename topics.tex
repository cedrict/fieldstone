...
2002: \cite{mudm02}\\
2003: \cite{mumc03}\\
2004: \cite{mumc04}\cite{karb04}\\
2006: \cite{besb06}\\
2007: \cite{cobs07}\cite{rimb07}\\
2008: \cite{beke08}\cite{beck08}\\
2010: \cite{cobe10}\cite{jabi10a}\\
2011: \cite{obbh11}\cite{scbb11}\\
2012: \cite{mibe12}\\
2013: \cite{faca13}\cite{almb13}\\
2014: \cite{facc14}\\
2015: \cite{ealw15}\\
2017: \cite{majf17}\\
2018: \cite{peka18}
...
\twothousandnineteen: \cite{clhe19}\cite{liki19}\cite{demh19}\cite{galb19}\cite{frtv19}\cite{yuwa19}\cite{ropu19}\\
...
\twothousandeighteen: \cite{pabn18}\cite{hamp18}\cite{ghmc18}\cite{homs18}\\
\twothousandnineteen: \cite{sopg19}\cite{shar19}\cite{afss19}\\
\twothousandtwenty: \cite{rovb20}
}
...
1953: \cite{lema53}\\
1960: \cite{cull60}\\
\nineteenninety: \cite{moen90}\cite{enmo90}\\
...
\twothousandfifteen: \cite{uewg15,fohk15,cofk15}\\
\twothousandsixteen: \cite{coyc16,schr16}\\
\twothousandeighteen: \cite{jolp18}\\
\twothousandnineteen: \cite{anpa19,sall19}\\
\twothousandtwenty: \cite{ster20}
}
...
\twothousandnineteen: \cite{deli19}\cite{davk19}\cite{bore19}\\
\twothousandtwenty: \cite{braf20}, Mitrovica et al \cite{miac20}
...
\twothousandeighteen: \cite{osss18}
...
\twothousandnineteen: \cite{zhli19}
\end{scriptsize}
...
\twothousandnine: \cite{king09}\\
\twothousandten: \cite{ghbz10}\cite{spgs10b}\\
\twothousandtwelve: \cite{hibi12}\\
\twothousandthirteen: \cite{shsc13}\cite{chus13}\\
\twothousandfifteen: \cite{lizh15}\\
\twothousandsixteen: \cite{necg16}\\
...
1984: \cite{kara84}
1999: \cite{brcp99}
2001: \cite{dets01}\cite{solo01}
2002: \cite{soet02}
2003: \cite{hapa03}\cite{reyu03}
2008: \cite{sore08}
2011: \cite{rorb11}
2013: \cite{beri13}
2014: \cite{besr14}
2015: \cite{thrk15}\cite{tukb15}\cite{pevp15}\cite{glfa15}
2017: \cite{ceww17}\cite{daef17}\cite{mube17}\cite{scdu17}
2018: \cite{bemu18}\cite{bezb18}\cite{mube18}
2019: \cite{mube19}
...
\twothousandsixteen: \cite{keka16}\cite{vade16}\cite{mesj16}\\
...
\nineteenninetytwo: \cite{besg92}\cite{mayw92}\cite{vayv92}\cite{chri92}\cite{haym92}\\
...
\twothousandnineteen: \cite{gult19}\cite{mazh19}\cite{cohf19}\cite{lewh19}\cite{ulcw19}\cite{boba19}\cite{fube19}
      \cite{plju19}\\
\twothousandtwenty: \cite{lalt20}\cite{gugb20}\cite{yabt20} Yoshida et al \cite{yosy20}
...
\twothousandseven:
\cite{gogc07}\cite{knvk07}\cite{lohd07}\\
\twothousandeight:
\cite{knva08}\cite{cage08}\cite{vack08}\\
\twothousandnine:
\cite{leki09}\cite{heaa09}\\
\twothousandten:
\cite{roms10}\cite{hogz10}\cite{syab06}\\
\twothousandeleven:
\cite{zhgh11}\\
\twothousandfourteen:
\cite{ledg14}\cite{mabv14}\\
...
\twothousandfive: \cite{tagu05}\cite{bung05}\cite{zhon05}\\
\twothousandsix: \cite{isst06}\cite{liva06a}\cite{liva06b}\cite{zhon06}\cite{mita06}\cite{nokm06}\cite{qufo06}
      \cite{keso06}\\
...
\twothousandsixteen: \cite{kili16}\cite{dannbergphd}\\
...
\twothousandnineteen: \cite{rejv19}\cite{hakt19}
}
...
\twothousandtwenty: \cite{cump20}\cite{pena20,ster20,fahm20,siss20}\cite{zwsr20}
\end{scriptsize}
...
\cite{kicd20}\cite{mugu20}\cite{gatt20}\cite{pust20}, Billen \cite{bill20},Roda et al \cite{rozr20}
}
...
2002: \cite{vakp02}\\
\twothousandsix: \cite{abvk06}\\
\twothousandten: \cite{roms10}\\
\twothousandeleven: \cite{geme11}\cite{vahs11}\\
\twothousandtwelve: \cite{fagm12}\\
\twothousandfourteen: \cite{qubu14}\cite{mabv14}\cite{malg14}\cite{wisv14}\\
\twothousandfifteen: \cite{bomv15}\cite{nani15}\\
\twothousandseventeen: \cite{ceww17}\cite{wewv17}\\
\twothousandnineteen: \cite{ceww19}\cite{meag19}\cite{ligc19}
...
\twothousandfourteen: \cite{recf14}\cite{macg14}\cite{crta14}\\
...
1990: \cite{dahl90}
1994: \cite{koon94}
2003: \cite{wiep03}\cite{smbs03}\cite{muso03}\cite{vamf03}
...
1968: \cite{ramb68}\\
nineteenseventytwo: \cite{bers72}\\
\nineteenseventyfive: \cite{dixo75}\\
...
\twothousandtwenty: \cite{kids20}, Roda et al \cite{rozr20}
\end{scriptsize}
