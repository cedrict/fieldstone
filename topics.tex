...
\twothousandtwenty: \cite{zwsr20}, Kiraly et al \cite{kiph20}
}
...
\twothousandeighteen: Meriaux et al \cite{memm18}, Crameri \cite{cram18}, Wieczorek \& Meshede \cite{2018}\\
...
\twothousandeight: Tackley \cite{2008}, Leng \& Zhong \cite{lezh08}, Trubitsyn \cite{trub08}\\
...
\nineteenninetysix: Hassany \& Chery \cite{hach96b}, Christensen \cite{chri96b}\\
...
\twothousandtwenty: Bolrao et al \cite{bobm20}
\end{scriptsize}
...
\nineteenninetyfive: \cite{bisc95}\cite{crks95}, Aharonov et al \cite{ahwk95}\\
...
\twothousandtwenty: Sim et al \cite{siss20}, Zhang et al \cite{zhbp20}
\end{scriptsize}
...
\nineteenninetysix: \cite{zhyu96}\cite{hond96}\cite{rytr96a}\cite{rytr96b}\cite{tack96}\cite{trbo96}
      ...
      \cite{leka96}\cite{iwas96}\cite{buri96}\cite{schh96}, Trompert \& Hansen \cite{trha96}\\
...
\twothousandtwenty: Brizzi et al \cite{brvf20}
\end{scriptsize}
...
\cite{kicd20}\cite{mugu20}\cite{gatt20}\cite{pust20}, Billen \cite{bill20},Roda et al \cite{rozr20}, Regorda et al \cite{relr20}, Tang et al \cite{tacm20}, Kiraly et al \cite{kiph20}, Sandiford et al \cite{sams20}, Grima et al \cite{grlc20}, Peral et al \cite{perz20}
\end{scriptsize}
...
\begin{scriptsize}
1994: Tikoff \& Teyssier \cite{tite94}\\
1997: Thompson et al \cite{thsj97}\\
2003: Koons et al \cite{konc03}, Upton et al \cite{upke03}\\
2011: Leever et al \cite{legs11}\\
2017: Nabavi et al \cite{naam17}, Ruh et al \cite{rugb17}\\
2018: Nabavi et al \cite{naam18}
\end{scriptsize}
...
\nineteeneightyeight: Peltzer \& Tapponnier \cite{peta88}, Davy \& Cobbold \cite{daco88}, Cobbold \& Davy \cite{coda88}\\
