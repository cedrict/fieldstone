...
2013: \cite{ress13}\cite{ebbf13}\cite{davi13}\cite{scle13}\\
...
2013:\cite{wahd13}\\
2014:\cite{famc14}\cite{fogm14}\cite{olbe14}\\
2015:\cite{thkp15}\\
...
2014: \cite{robn14}\cite{hond14}\cite{ronc14}\cite{mobm14}\cite{famc14}\cite{fogm14}\cite{frba14} 
      ...
      \cite{chsg14}\cite{sigb14}\cite{shjm14}\cite{mova14}\cite{olpr14}\\
...
2019: \cite{magn19}\cite{mavb19}\cite{scvm19}\cite{cakc19}\cite{samo19}\cite{sihf19}\cite{meag19}
      \cite{vaws19}\cite{bokg19}\cite{vawg19}\\
2020: \cite{algg20}\cite{braf20}
}
...
\cite{basv06}\cite{meph06}\cite{iabd06}\cite{oncf06}
\cite{iabb07}
