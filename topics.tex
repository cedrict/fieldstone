...
\twothousandtwenty: Sim \etal \cite{siss20}, Zhang \etal \cite{zhbp20}
\end{scriptsize}
...
\twothousandten: O'Farrell \& Lowman \cite{oflo10}, \cite{bumb10}\cite{detn10}\cite{yayh10}\cite{nata10}\cite{hole10}\cite{zhzl10}\cite{vayb10}
      \cite{brmw10}\\
\twothousandeleven: Yuen \etal \cite{yutc11}, \cite{lowm11}\cite{rota11}\cite{woda11}\cite{lemj11}\cite{befa11}\cite{pewb11}\\
\twothousandtwelve: \cite{bisa12}\cite{cort12b}\cite{deyt12}, Solomatov \cite{solo12}, \cite{wele12}\\
\twothousandthirteen: \cite{holj13}\cite{dadb13}, Tosi \etal \cite{toyd13}, \cite{bogs13a}\cite{busa13}\cite{mika13}
...
\twothousandtwenty: Houser et al \cite{hohv20}, Lu \etal{} \cite{lufs20}, Wang \& Li \cite{wali20}
\end{scriptsize}
...
\nineteenninetynine: Brun \cite{brun99}, Buck \etal \cite{bulp99}, Govers \& Wortel \cite{gowo99}\\
...
\twothousandtwenty: Cuffaro et al \cite{cump20}, Peron-Pinvidic \& Naliboff \cite{pena20}, 
                    ...
                    Chenin et al \cite{chsm20}, Korchinski \etal \cite{kotr21}
\end{scriptsize}
...
\item[\twothousandtwelve] \cite{shch12}
\item[\twothousandthirteen] \cite{gery13c}
\item[\twothousandeighteen] \cite{zhlg18}
...
\twothousandtwenty: Spitz et al \cite{spsk20,spbe20}, Kiss et al \cite{kids20}, 
                    Humair et al \cite{hube20}, Ruh \cite{ruh20}
\end{scriptsize}
...
2008: Chen \etal \cite{chzy08}, Stegman \etal \cite{stmt08}
      Billen \etal \cite{bikh08}, Kadlec et al \cite{kadt08}\\
2012: May \cite{may12}\\
2017: \cite{krke17}\\
...
\twothousandeleven: \cite{befa11}, Zhang et al \cite{zhxy11}, \cite{vasd11}\cite{jabe11}\cite{iahb11}, Searle et al \cite{seep11}\\
