...
\nineteenninetytwo: \cite{zhgu92}\cite{kiha92}Ribe \cite{ribe92}\\
...
\twothousandone: Zhong \cite{zhon01}\\
\twothousandseven: Kaban \etal \cite{kart07}\\
\twothousandeight: Metivier \& Conrad \cite{meco08}\\
...
\item[\twothousandtwenty] Sim \etal \cite{siss20}, Zhang \etal \cite{zhbp20}, 
                          Rummel \etal \cite{rubk20}, Cobden \cite{cobd20},
                          Lees \etal \cite{lerm20}
\end{itemize}
\end{scriptsize}
...
\twothousandtwentyone: Koppers \etal \cite{kobj21}
\end{scriptsize}
...
\item[\twothousandseventeen] Ruedas \& Breuer \cite{rubr17}
