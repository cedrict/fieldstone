...
\item Subduction
   ...
   \item Subduction-transition zone interaction: A review \cite{goav17}
   \end{itemize}

\item Orogeny:
   \begin{itemize}
   \item the origin of orogens \cite{jabe13}
   \item Experimental modelling of orogenic wedges: A review \cite{grmd12} 
   \item Mountain Belts and the New Global Tectonics (1970) \cite{debi70}
   \end{itemize}
...
\item Computational geodynamics
   ...
   \item Uncertainty Quantification for Multiscale Simulations \cite{degg02}
   \item What makes computational open source software libraries successful? \cite{bahe13}
   \item Software and the Scientist: Coding and Citation Practices in Geodynamics \cite{hwfs17}
   \end{itemize}
...
\item Rheology \index{topics}{Rheology}
   ...
   \item Tectonic pressure: Theoretical concepts and modelled examples \cite{manc08}
   \item The yield stress - a review \cite{barn99}
   \item The Origins of Rheology: A Short Historical Excursion \cite{dora02}
   \end{itemize}
...
2012: \cite{grmd12}\\
2013: \cite{luws13}\cite{vadv13}\cite{guhf13}\cite{mibg13}\\
...
2008: \cite{zhmt08}\cite{deka08}\cite{trub08}\cite{krdp08}\cite{mamo08}\cite{gepd98}
      \cite{vack08}\cite{heta08}\cite{brtf08}\cite{daks08}\cite{chzy08}\cite{tack08}\\
2009: \cite{king09}\cite{geum09}\cite{vemm09}\cite{qurj09}\\
2010: \cite{kaus10}\cite{kamm10}\cite{egat10}\cite{kilv10}\cite{brfy10}\\
...
2019: \cite{clhe19}\cite{liki19}\cite{demh19}\cite{galb19}\cite{frtv19}\cite{yuwa19}
}
...
2016: \cite{kord16}\cite{moek16}\cite{rond16}\\
2017: \cite{roev17}\\
...
2015: \cite{wahg15}\\
2016: \cite{ghbu16}\cite{bocf16}\cite{yagu16}\\
2017: \cite{ligs17}\\
2018: \cite{bofc18}
}
...
2006: \cite{bube06}\cite{basv06}\cite{kasc06}\cite{fuwb06}\cite{colm06}\cite{pabs06}\\
...
2019: \cite{koen19}\cite{kipd19}\cite{crcm19}\cite{pedm19}\cite{mazz19}
}
...
2016: \cite{howa16}\cite{gvfb16}\cite{yagu16}\\
...
{\scriptsize
\noindent
1984: \cite{davi84}\cite{hage84}\cite{riff84}\\
1986: \cite{davi86}\\
...
1991: \cite{chha91}\cite{mawe91}\cite{gaot91}\cite{vayv91}\\
...
1993: \cite{zhch93}\cite{jarv93}\cite{tack93}\cite{bucc93}\cite{carm93}\cite{vavy93}\cite{tasg93}
      \cite{zhgu93}\cite{mamc93}\cite{zebi93}\cite{vayv93}\\
...
1999: \cite{duyr99}\cite{vazh99}\cite{dava99}\cite{tabg99}\cite{como99}\cite{cicv99}\\
2000: \cite{albe00}\cite{hayu00}\cite{devv00b}\cite{tack00}\cite{tack00b}\cite{tack00c}\cite{tack00d}
      \cite{zhzm00}\cite{legm00}\cite{conr00}\cite{somo00}\\
2001: \cite{vank01}\cite{riyb01}\cite{lemo01}\cite{vays01}\cite{moqu01}\cite{zhon01}\\
2002: \cite{tasu02}\cite{modm02}\cite{tack02}\cite{vaya02}\cite{vayu02}\cite{taxi02}\\
2003: \cite{hapa03}\cite{lemo03}\cite{mumc03}\cite{fasa03}\cite{heta03}\cite{sibu03}\\
2004: \cite{vavv04b}\cite{xita04b}\cite{xita04}\cite{nata04b}\cite{vayr04}\cite{brws04}\\
2005: \cite{taxn05}\cite{bupc05}\cite{grlt05}\cite{lemj05}\cite{kogk05}\cite{mczh05b}\cite{vary05}
      \cite{nata05}\cite{nabu05}\\
2006: \cite{beck06}\cite{nake06}\cite{losh06}\cite{sthh06}\\
2007: \cite{nake07}\cite{mayu07}\cite{brva07a}\cite{brva07b}\cite{grlt07}\cite{grlt07b}\cite{huda07}
      \cite{tanh07}\cite{tagu07}\\
...
2013: \cite{holj13}\cite{dadb13}\cite{toyd13}\cite{bogs13a}\cite{busa13}\cite{mika13}
      \cite{fabc13}\cite{cosr13}\cite{coml13}\cite{cost13}\cite{stha13}\cite{plth13}\\
...
2016: \cite{frbs16}\cite{sisc16}\cite{boba16}\cite{wele16}\cite{welm16}\cite{vade16}\\
2017: \cite{ghts17}\\
...
2007: \cite{pazw07}\cite{mofm07}\cite{tanh07}\cite{stli07}\\
2009: \cite{natd09}\\
2010: \cite{kayy10}\\
...
2012: \cite{huss12}\cite{gutz12}\cite{qumm12}\cite{holr12}\cite{dost12}\\
...
2012: \cite{huco12}\cite{gubc12}\\
2013: \cite{bemm12}\cite{brps13}\\
2014: \cite{buge14}\cite{gery14b}\cite{buto14}\cite{buit14}\cite{leli14}\\
2015: \cite{bemm15}\cite{gesb15}\cite{kocb15}\cite{meds15}\cite{lile15}\cite{medd15}\\
...
1984: \cite{poay84}\\
1985: \cite{bosw85}\\
1986: \cite{hoen86b}\cite{zupf86}\cite{zupa86}\cite{mofr86}\cite{mcke86}\\
1988: \cite{bums88}\\
...
2007: \cite{huha07}\cite{macl07}\cite{vabl07}\cite{dyrm07}\cite{hube07}\cite{buto07}\cite{socb07}
      \cite{werr07}\\
2008: \cite{cort08}\cite{gumb08}\cite{buhb08}\cite{hube08}\cite{peso08}\cite{rerw08}\\
...
2004: \cite{toba04}\cite{bocj04}\cite{bejn04}\cite{tobj04}\cite{sche04}\cite{sche04b}\\
...
2011: \cite{lixg11}\cite{list11}\cite{bubj11}\cite{bagw11b}\cite{cafz11}\cite{geme11}\cite{qube11}
      \cite{blgg11}\cite{gery11b}\cite{leki11}\cite{scsf11}\cite{gopc11}\\
...
2013: \cite{nabg13}\cite{hage13}\cite{ancv13}\cite{namu13}\cite{yosh13}\cite{zhgt13}\cite{lixg13} 
      ...
      \cite{cavg13}\cite{vocg13}\cite{qula13}\cite{bugu13}\cite{myhi13}\\
...
2018: \cite{yamz18}\cite{crli18}\cite{spcv18}\cite{chss18}\cite{yagz18}\cite{mazh18}\cite{pukp18}
      \cite{masg18}\\
2019: \cite{magn19}\cite{mavb19}\cite{scvm19}\cite{cakc19}\cite{samo19}\cite{sihf19}\cite{meag19}\cite{vaws19}
}

%--------------------------------------------------------------------
\subsection{Subduction - slab detachment, break-off}
\index{topics}{Slab  Detachment} \index{topics}{Slab Break-off}
%--------------------------------------------------------------------
...
\cite{fagm12}
\cite{qubu14}\cite{mabv14}\cite{malg14}
\cite{ceww17}\cite{wewv17}
\cite{ceww19}\cite{meag19}
}
...
2012: \cite{stri12}\cite{thka12}\cite{lega12}\\
...
\cite{dahl90}
\cite{koon94}
\cite{wiep03}\cite{smbs03}\cite{muso03}
\cite{simp06}
\cite{rukb12}
\cite{rugb13}
\cite{mauw16}
...
%--------------------------------------------------------------------
%------------------------------------------------------------------------------
\subsection{Uzawa-type algorithms}
%------------------------------------------------------------------------------
%------------------------------------------------------------------------------
...
{\scriptsize
\cite{stfl11}\cite{vata11}\cite{stlh13}\cite{welo15}
}
...
\cite{basv06}\cite{meph06}
\cite{hucf12}\cite{shlm12}
\cite{cudd15}
\cite{robn16}\cite{marl16}
\cite{sche17}
\cite{yamg19}
}
%..........................
...
1977: \cite{mota77}\\
1978: \cite{bird78}\\
1982: \cite{tapl82}\cite{vidm82}\\
1984: \cite{vidm84}\\
1986: \cite{vimd86}\cite{moln86}\\
1988: \cite{peta88}\\
1989: \cite{moln89}\\
1993: \cite{moem93}\\
1994: \cite{wibe94}\\
...
1997: \cite{robk97}\\
1999: \cite{vasb99}\\
2000: \cite{cblk00}\cite{clro00}\\
2001: \cite{bejn01}\cite{laav01}\cite{zemk01}\cite{tazr01}\\
2002: \cite{kozc02}\\
2003: \cite{reta03}\\
2004: \cite{bejn04}\cite{jabm04}\cite{zhsw04}\\
2005: \cite{clbr05}\cite{rost05a}\cite{rost05b}\\
2006: \cite{clrw06}\cite{jabn06}\\
2007: \cite{mead07}\\
2008: \cite{busc08}\cite{strh08}\\
2010: \cite{hamo10}\\
2011: \cite{befa11}\cite{zhxy11}\cite{vasd11}\cite{jabe11}\cite{iahb11}\\
2012: \cite{zams12}\cite{vald12}\\
2013: \cite{care13}\cite{chgz13}\cite{chgz13b}\cite{lesh13}\\
2014: \cite{whbb14}\cite{mutg14}\cite{stjm14}\\
2015: \cite{puka15}\cite{jarh15}\\
2016: \cite{kebb16}\\
2017: \cite{bube17}\\
2018: \cite{pirf18}\cite{pukp18}\\
...
\cite{lohd07}
\cite{musi13}
\cite{kigk14}\cite{leli14}\cite{mova14}
\cite{kilk15}
\cite{yagz17}
\cite{yamg19}
}
...
{\scriptsize
\cite{hasp15}\cite{meds15}
}

Colorado plateau \cite{lesm11}

Antarctica \cite{huha07}
