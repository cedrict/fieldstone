...
\item[\twothousandfifteen] Zhong \& Rudoplh \cite{zhru15}, Weismuller \etal \cite{wegg15},
                     Bello \etal \cite{bect15}, Petschel \etal \cite{pesw15}
\item[\twothousandsixteen] \cite{frbs16}\cite{sisc16}\cite{boba16}\cite{wele16}\cite{welm16}
                     \cite{vade16}\cite{chah16}, Wong \& Solomatov \cite{woso16b}
\item[\twothousandseventeen] Barry \etal \cite{badw17}, Ghosh \etal \cite{ghts17}, 
...
\item[\twothousandtwentyone] Langemeyer \etal \cite{lalt21}
\end{itemize}
\end{scriptsize}
...
\twothousandone: \cite{lova01}, Karato \etal \cite{kary01}\\
...
\item Mercury \index{topics}{Mercury}
   ...
   \begin{scriptsize}
   \begin{itemize}
   \item[\twothousandseven] Redmond \& King \cite{reki07}
   \item[\twothousandeight] King \cite{king08}
   \item[\twothousandtwelve] Roberts \& Barnouin\cite{roba12} 
   \item[\twothousandtwentyone] Guernero \etal \cite{gult21}
   \end{itemize}
   \end{scriptsize}
