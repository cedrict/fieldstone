...
\item[\twothousandsixteen] Zhang \& O'Neill \cite{zhon16}, Kiefer \& Li \cite{kili16},
                           Genova \etal \cite{gegl16}
\item[\twothousandseventeen] Ruedas \& Breuer \cite{rubr17}, Azuma \& Katayama \cite{azka17}
\item[\twothousandeighteen] Citron \etal \cite{cimt18}, Golabek \etal \cite{goej18}, 
                            Schools \& Montesi \cite{scmo18}, Khan \etal \cite{khlr18}
\item[\twothousandnineteen] Smrekar \etal \cite{smls19}
\item[\twothousandtwenty] Lognonne \etal \cite{lobp20}, Giardini \etal \cite{gilb20},
                          Agarwal \etal \cite{agtb20}, Genova \cite{geno20},
                          Banerdt \etal \cite{basb20}, Taylor \etal \cite{tajh20}
\item[\twothousandtwentyone] Khan \etal \cite{khcv21}, Stähler \etal \cite{stkb21},
                             Knapmeyer-Endrun \etal \cite{knpb21}, van der Tang \cite{vand21}
\end{itemize}
\end{scriptsize}
