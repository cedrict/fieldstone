...
\item[\nineteenninetysix] 
\textcite{bekh96} \cite{bekh96}\\
\textcite{berc96} \cite{berc96}\\
\textcite{jabh96} \cite{jabh96}\\
\item[\nineteenninetyseven] 
\textcite{thsj97} \cite{thsj97}\\
\textcite{babr97} \cite{babr97}\\
\textcite{bucl97} \cite{bucl97}\\
\textcite{mole97} \cite{mole97}\\
\item[\nineteenninetyeight] 
\textcite{bird98} \cite{bird98}\\
\textcite{lecd98} \cite{lecd98}\\
\textcite{kian98} \cite{kian98}\\
\textcite{mafs98} \cite{mafs98}\\
\textcite{madu98} \cite{madu98}\\
\textcite{gumm98} \cite{gumm98}\\
\textcite{berc98} \cite{berc98}\\
\textcite{madu98} \cite{madu98}\\
\item[\nineteenninetynine] 
\textcite{will99b} \cite{will99b}\\
\textcite{bird99} \cite{bird99}\\
\textcite{clbp99} \cite{clbp99}\\
\textcite{fugo99} \cite{fugo99}\\
\textcite{mole99} \cite{mole99}\\
\textcite{lemo99} \cite{lemo99}\\
\textcite{gebp99} \cite{gebp99}\\
\item[\twothousand] 
\textcite{hanl00} \cite{hanl00}\\
\textcite{labp00} \cite{labp00}\\
\textcite{lemm00} \cite{lemm00}\\
\textcite{gumm00} \cite{gumm00}\\
\textcite{lemo00} \cite{lemo00}\\
\textcite{pepo00} \cite{pepo00}\\
\textcite{scys00b} \cite{scys00b}\\
\item[\twothousandone] 
\textcite{homo01} \cite{homo01}\\
\textcite{beoc01} \cite{beoc01}\\
\textcite{kapo01} \cite{kapo01}\\
\item[\twothousandtwo] 
\textcite{labu02} \cite{labu02}\\
\textcite{coli02} \cite{coli02}\\
\textcite{bast02} \cite{bast02}\\
\textcite{gedh02} \cite{gedh02}\\
\textcite{kilg02} \cite{kilg02}\\
\item[\twothousandthree] 
\textcite{wipo03} \cite{wipo03}\\
\textcite{wabu03} \cite{wabu03}\\
\textcite{geur03} \cite{geur03}\\
\textcite{upke03} \cite{upke03}\\
\textcite{vamf03} \cite{vamf03}\\
\textcite{bupf03} \cite{bupf03}\\
\textcite{lemm03} \cite{lemm03}\\
\textcite{onmo03} \cite{onmo03}\\
\item[\twothousandfour] 
\textcite{tibb04} \cite{tibb04}\\
\textcite{gewi04} \cite{gewi04}\\
\textcite{colm04} \cite{colm04}\\
\textcite{coli04} \citetitle{coli04}\\
\textcite{pybe04} \citetitle{pybe04}\\
\item[\twothousandfive] 
\textcite{vazs05} \cite{vazs05}\\
\textcite{hagu05} \cite{hagu05}\\
\textcite{wiwg05} \cite{wiwg05}\\
\textcite{mcjp05} \cite{mcjp05}\\
\item[\twothousandsix] 
\textcite{bube06} \cite{bube06}\\ 
\textcite{basv06} \cite{basv06}\\
\textcite{kasc06} \cite{kasc06}\\
\textcite{fuwb06} \cite{fuwb06}\\
\textcite{colm06} \cite{colm06}\\
\textcite{pabs06} \cite{pabs06}\\
\textcite{crnp06} \cite{crnp06}\\
\textcite{sahm06} \cite{sahm06}\\
\item[\twothousandseven] 
\textcite{afrf07} \cite{afrf07}\\
\textcite{kore07} \cite{kore07}\\
\textcite{gewm07} \cite{gewm07}\\
\textcite{jabn07} \cite{jabn07}\\
\item[\twothousandeight] 
\textcite{affr08} \cite{affr08}\\
\textcite{tibb08} \cite{tibb08}\\
\textcite{hapo08} \cite{hapo08}\\
\textcite{busc08} \cite{busc08}\\
\textcite{clbz08} \cite{clbz08}\\
\textcite{chlg08} \cite{chlg08}\\
\textcite{kasb08} \cite{kasb08}\\
\textcite{fabs08} \cite{fabs08}\\
\textcite{chgu08} \cite{chgu08}\\
\textcite{buit08} \cite{buit08}\\
\textcite{onlg08} \cite{onlg08}\\
\item[\twothousandnine]
\textcite{bupb09} \cite{bupb09}\\
\textcite{plmg09} \cite{plmg09}\\
\textcite{rigo09} \cite{rigo09}\\
\textcite{bubg09} \cite{bubg09}\\
\textcite{coco09} \cite{coco09}\\
\item[\twothousandten]
...
\item[\twothousandseven] Elkins-Tanton \cite{elki07}, Ballmer \etal \cite{bavi07}
...
\begin{center}
\includegraphics[width=4cm]{images/dyntopo/dyntopo.jpg}
...
\item[\twothousandseventeen] \textcite{yamm17}, \textcite{aumh17},
                             \textcite{grrb17}, \textcite{rubh17}
...
\cite{ghbz10}
\cite{spgs10b}
\item[\twothousandeleven] \cite{capd11}
\item[\twothousandtwelve] \cite{hibi12} \cite{cabp12}, 
                          \cite{katr12}
\item[\twothousandthirteen] \cite{shsc13} \cite{chus13}
\item[\twothousandfourteen] \cite{cako14} \cite{kaps14}
\item[\twothousandfifteen] \cite{lizh15}
\item[\twothousandsixteen] \cite{necg16}
\item[\twothousandseventeen] \cite{grab17}\\
\item[\twothousandeighteen] \cite{king18}
\end{itemize}
\end{scriptsize}
...
\item[\twothousandeight] 
\cite{ghja08}\cite{ghja08}\\
\cite{tack08}\cite{tack08}\\
\cite{tack08b}\cite{tack08b}\\
\cite{chhl08}\cite{chhl08}\\
\cite{brhv08}\cite{brhv08}\\
\cite{deta08}\cite{deta08}\\
\cite{plva08}\cite{plva08}\\
\cite{hole08}\cite{hole08}\\
\cite{vata08}\cite{vata08}\\
\cite{trkr08}\cite{trkr08}\\
\cite{shlj08}\cite{shlj08}\\
\cite{stha08}\cite{stha08}\\
\cite{yosh08}\cite{yosh08}\\
\cite{galg08}\cite{galg08}\\
\item[\twothousandnine] 
\cite{wodd09} \cite{wodd09}\\
\cite{fobe09} \cite{fobe09}\\
\cite{gows09} \cite{gows09}\\
\cite{deta09} \cite{deta09}\\
\cite{onlj09} \cite{onlj09}\\
\cite{wazh09} \cite{wazh09}\\
\cite{vavv09} \cite{vavv09}\\
\cite{brha09} \cite{brha09}\\
\cite{scbs09b} \cite{scbs09b}\\ 
\cite{oebm09} \cite{oebm09}\\
\cite{fuog09} \cite{fuog09}\\
\item[\twothousandten] 
\cite{oflo10} \cite{oflo10}\\
\cite{bumb10} \cite{bumb10}\\
\cite{detn10} \cite{detn10}\\
\cite{yayh10} \cite{yayh10}\\
\cite{nata10} \cite{nata10}\\
\cite{hole10} \cite{hole10}\\
\cite{zhzl10} \cite{zhzl10}\\
\cite{vayb10} \cite{vayb10}\\
\cite{brmw10} \cite{brmw10}\\
\item[\twothousandeleven] 
\cite{yutc11} \cite{yutc11}\\
\cite{lowm11} \cite{lowm11}\\
\cite{rota11} \cite{rota11}\\
\cite{woda11} \cite{woda11}\\
\cite{lemj11} \cite{lemj11}\\
\cite{befa11} \cite{befa11}\\
\cite{pewb11} \cite{pewb11}\\
\cite{andl11} \cite{andl11}\\
\item[\twothousandtwelve] 
\cite{bisa12} \cite{bisa12}\\
\cite{cort12b} \cite{cort12b}\\
\cite{deyt12} \cite{deyt12}\\
\cite{solo12} \cite{solo12}\\
\cite{wele12} \cite{wele12}\\
\item[\twothousandthirteen] 
\cite{holj13} \cite{holj13}\\
\cite{dadb13} \cite{dadb13}\\
\cite{toyd13} \cite{toyd13}\\
\cite{bogs13a} \cite{bogs13a}\\
\cite{busa13} \cite{busa13}\\
\cite{mika13} \cite{mika13}\\
\cite{fabc13} \cite{fabc13}\\
\cite{cosr13} \cite{cosr13}\\
\cite{coml13} \cite{coml13}\\
\cite{cost13} \cite{cost13}\\
\cite{stha13} \cite{stha13}\\
\cite{plth13} \cite{plth13}\\
\cite{oflb13} \cite{oflb13}\\
\cite{whch13} \cite{whch13}\\
\item[\twothousandfourteen] 
\cite{arfw14} \cite{arfw14}\\
\cite{helo14} \cite{helo14}\\
\cite{crta14} \cite{crta14}\\
\cite{flgw14} \cite{flgw14}\\
\cite{roct14} \cite{roct14}\\
\cite{cort14} \cite{cort14}\\
\cite{becr14} \cite{becr14}\\
\cite{nata14} \cite{nata14}\\
\cite{stha14} \cite{stha14}\\
\cite{stlh14} \cite{stlh14}\\
\cite{ogaw14} \cite{ogaw14}\\
\item[\twothousandfifteen]   
\cite{zhru15} \cite{zhru15}\\
\cite{wegg15} \cite{wegg15}\\
\cite{bect15} \cite{bect15}\\
\cite{pesw15} \cite{pesw15}\\
\cite{khfh15} \cite{khfh15}\\
\item[\twothousandsixteen]   
\cite{frbs16} \cite{frbs16}\\ 
\cite{sisc16} \cite{sisc16}\\
\cite{boba16} \cite{boba16}\\
\cite{wele16} \cite{wele16}\\
\cite{welm16} \cite{welm16}\\
\cite{vade16} \cite{vade16}\\
\cite{chah16} \cite{chah16}\\
\cite{woso16b} \cite{woso16b}\\
\item[\twothousandseventeen] 
\cite{badw17} \cite{badw17}\\
\cite{ghts17} \cite{ghts17}\\
\cite{civj17} \cite{civj17}\\
\item[\twothousandeighteen] 
\cite{guld18} \cite{cold18}\\
\cite{arcf18} \cite{cosh18}\\
\cite{wele18} \cite{rile18}\\
\item[\twothousandnineteen] 
...
\item[\twothousandnine]  \cite{natd09}
\item[\twothousandten]   \cite{kayy10}
\item[\twothousandeleven] 
\cite{mayw11} 
\cite{java11} 
\cite{faff11} 
...
\item[\twothousandnine] Burov \& Cloetingh \cite{bucl09}, Zhu \etal \cite{zhgy09},
                        ...
                        Manea \etal \cite{maml09}, \textcite{dada09} 
...
\item[\twothousandfifteen] Betts \etal \cite{bemm15}, Gerya \etal \cite{gesb15},
                           ...
                           \textcite{lile15}, \textcite{medd15},
                           \textcite{frro15}, \textcite{dags15}
...
\item[\twothousandtwentyone] Cloetingh \etal \cite{clkk21}, Rodriguez \etal \cite{roac21},
                             ...
                             Wang \& Li \cite{wali21}
\item[\twothousandtwentytwo] \textcite{zals22} \citetitle{zals22yy}
\end{itemize}
\end{scriptsize}
...
\item[\twothousandtwentytwo] \textcite{toyp22} \citetitle{toyp22}
\end{itemize}
\end{scriptsize}
...
\item[\twothousandtwentyone] Njinju \etal \cite{njsn21}, \textcite{ribr21} 
\end{itemize}
\end{scriptsize}
...
\begin{scriptsize}
\begin{itemize}
\item[2010] \cite{zhst10}
\item[2015] \cite{wazh15}
\item[2016] \cite{guyr16}
\item[2018] \cite{lecd18}
\item[2019] \cite{2019}, \cite{lixs19}
\item[2020] \cite{dawl20}, Li \etal \cite{lisy20},
\item[2021] Qi \etal (2021) \cite{qill21}
\end{itemize}
\end{scriptsize}
...
\twothousandtwenty: \textcite{mapg20}
\twothousandtwentytwo:  \textcite{pafl22}
\end{scriptsize}
