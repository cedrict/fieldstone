...
2014: \cite{robn14}\cite{hond14}\cite{ronc14}\cite{mobm14}\cite{famc14}\cite{fogm14}\cite{frba14} \\
      ...
      \cite{basc14}\cite{vamd14}\cite{kile14}\cite{jahm14}\\
...
Europa \cite{shha04,shha05,mish05,hash08}\cite{hash10}\cite{hash11,almc19}\index{Europa}

Moon \cite{elvh02}\cite{elhg04}\cite{devv10} \cite{zhdv19} \index{Moon}
...
Mercury \cite{reki07,king08} \index{Mercury}
