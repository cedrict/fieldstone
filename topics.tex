...
2015: \cite{wahg15}\cite{cobs15}\\
2016: \cite{ghbu16}\cite{bocf16}\cite{yagu16}\cite{baum16}\\
2017: \cite{ligs17}\\
2018: \cite{bofc18}\cite{ghbu18}\cite{cogb18}
}
...
2005: \cite{taxn05}\cite{bupc05}\cite{grlt05}\cite{lemj05}\cite{kogk05}\cite{mczh05b}\cite{vary05}
      \cite{nata05}\cite{nabu05}\cite{chob05}\cite{phbu05}\\
...
2007: \cite{zhzl07}\\
2009: \cite{lizh09}\cite{vasv09}\cite{iabu09}\\
