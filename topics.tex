...
2017: \cite{lemh17}\cite{brcr17}\cite{bekb17}\\
2018: \cite{chsm18}\cite{brwm18}\\
2019: \cite{lisp19}\cite{zwsb19}\cite{anpa19}\cite{dual19}
...
\cite{gagd14}\cite{voge14}\cite{voge14b}\cite{lidr14}\cite{bocj04}\\
...
\subsubsection*{Himalayan region}

\cite{chmm95}
\cite{bejn01}\cite{laav01}\cite{zemk01}
\cite{kozc02}
\cite{bejn04}
\cite{busc08}
\cite{hamo10}
\cite{care13}\cite{mutg13}
\cite{whbb14}
