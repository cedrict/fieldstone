...
2008: \cite{yaba08}\cite{ozrs08}\cite{dihf08}\cite{wabj08}\cite{wabj08b}\cite{boht08b}\cite{migb08}
      \cite{boht08a}\cite{baso08}\cite{fagc08}\cite{gecy08}\cite{fufh08}\cite{degw08}\cite{degw08b}\cite{nigc08}\\
2009: \cite{yahb09}\cite{bill09}\cite{fagb09}\cite{bejb09}\cite{kecw09}\cite{gecm09}\cite{gefc09}\\
2010: \cite{hagr10}\cite{lobh10}\cite{mamb10}\cite{camg10}\cite{casm10}\\
...
%--------------------------------------------------------------------
\subsection*{Planetary accretion, exoplanets, planet formation}
...
\subsubsection*{Himalayan region, Tibet, India collision}
