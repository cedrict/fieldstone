...
%------------------------------------------------------------------------------
\subsection*{Analogue modelling}\index{topics}{Analogue Modelling}
%------------------------------------------------------------------------------
...
\cite{jujb05}\cite{sche05}\cite{sobb05}
...
\index{topics}{Core Dynamics} \index{topics}{CMB}
%------------------------------------------------------------------------------
...
2006: \cite{rosw06}\cite{brau06gsl}\cite{bocr06}\cite{simp06}\\
...
%------------------------------------------------------------------------------
\subsection*{Channel flow model} \index{topics}{Channel Flow}
%------------------------------------------------------------------------------
...
%------------------------------------------------------------------------------
\subsection*{Continental collision} \index{topics}{Continental collision}
%------------------------------------------------------------------------------
...
1998: \cite{ande98}\cite{iwho98}\cite{devv98}\cite{tack98}\cite{tack98b}\cite{trha98b}
      \cite{trha98}\cite{burl98}\cite{mokm98}\cite{lena98}\cite{vayu98}\\
...
2001: \cite{vank01}\cite{riyb01}\cite{lemo01}\cite{vays01}\\
2002: \cite{tasu02}\cite{modm02}\cite{tack02}\cite{vaya02}\cite{vayu02}\\
2003: \cite{hapa03}\cite{lemo03}\cite{mumc03}\cite{fasa03}\cite{heta03}\\
2004: \cite{vavv04b}\cite{xita04b}\cite{xita04}\cite{nata04b}\cite{vayr04}\\
...
2009: \cite{grba09}\\
2010: \cite{albe10}\cite{albi10}\cite{inbe10}\\
2011: \cite{brfo11}\\
...
1999: \cite{hagu99}\cite{befo99}\cite{bumo99}\cite{roda99}\cite{elbp99}\cite{scmr99}\\
2000: \cite{tesc00}\cite{brky00}\cite{bemh00}\\
2001: \cite{bujl01}\cite{bugw01}\cite{chys01}\cite{coha01}\\
2002: \cite{civv02}\cite{clbb02}\cite{gesp02}\cite{ster02}\\
...
\index{topics}{Smoothed Particle Hydrodynamics} \index{topics}{SPH}
\index{topics}{Discrete Element Method} \index{topics}{DEM}
%------------------------------------------------------------------------------
...
%------------------------------------------------------------------------------
\index{topics}{EFGM} \index{topics}{Element Free Galerkin Method}
...
%------------------------------------------------------------------------------
\subsection*{Thrust-wrench fault} \index{topics}{Thrust-Wrench Fault}
%------------------------------------------------------------------------------
...
%------------------------------------------------------------------------------
\subsection*{Transpressional systems} \index{topics}{Transpressional system}
%------------------------------------------------------------------------------
...
%------------------------------------------------------------------------------
\subsection*{Urey ratio}\index{topics}{Urey Ratio}
%------------------------------------------------------------------------------
...
\begin{itemize}
\item Europa \cite{shha04,shha05,mish05,hash08}\cite{hash10}\cite{hash11,kast14,almc19}\index{topics}{Europa}
...
\cite{huyz13}\cite{gita14}\cite{gery14b}\cite{cram17}\cite{dast17}\cite{king18}\index{topics}{Venus}
\item Mars \index{topics}{Mars}
\cite{scbg90}
\cite{hach96}
\cite{resm98}
\cite{nist01}
\cite{lenm04}\cite{vavv04c}
\cite{vavv05}
...
\cite{zhon16,kili16}
\cite{cimt18}
\item Mercury \cite{reki07,king08,roba12} \index{topics}{Mercury}
