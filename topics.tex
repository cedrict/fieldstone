...
\index{Surface Processes}\index{Erosion}
...
2006: \cite{libi06}\cite{bube06}\cite{basv06}\cite{kasc06}\cite{fuwb06}\cite{colm06}\\
...
2007: \cite{huha07}\cite{macl07}\cite{vabl07}\cite{dyrm07}\\
2008: \cite{cort08}\cite{gumb08}\cite{buhb08}\\
...
2007: \cite{artd07}\cite{yaab07}\cite{cubh07}\cite{civv07}\cite{masp07}\cite{camg07}\cite{gogg07}\cite{gowg07}\cite{magu07}\\
