...
1995: \cite{belg95}\cite{brbe95}\cite{kian95}\cite{budi95}\\
1996: \cite{bekh96}\\
...
2003: \cite{wipo03}\cite{wabu03}\cite{geur03}\\
...
\cite{birg96}\cite{burb96}\cite{kafo96}\cite{guez96}\\
...
2005: \cite{jalo05}\cite{lahb05}\cite{gowo05}\\
...
\cite{boht08a}\cite{baso08}\cite{fagc08}\cite{gecy08}\\
...
\cite{magc13}\cite{musi13}\cite{mibg13}\cite{grpy13}\\
