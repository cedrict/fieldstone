...
%------------------------------------------------------------------------------A
%------------------------------------------------------------------------------A
\section{axisymmetric modelling}
%------------------------------------------------------------------------------A
%------------------------------------------------------------------------------A
...
%------------------------------------------------------------------------------C
%------------------------------------------------------------------------------C
\section{compressible flow, compressibility, Ba, EBA, TALA, ALA and co}
%------------------------------------------------------------------------------C
%------------------------------------------------------------------------------C
...
%------------------------------------------------------------------------------C
%------------------------------------------------------------------------------C
\section{continental root, erosion of continental roots}
%------------------------------------------------------------------------------C
%------------------------------------------------------------------------------C
...
%------------------------------------------------------------------------------D
%------------------------------------------------------------------------------D
\section{diapirism, Rayleigh-Taylor instability, plutons, intrusions}
%------------------------------------------------------------------------------D
%------------------------------------------------------------------------------D
...
mantle unrooting, lithosphere thinning, convective destabilization, 
small scale convection, drip} 
%------------------------------------------------------------------------------D
%------------------------------------------------------------------------------D
...
%------------------------------------------------------------------------------
%------------------------------------------------------------------------------
\section{(role of) (visco-)elasticity (in geodynamics modelling)}
%------------------------------------------------------------------------------
%------------------------------------------------------------------------------
...
%------------------------------------------------------------------------------F
%------------------------------------------------------------------------------F
\section{finite differences (FDM)}
%------------------------------------------------------------------------------F
%------------------------------------------------------------------------------F
...
%------------------------------------------------------------------------------F
%------------------------------------------------------------------------------F
\section{foreland (basin)} 
%------------------------------------------------------------------------------F
%------------------------------------------------------------------------------F

\begin{small}
\begin{itemize}
\item[1986] \fullcite{stbb86} 
\item[1997] \fullcite{gaft97}
\item[1998] \fullcite{buwg98} 
\item[2002] \fullcite{garc02} \\ \fullcite{pfsb02} 
\item[2004] \fullcite{fijj04} 
\item[2006] \fullcite{nehe06} \\ \fullcite{simp06}
\item[2010] \fullcite{simp10}
\item[2013] \fullcite{tuva13} 
\item[2023] \fullcite{pors23} 
\item[2022] \fullcite{lisb22}
\item[2024] \fullcite{malb24}
\item[2025] \fullcite{espt25} 
\end{itemize}
\end{small}
...
%------------------------------------------------------------------------------G
%------------------------------------------------------------------------------G
\section{grain size (evolution) \& influence on geodynamics}\label{sec:topics:gsev}
%------------------------------------------------------------------------------G
%------------------------------------------------------------------------------G
...
%------------------------------------------------------------------------------
%------------------------------------------------------------------------------
\section{(use of) Inverse methods, inversion, adjoint methods, (data) assimilation}
%------------------------------------------------------------------------------
%------------------------------------------------------------------------------
...
%------------------------------------------------------------------------------L
%------------------------------------------------------------------------------L
\section{LLSVPs, LLVPs, ULVZ, CMB layer, thermo-chemical piles, D'' layer}
%------------------------------------------------------------------------------L
%------------------------------------------------------------------------------L
...
%------------------------------------------------------------------------------
%------------------------------------------------------------------------------
\section{(Thermal) Lattice Boltzmann Method (TLBM), Lattice Gas Automata}
%------------------------------------------------------------------------------
%------------------------------------------------------------------------------
...
%------------------------------------------------------------------------------P
%------------------------------------------------------------------------------P
\section{planetary accretion, exoplanets, planet formation, segregation, Super Earths}
%------------------------------------------------------------------------------P
%------------------------------------------------------------------------------P
...
%------------------------------------------------------------------------------P
%------------------------------------------------------------------------------P
\section{(subduction) polarity reversal}
%------------------------------------------------------------------------------P
%------------------------------------------------------------------------------P
...
\item[2025] \fullcite{masg25}\\ \fullcite{guhp25}
\end{itemize}
\end{small}
...
\item[2022] \fullcite{raud22}
\item[2024] \fullcite{alku24}
\end{itemize}
\end{small}
...
\begin{small}
\begin{itemize}
\item[2015] \textcite{cobs15}
\item[2018] \textcite{cogb18}
\item[2021] \textcite{ghbo21} 
\end{itemize}
\end{small}
...
rate and state friction, dynamic rupture}
%------------------------------------------------------------------------------S
%------------------------------------------------------------------------------S
...
\item[2025] \fullcite{bhjk25} \\ \fullcite{grlc25}
\end{itemize}
\end{small}
...
%----------------------------------------------------------------------------S
%----------------------------------------------------------------------------S
\section{subduction: slab foundering, lithospheric foundering}
%----------------------------------------------------------------------------S
%----------------------------------------------------------------------------S
...
%----------------------------------------------------------------------------S
%----------------------------------------------------------------------------S
\section{subduction: intra-oceanic subduction}
%----------------------------------------------------------------------------S
%----------------------------------------------------------------------------S
...
%------------------------------------------------------------------------------S
%------------------------------------------------------------------------------S
\section{subduction: single-sided}
%------------------------------------------------------------------------------S
%------------------------------------------------------------------------------S
...
%------------------------------------------------------------------------------S
%------------------------------------------------------------------------------S
\section{structural geology, cm-scale, shear zones, texture}
%------------------------------------------------------------------------------S
%------------------------------------------------------------------------------S
...
%------------------------------------------------------------------------------
%------------------------------------------------------------------------------
\section{Tectonic quiescence} 
%------------------------------------------------------------------------------
%------------------------------------------------------------------------------

\begin{small}
\begin{itemize}
\item[2021] \fullcite{sasa21}
\item[2022] \fullcite{kebj22}
\item[2023] \fullcite{sasa23b} 
\end{itemize}
\end{small}

%------------------------------------------------------------------------------
%------------------------------------------------------------------------------
\section{Triple junctions} 
%------------------------------------------------------------------------------
%------------------------------------------------------------------------------
...
%------------------------------------------------------------------------------
%------------------------------------------------------------------------------
\section{True polar wander, apparent polar wander} 
%------------------------------------------------------------------------------
%------------------------------------------------------------------------------
...
%--------------------------------------------------------------------
\section{Wilson cycle, supercontinent cycles, insulation}
%--------------------------------------------------------------------
...
%--------------------------------------------------------------------
%------------------------------------------------------------------------------
\section{mantle convection/dynamics, whole Earth models, plate interaction, tectonic regimes}
%--------------------------------------------------------------------
%------------------------------------------------------------------------------
...
%------------------------------------------------------------------------------
%------------------------------------------------------------------------------
\section{porosity waves} 
%------------------------------------------------------------------------------
%------------------------------------------------------------------------------

\begin{small}
\begin{itemize}
\item[2015] \fullcite{copo15} \\ \fullcite{yapc15}
\item[2016] \fullcite{skre16}
\item[2018] \fullcite{johr18}
\item[2020] \fullcite{yapw20}
\item[2022] \fullcite{bepp22}
\end{itemize}
\end{small}
...
%--------------------------------------------------------------------
\section{subduction retreat, trench retreat, trench migration}
%--------------------------------------------------------------------
