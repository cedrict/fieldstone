...
%--------------------------------------------------------------------
\subsection*{Magma transport / melting / two phase flow}
...
2006: \cite{beck06}\\
2007: \cite{nake07}\cite{mayu07}\cite{brva07a}\cite{brva07b}\\
2008: \cite{tack08}\cite{chhl08}\cite{brhv08}\\
2009: \cite{wodd09}\cite{fobe09}\cite{gows09}\\
2010: \cite{bumb10}\\
...
2014: \cite{arfw14}\cite{helo14}\cite{crta14}\cite{flgw14}\cite{roct14}\\
...
2008: \cite{yaba08}\cite{ozrs08}\cite{dihf08}\cite{wabj08}\cite{wabj08b}\cite{boht08b}\cite{migb08}
      \cite{boht08a}\cite{baso08}\cite{fagc08}\cite{gecy08}\cite{fufh08}\cite{degw08}\cite{degw08b}\cite{gepb08}\cite{nigc08}\\
2009: \cite{yahb09}\cite{bill09}\cite{fagb09}\cite{bejb09}\cite{kecw09}\cite{gecm09}\cite{gefc09}\cite{famg09}\cite{lige09}\\
2010: \cite{hagr10}\cite{lobh10}\cite{mamb10}\cite{camg10}\cite{casm10}\cite{ligb10}\cite{stfc10}\\
2011: \cite{lixg11}\cite{list11}\cite{bubj11}\cite{bagw11b}\cite{cafz11}\cite{geme11}\cite{qube11}\cite{blgg11}\\
...
%--------------------------------------------------------------------
\subsection*{accretionary wedges} \index{Accretionary Wedge}
