...
\item [\twothousandten]  \cite{will10}\cite{tuha10}\cite{brau10}\cite{brau10}\cite{brya10}\cite{crmw10}
...
\item[\twothousandfive] \cite{hubb05}\cite{coub05}\cite{vanw05}\cite{vabl05}
\item[\twothousandsix] \cite{tibs06},\cite{coma06},
                       \cite{crwy06},\cite{peso06},
                       \cite{lemm06},\cite{malm06}, 
                       Crosby \etal \cite{crms06}\\
\item[\twothousandseven] \cite{huha07}\cite{macl07}
                         \cite{vabl07}\cite{dyrm07}
                         \cite{hube07}\cite{buto07}
                         \cite{socb07}\cite{werr07}
\item[\twothousandeight] \cite{cort08}\cite{gumb08}
...
\item[\twothousandtwelve] Allken \etal \cite{alht12}, \cite{brps12}
                    \cite{bein12}
...
\item[\twothousandeighteen] \cite{chsm18}\cite{brwm18},
...
{\color{red} needs sorting: what are the major subgenres ? } 
...
\twothousandthree: \cite{refm03}\cite{fumr03}, Gerbault \etal \cite{gehd03}, \cite{bigs03}\\
...
\twothousandsix: \cite{degw06}\cite{rohu06}\cite{masr06}\cite{gest06}\cite{fump06}\cite{pibf06}\cite{stfs06}
      \cite{libi06}\cite{hapf06}\cite{sobk06}\cite{syab06}, Currie \& Hyndman \cite{cuhy06}\\
\twothousandseven: Tagawa \etal \cite{tank07}, \cite{artd07}
      ...
      \cite{bihi07}\\
\twothousandeight: \cite{yaba08}\cite{ozrs08}\cite{wabj08}\cite{wabj08b}\cite{boht08b}
...
Morra \etal \cite{moyb10}, \cite{zhst10}\cite{qusp10}\cite{moht10}\cite{leki10}\cite{sigb10}\cite{stsf10}
\cite{syva10}\\
\twothousandeleven: 
...
\cite{buqm12}\cite{yoth12}\cite{gigh12}\cite{vakn12}, Roda \etal \cite{rosm12}\\
\twothousandthirteen: 
...
\twothousandtwenty: \cite{algg20}\cite{braf20}
                    van den Broek \etal \cite{vamg20}, \cite{dawl20}
                    ...
                    Sch{\"u}tt \& Whipp \cite{scwh20}
\twothousandtwentyone: Suchoy \etal \cite{sugm21}
\end{scriptsize}
...
\item[\twothousandten] Stein \etal \cite{stfh10}
