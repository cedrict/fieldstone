...
\item[\twothousandone] \cite{goko01}
\item[\twothousandfour] \cite{frmm04}
\item[\twothousandsix] \cite{asbl06}\cite{frmm06}
\item[\twothousandseven] \cite{susp07}\cite{zwgg07}
