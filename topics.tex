...
2012: \cite{grmd12}\\
2013: \cite{luws13}\cite{vadv13}\cite{guhf13}\cite{mibg13}\cite{mesc13}\cite{dusc13}\\
...
2016: \cite{kord16}\cite{moek16}\cite{rond16}\cite{duti16a,duti16b}\\
2017: \cite{roev17}\\
...
2013: \cite{vehc13}\cite{brwi13}\cite{fihv13a}\cite{fihv13b}\cite{brrs13}\cite{chgz13}\cite{tuva13}
      \cite{caya13} \\
2014: \cite{crbr14}\cite{cokm14}\cite{erhv14}\cite{erhv15}\cite{stsc14} \\
2015: \cite{uewg15}\\
2016: \cite{coyc16}\\
...
2016: \cite{howa16}\cite{gvfb16}\cite{yagu16}\cite{stei16}\\
...
1983: \cite{hous83}\cite{hous83b}\cite{chri83}\cite{mcke83}\cite{chri83b}\\
...
1992: \cite{besg92}\cite{mayw92}\cite{vayv92}\cite{chri92}\\
...
2005: \cite{taxn05}\cite{bupc05}\cite{grlt05}\cite{lemj05}\cite{kogk05}\cite{mczh05b}\cite{vary05}
      \cite{nata05}\cite{nabu05}\cite{chob05}\\
...
2012: \cite{huco12}\cite{gubc12}\cite{egim12}\\
...
2018: \cite{daga18}\cite{stbl18}\cite{frkc18}\\
2019: \cite{kobg19}
}
...
2014: \cite{hebr14}\cite{lige14}\cite{brun14}\cite{kobf14}\cite{ebva14}\cite{puge14}\cite{lige14b}
      \cite{hube14}\cite{gogu14}\cite{ebva14}\\
...
2013: \cite{nabg13}\cite{hage13}\cite{ancv13}\cite{namu13}\cite{yosh13}\cite{zhgt13}\cite{lixg13} 
      ...
      \cite{cavg13}\cite{vocg13}\cite{qula13}\cite{bugu13}\cite{myhi13}\cite{mesc13}\\
...
2015: \cite{bemm15}\cite{bomv15}\cite{bogf15}\cite{ceag15}\cite{kifr15}\cite{vami15}\cite{dali15}
      \cite{mami15}\cite{rula15}\cite{chsd15}\cite{dusc15}\\
...
Greenland \cite{stsj14}\cite{stbl18}
