...
2015: \cite{uewg15,fohk15,cofk15}\\
2016: \cite{coyc16,schr16}\\
2018: \cite{jolp18}\\
2019: \cite{anpa19,sall19}\\
2020: \cite{ster20}
}
...
2019: \cite{lisp19}\cite{zwsb19}\cite{anpa19}\cite{dual19}\cite{mocb19}\cite{chmd19}\cite{thhu19}
      \cite{jala19}\cite{zwsr19}\cite{hooi19}\cite{lapk19}\\
2020: \cite{cump20}\cite{pena20,ster20,fahm20}
}
...
1989: \cite{boww89}\cite{mibj89}\cite{hesw89}\\
...
2012: \cite{anwb12}\cite{jahu12}\cite{jabi12}\cite{jabk12}\cite{lixg12}\cite{grpy12}\cite{grpy12b}
      ...
      \cite{buqm12}\cite{yoth12}\cite{gigh12}\cite{vakn12}\\
...
2020: \cite{livn20}\cite{chlc20}\cite{pust20}
}
