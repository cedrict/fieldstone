...
\item[\nineteenninetysix] 
\cite{bekh96} \cite{bekh96}\\
\cite{berc96} \cite{berc96}\\
\cite{jabh96} \cite{jabh96}\\
\item[\nineteenninetyseven] 
\cite{thsj97} \cite{thsj97}\\
\cite{babr97} \cite{babr97}\\
\cite{bucl97} \cite{bucl97}\\
\cite{mole97} \cite{mole97}\\
\item[\nineteenninetyeight] 
\cite{bird98} \cite{bird98}\\
\cite{lecd98} \cite{lecd98}\\
\cite{kian98} \cite{kian98}\\
\cite{mafs98} \cite{mafs98}\\
\cite{madu98} \cite{madu98}\\
\cite{gumm98} \cite{gumm98}\\
\cite{berc98} \cite{berc98}\\
\cite{madu98} \cite{madu98}\\
\item[\nineteenninetynine] 
\cite{will99b} \cite{will99b}\\
\cite{bird99} \cite{bird99}\\
\cite{clbp99} \cite{clbp99}\\
\cite{fugo99} \cite{fugo99}\\
\cite{mole99} \cite{mole99}\\
\cite{lemo99} \cite{lemo99}\\
\cite{gebp99} \cite{gebp99}\\
\item[\twothousand] 
\cite{hanl00} \cite{hanl00}\\
\cite{labp00} \cite{labp00}\\
\cite{lemm00} \cite{lemm00}\\
\cite{gumm00} \cite{gumm00}\\
\cite{lemo00} \cite{lemo00}\\
\cite{pepo00} \cite{pepo00}\\
\cite{scys00b} \cite{scys00b}\\
\item[\twothousandone] 
\cite{homo01} \cite{homo01}\\
\cite{beoc01} \cite{beoc01}\\
\cite{kapo01} \cite{kapo01}\\
\item[\twothousandtwo] 
\cite{labu02} \cite{labu02}\\
\cite{coli02} \cite{coli02}\\
\cite{bast02} \cite{bast02}\\
\cite{gedh02} \cite{gedh02}\\
\cite{kilg02} \cite{kilg02}\\
\item[\twothousandthree] 
\cite{wipo03} \cite{wipo03}\\
\cite{wabu03} \cite{wabu03}\\
\cite{geur03} \cite{geur03}\\
\cite{upke03} \cite{upke03}\\
\cite{vamf03} \cite{vamf03}\\
\cite{bupf03} \cite{bupf03}\\
\cite{lemm03} \cite{lemm03}\\
\cite{onmo03} \cite{onmo03}\\
\item[\twothousandfour] 
\cite{tibb04} \cite{tibb04}\\
\cite{gewi04} \cite{gewi04}\\
\cite{colm04} \cite{colm04}\\
...
\item[\twothousandfive]
\cite{resb05} \cite{resb05}\\
\cite{taxn05} \cite{taxn05}\\
\cite{bupc05} \cite{bupc05}\\
\cite{grlt05} \cite{grlt05}\\
\cite{lemj05} \cite{lemj05}\\
\cite{kogk05} \cite{kogk05}\\
\cite{mczh05b} \cite{mczh05b}\\
\cite{vary05} \cite{vary05}\\
\cite{nata05} \cite{nata05}\\
\cite{nabu05} \cite{nabu05}\\
\cite{chob05} \cite{chob05}\\
\cite{phbu05} \cite{phbu05}\\
\cite{hosh05} \cite{hosh05}\\
\item[\twothousandsix] 
\cite{soba06} \cite{soba06}\\ 
\cite{beck06} \cite{beck06}\\ 
\cite{nake06} \cite{nake06}\\ 
\cite{losh06} \cite{losh06}\\ 
\cite{sthh06} \cite{sthh06}\\ 
\cite{yoka06} \cite{yoka06}\\ 
\item[\twothousandseven] 
\cite{ghja07} \cite{ghja07}\\
\cite{nake07} \cite{nake07}\\
\cite{mayu07} \cite{mayu07}\\
\cite{brva07a} \cite{brva07a}\\
\cite{brva07b} \cite{brva07b}\\
\cite{grlt07} \cite{grlt07}\\
\cite{grlt07b} \cite{grlt07b}\\
\cite{huda07} \cite{huda07}\\
\cite{tanh07} \cite{tanh07}\\
\cite{tagu07} \cite{tagu07}\\
\cite{jalo07} \cite{jalo07}\\
\cite{galo07} \cite{galo07}\\
\cite{galo07b} \cite{galo07b}\\ 
\cite{nelo07} \cite{nelo07}\\
\cite{soba07} \cite{soba07}\\
\item[\twothousandeight] 
