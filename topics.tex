...
2005: \cite{mure05}\\
2006: \cite{kapo06}\cite{more06}\cite{onmm06}\cite{mudm06}\\
...
2006: \cite{masr06}\\
2007: \cite{mitk07}i\cite{lobc07}\\
...
2008: \cite{affr08}\cite{tibb08}\cite{hapo08}\cite{busc08}\cite{clbz08}\cite{chlg08}
      \cite{kasb08}\cite{fabs08}\cite{chgu08}\\
...
2019: \cite{koen19}\cite{kipd19}\cite{crcm19}
...
1994: \cite{haeb94}\cite{chho94}\cite{tasg94}\cite{itki94}\\
1995: \cite{zhgu95}\cite{vayv95}\cite{buba95}\cite{rasz95}\cite{berc95}\\
...
1998: \cite{ande98}\cite{iwho98}\cite{devv98}\cite{tack98}\cite{tack98b}\cite{trha98b}
      \cite{trha98}\cite{burl98}\cite{mokm98}\\
...
2009: \cite{wodd09}\cite{fobe09}\cite{gows09}\cite{deta09}\cite{onlj09}\\
2010: \cite{bumb10}\cite{detn10}\cite{yayh10}\cite{nata10}\cite{hole10}\\
...
2016: \cite{frbs16}\cite{sisc16}\cite{boba16}\\
2017: \cite{ghts17}\\
2018: \cite{cold18}\cite{arcf18}\cite{cosh18}\\
2019: \cite{gult19}\cite{mazh19}\cite{cohf19}\cite{lewh19}
...
2007: \cite{artd07}\cite{yaab07}\cite{cubh07}\cite{civv07}\cite{masp07}\cite{camg07}
      \cite{gogg07}\cite{gowg07}\cite{magu07}\cite{moct07}\cite{onlm07}\\
2008: \cite{yaba08}\cite{ozrs08}\cite{dihf08}\cite{wabj08}\cite{wabj08b}\cite{boht08b}
      \cite{migb08}\cite{boht08a}\cite{baso08}\cite{fagc08}\cite{gecy08}\cite{fufh08}
      \cite{degw08}\cite{degw08b}\cite{gepb08}\cite{nigc08}\cite{sebp08}\\
2009: \cite{yahb09}\cite{bill09}\cite{fagb09}\cite{bejb09}\cite{kecw09}\cite{gecm09}\cite{gefc09}\\
      \cite{famg09}\cite{lige09}\cite{moct09}\cite{lohb09}\cite{befa09}\\
...
2014: \cite{robn14}\cite{hond14}\cite{ronc14}\cite{mobm14}\cite{famc14}\cite{fogm14}\cite{frba14} \\
      ...
      \cite{basc14}\cite{vamd14}\cite{kile14}\\
...
2017: \cite{kicf17}\cite{sche17}\cite{pest17}\cite{vomc17}\cite{majf17}\\
2018: \cite{yamz18}\cite{crli18}\\
2019: \cite{magn19}\cite{mavb19}\cite{scvm19}
...
Europa \cite{shha04},\cite{shha05} \index{Europa}

Moon \cite{devv10} \cite{zhdv19} \index{Moon}

Venus \cite{scbg90}\cite{kiha92}\cite{kief93}\cite{somo96}\cite{mazk98}\cite{moso98}\cite{phha98}
\cite{vavv05}\cite{arta12}\cite{gita14}\cite{gery14b}\cite{cram17}\cite{dast17}\cite{king18}
\index{Venus}

Mars \cite{scbg90}\cite{hach96}\cite{nist01}\cite{lenm04}\cite{vavv05}\cite{keta09}\cite{gokg11}
\cite{ruts13}\cite{seki14}\cite{zhon16}\index{Mars}

Mercury \cite{reki07} \index{Mercury}
...
%..........................
\item{Japan} 
\cite{kigk14}\cite{leli14}\cite{kilk15}
\index{Japan}
%..........................
