...
\item[\twothousandfour] \cite{spwo04}, Boschi \etal \cite{boek04}
\item[\twothousandnine] \cite{wogs09}
\item[\twothousandten] \cite{bofb10}\cite{fabe10}
\item[\twothousandfourteen] \cite{chsv14}\cite{chsg14}\cite{vavs14}\cite{mafv14}
\item[\twothousandsixteen] \cite{mesj16}
\item[\twothousandeighteen] \cite{spcv18}
