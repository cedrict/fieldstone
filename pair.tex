...
\Literature p. 722 of \cite{john16} \cite{ratu92,horg95,knob00,lisi12,maky17,bufm19}
...
\item P2P2
\item the MINI quadrilateral element $Q_1^+\times Q_1$. \index{general}{$Q_1^+ \times Q_1$} \cite{bai97,kwpa14,lami17}
