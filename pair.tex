...
It is used in van de Vosse \etal (1989) \cite{vavs89} for steady laminar flowin a curved tube. 
...
Also used in Zlotnik \etal (2007) \cite{zldf07} for suduction with X-FEM technique.
