...
2003: \cite{taxi03}\\
2004: \cite{xita04b}\cite{xita04}\cite{nata04}\cite{nata04b}\cite{nata04c}\\
2005: \cite{grlt05}\cite{fasa05}\\
2006: \cite{mita06}\\
2007: \cite{grlt07}\cite{grlt07b}\cite{heta07}\\
2008: \cite{deta08}\cite{hets08}\cite{heta08}\cite{sata08}\cite{nata08}\\
...
2013: \cite{ruts13}\cite{taab13}\cite{nata13}\\
...
2019: \cite{samo19}\cite{yamg19}\cite{canc19}\cite{cakc19}\cite{sams19b}
}
