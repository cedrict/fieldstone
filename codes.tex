...
2008: \cite{deta08}\cite{hets08}\\
2009: \cite{deta09}\cite{natd09}\cite{keta09}\\
2010: \cite{detn10}\\
2011: \cite{rota11}\cite{gokg11}\\
2012: \cite{roct12}\cite{crtm12}\cite{cosr13}\cite{deyt12}\cite{dect12}\\
2014: \cite{yadl14}\cite{crta14}\cite{roct14}\cite{cort14}\cite{becr14}\\
2015: \cite{bect15}
2016: \cite{sisc16}\\
2017: \cite{cogu17}\\
