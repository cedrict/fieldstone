...
\item[\twothousandtwentyone] \textcite{siht21} 
\end{itemize}
\end{scriptsize}
...
\item[\twothousandtwentytwo] \textcite{kone22}
\end{itemize}
\end{scriptsize} 
...
\item[\twothousandtwenty]    \textcite{deol20} 
\end{itemize}
\end{scriptsize}
