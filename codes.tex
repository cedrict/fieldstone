...
\noindent
{\small
2012: Kronbichler et al \cite{krhb12}\\
2015: Austermann et al \cite{aupm15}, Tosi et al \cite{tosn15}\\
2016: Dannberg \& Heister \cite{dahe16}, Gassmoeller et al \cite{gadb16}, Zhang \& O'Neill \cite{zhon16}\\
2017: He et al \cite{hepb17}, Dannberg et al \cite{daef17}, Heister et al \cite{hedg17},
...
2018: \cite{daga18}\cite{onzh18}, Glerum et al \cite{gltf18}, \cite{heps18}\cite{galh18}\cite{peka18}
      \cite{puth18}\cite{brst18b}, Zhang \& Li \cite{zhli18}\\
2019: Bauville \& Baumann \cite{baba19}, Steinberger et al \cite{stbl19}, Corti et al \cite{cocf19},
...
2020: Gassmoeller et al \cite{gadb20}, Farangitakis et al \cite{fahm20}, 
...
2020: Weller \& Kiefer \cite{weki20}, Briaud et al \cite{braf20}, van den Broek et al \cite{vamg20},
...
{\small
\noindent
Yoshida (2008) \cite{yosh08}
Yoshida et al (2012) \cite{yoth12}
Yoshida (2013) \cite{yosh13} 
Yoshida et al (2020) \cite{yosy20}
} 
...
{\small
\noindent
Braun et al (2008) \cite{brtf08}, 
Thieulot et al (2008) \cite{thfb08}
Yamato et al (2009) \cite{yahb09},
Braun et al (2010) \cite{brya10},
Loiselet et al (2010) \cite{lobh10},
Murphy et al (2014) \cite{mutg14},
Whipp et al (2014) \cite{whbb14},
Nettesheim et al (2018) \cite{neew18},
Koptez et al (2019) \cite{koen19}
}
...
{\small
\noindent
2003: \cite{modm03}\cite{wibm03}\cite{mumc03}\cite{wemv03}\cite{onmo03}\cite{onml03}\\
2004: \cite{wijns2004}\\
...
2019: \cite{kobg19}\cite{ligc19}\cite{sihf19}\cite{meag19}\cite{gubg19}\cite{vawg19}\cite{zhli19}\\
2020: \cite{basg20}\cite{zhlg20}\cite{dawl20}\cite{chcg20}\cite{meag20}\cite{chlc20}\cite{mugu20}
}
...
2012: \cite{besy12}\cite{beva12}\cite{chgv12}\cite{vakn12}\\
...
2003: \cite{taxi03}\\
2004: \cite{xita04b}\cite{xita04}\cite{nata04}\cite{nata04b}\cite{nata04c}\cite{scmo04}\cite{yoog04}\\
2005: \cite{grlt05}\cite{fasa05}\cite{nata05}\cite{nata05b}\cite{nabu05}\cite{yoog05}\\
2006: \cite{mita06}\\
...
Wilson et al \cite{wisv17},
Spiegelman \cite{spmw16},
Cerpa et al \cite{ceww17},
Cerpa et al \cite{ceww19},
Sim et al \cite{siss20}
}
