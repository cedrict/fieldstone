...
Glerum et al \cite{gltf18}, \cite{heps18}, Gassmoeller et al \cite{galh18}, 
...
Louis-Napoleon et al \cite{logb20}, Heyn et al \cite{hect20}
}
...
\nineteenninetysix: \cite{somo96}\cite{mogu96}\cite{zhgu96}\\
\nineteenninetyseven: \cite{mole97}\cite{bugm97}\cite{somo97}\\
\nineteenninetyeight: \cite{moso98}\cite{zhgm98}\cite{gumm98}\cite{resm98}\\
...
\twothousandtwenty: Weller \& Kiefer \cite{weki20}, Briaud et al \cite{braf20}, van den Broek et al \cite{vamg20},
      Hertgen et al \cite{heyg20}, Billen \cite{bill20}
...
\twothousandfourteen:
\cite{kile14}\cite{leli14}\\
\twothousandfifteen:
\cite{kifr15}\cite{kilk15}\cite{lile15}
\end{scriptsize}
...
\twothousandtwenty:
\cite{algg20}\cite{mapg20}\cite{gatt20}
\end{scriptsize}
...
\twothousandtwenty: \cite{basg20}\cite{zhlg20}\cite{dawl20}\cite{chcg20}\cite{meag20}\cite{chlc20}\cite{mugu20}
...
\twothousandfive: \cite{vavv05}\cite{sepr05}\cite{vary05}\\
\twothousandsix: \cite{liva06a}\cite{liva06b}\cite{abvk06}\\
...
\twothousandten: \cite{albs10}\cite{albe10}\cite{grpy10}\cite{pygp10}\cite{albi10}\cite{jabw10}\cite{inbe10}
      \cite{inbe10b}\\
\twothousandeleven: \cite{cube11}\cite{bubj11}\cite{hube11}\cite{jabe11}\\
\twothousandtwelve: \cite{grpy12}\cite{grpy12b}\cite{kogp12}\cite{grbe12}\cite{jahu12}\cite{albe12}\cite{grbi12}
...
\twothousandfourteen: \cite{gogu14}\cite{jahm14}\cite{hube14}\cite{bubj14}\\
\twothousandfifteen: \cite{albe15}\cite{bubj15}\cite{heps15}\cite{cudd15}\\
\twothousandsixteen: \cite{licu16}\cite{albe16}\cite{kebb16}\\
\twothousandseventeen: \cite{bube17}\cite{grbe17}\\
\twothousandeighteen: \cite{webe18}\cite{webe18b}
...
\twothousandeighteen: \cite{cosh18}\cite{bofc18}\cite{cold18}\cite{arcf18}\cite{cram18}\cite{crli18}\cite{lalt18}
      \cite{dert18}\\
\twothousandnineteen: \cite{gult19}\cite{argc19}\cite{deli19}\cite{pact19}\cite{cohf19}\cite{crcm19}\cite{ulcw19}\\
\twothousandtwenty: \cite{lalt20}\cite{gugb20}\cite{yabt20}
...
\twothousandtwenty: Roda et al \cite{rozr20}
\end{scriptsize}
...
{\small
\noindent
Samuel \& Tosi \cite{sato12}, 
Tosi et al \cite{toyd13},
Tosi et al \cite{tosn15},
Tosi et al \cite{tomy16}.
}
