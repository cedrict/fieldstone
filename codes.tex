...
\item[\twothousandtwenty] Gassmoeller \etal \cite{gadb20}, Farangitakis \etal \cite{fahm20}, 
                          Louis-Napoleon \etal \cite{logb20}, Heyn \etal \cite{hect20}, 
...
\item[\twothousandtwenty] Weller \& Kiefer \cite{weki20}, Briaud \etal \cite{braf20}, 
                    ...
                    Dang \etal \cite{dazl20}, Wang \& Li \cite{wali20}
...
{\small
\noindent
\twothousandone: Moresi \etal \cite{modm01}\\
...
\nineteenninetynine: Willett \cite{will99a,will99b}, Ellis \etal \cite{elbp99},
                     \cite{elbe99}\cite{beep99}\cite{pelj99}\\
\twothousand: \cite{pybf00}\cite{bemh00}
              \cite{pfeb00}\\
...
\twothousandnineteen: \cite{gult19}\cite{argc19}
                      \cite{deli19}\cite{pact19}
                      \cite{cohf19}\cite{crcm19}\cite{ulcw19}\\
\twothousandtwenty: Langemeyer \etal \cite{lalt20}, Gulcher \etal \cite{gugb20}
...
\twothousandtwenty: Mansour \etal \cite{magm20}, Sandiford \etal \cite{sams20}, 
                    Ghosh \etal \cite{ghbm20}, Korchinski \etal \cite{kotr21}
\end{scriptsize}
