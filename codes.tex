...
\item[\twothousandtwentyone] Cao \etal \cite{cafm21}
\end{itemize}
\end{scriptsize}
...
\twothousandsixteen: \cite{kobc16}\cite{magc16}\cite{fige16}\cite{mauw16}\cite{duay16}\cite{mesj16}\cite{huwc16}
      \cite{staj16}\\
\twothousandseventeen: \cite{mauw17}\cite{kocb17}\cite{vomc17}\cite{shwl17}, Liao \etal \cite{liwg17}\\
...
\twothousandtwentyone  Pei \etal \cite{pels21}
\end{scriptsize}
...
\twothousandseventeen: Coltice \etal \cite{cogu17}, Petersen \etal \cite{pest17}, 
...
\twothousandnineteen: Price \etal \cite{prdp19}
\end{scriptsize}
...
\begin{scriptsize}
\begin{itemize}
\item[\twothousandsix] \cite{stfs06}\cite{momu06}
