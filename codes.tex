...
2019: \cite{baba19}\cite{stbl19}\cite{cocf19}\cite{liki19}\cite{galb19}
...
2005: \cite{buge05}\cite{mage05}\\
2006: \cite{bbeg06}\cite{gest06}\cite{gogc06}\cite{gecy06}\\
2007: \cite{geyu07}\cite{gogc07}\cite{gebu07}\\
2008: \cite{scbe08}\cite{gecy08}\cite{uegs08}\cite{fagc08}\cite{zhgy09}\cite{buge08}\cite{cage08}\cite{migb08}\cite{nigc08}\\
2009: \cite{gefc09}\cite{bubg09}\cite{ligt09}\\
2010: \cite{gerya2010}\cite{nigm10}\cite{bagc10}\\
2011: \cite{dugm11}\cite{dumg11}\cite{lixg11}\cite{gery11}\cite{geme11}\cite{blgg11}\cite{nigm11}\\
...
2013: \cite{lixg13}\cite{nabg13}\cite{magc13}\cite{vagd13a}\cite{vagd13b}\cite{zhgt13}\cite{dyge13}\cite{gemd13}
      \cite{mana13}\cite{chgz13}\cite{chgz13b}\cite{duge13}\cite{cavg13}\\
2014: \cite{dugs14}\cite{puge14}\cite{rugb14}\cite{voge14b}\cite{bagb14}\cite{lige14}\cite{stjm14}\cite{malg14}
\cite{buge14}\cite{gosk14}\cite{vamd14}\cite{macg14}\\
...
\noindent
2011: \cite{rota11}\\
2012: \cite{roct12}\cite{crtm12}\\
2014: \cite{yadl14}\cite{crta14}\\
2016: \cite{sisc16}\\
2017: \cite{cogu17}\\
