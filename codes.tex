...
2018: \cite{hect18}\cite{king18}\cite{kavb18}\cite{wavp18}\cite{hulz18}\cite{lizo18}\cite{cimt18}
      \cite{trev18}\cite{wele18}\cite{yagz18}\cite{mazh18}\\
...
2018: \cite{zhlg18}\\
2019: \cite{kobg19}\cite{ligc19}\cite{sihf19}\cite{meag19}
}
...
2019: \cite{zhdv19}\cite{vayu19}\cite{casv19}
}
...
2005: \cite{grlt05}\cite{fasa05}\cite{nata05}\cite{nata05b}\\
2006: \cite{mita06}\\
