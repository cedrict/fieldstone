...
1999: \cite{mole99}\cite{bumo99}\cite{vazh99}\\
2000: \cite{zhzm00}\cite{gumr00}\cite{lemm00}\cite{gumm00}\\
2001: \cite{bigu01}\\
2002: \cite{tagh02}\\
2003: \cite{vazh03}\cite{cogu03}\cite{bigu03}\cite{lemm03}\\
2004: \cite{solo04}\cite{frmm04}\cite{lenm04}\\
2005: \cite{bihi05}\cite{mczh05a}\cite{mczh05b}\cite{lemj05}\\
2006: \cite{beck06}\cite{pibf06}\cite{tact06}\cite{besb06}\cite{coli06}\cite{frmm06}\\
