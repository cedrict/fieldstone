...
2001: \cite{bigu01}\\
2002: \cite{tagh02}\\
2003: \cite{vhzh03}\cite{cogu03}\cite{bigu03}\\
2004: \cite{solo04}\\
2005: \cite{bihi05}\\
...
2010: \cite{bumb10}\cite{wibh10}\cite{baiv10}\cite{bubi10}\cite{zhzl10}\cite{bill10}\cite{jabi10}\\
...
2019: \cite{mavb19}\cite{fube19}\cite{magn19}\cite{malg19}
...
2008: \cite{scbe08}\cite{gecy08}\cite{uegs08}\cite{fagc08}\cite{zgyh09}\\
2009: \cite{gefc09}\\
...
2013: \cite{lixg13}\cite{nabg13}\cite{magc13}\cite{digd13a}\cite{digd13b}\cite{zhgt13}\cite{dyge13}\cite{gemd13}\cite{mana13}\\
...
2008: \cite{sebp08}\cite{wabj08}\cite{wabj08b}\\
