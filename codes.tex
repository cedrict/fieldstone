...
2013: \cite{bacs13}\cite{bogs13a}\cite{bogs13b}\cite{jabr13}\cite{qula13}\cite{oldh13}
      ...
      \cite{kecl13}\cite{vagc13}\cite{mafv13}\\
...
2016: \cite{kobc16}\cite{magc16}\cite{fige16}\cite{mauw16}\cite{duay16}\cite{mesj16}\\
2017: \cite{mauw17}\cite{kocb17}\cite{vomc17}\\
2018: \cite{zhlg18}\\
2019: \cite{kobg19}\cite{ligc19}\cite{sihf19}\cite{meag19}\cite{gubg19}
}
