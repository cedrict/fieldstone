...
\twothousandeighteen: \cite{zhlg18}\cite{masg18}\cite{gebu18}\cite{hegv18}, Dal Zilio et al \cite{davg18}\\
\twothousandnineteen: \cite{kobg19}\cite{ligc19}\cite{sihf19}\cite{meag19}\cite{gubg19}\cite{vawg19}\cite{zhli19}\\
\twothousandtwenty: Baes et al \cite{basg20}, \cite{zhlg20}\cite{dawl20}\cite{chcg20}\cite{meag20}\cite{chlc20}\cite{mugu20}, 
                    Tang et al \cite{tacm20}, G{\"u}lcher et al \cite{gugm20}, Brizzi et al \cite{brvf20}, 
                    Peral et al \cite{perz20}, Petrini et al \cite{pegy20}, Baes et al \cite{basg20b}, D'acquisto et al \cite{dadm20}
\end{scriptsize}
