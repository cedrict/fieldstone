...
2007: \cite{geyu07}\cite{gogc07}\cite{gebu07}\cite{gogg07}\\
...
2009: \cite{gefc09}\cite{bubg09}\cite{ligt09}\cite{famg09}\\
...
\cite{buge14}\cite{gosk14}\cite{vamd14}\cite{macg14}\cite{basc14}\\
