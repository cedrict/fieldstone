...
2018: \cite{hect18}\cite{king18}\cite{kavb18}\cite{wavp18}\cite{hulz18}\cite{lizo18}\\
...
1993: \cite{keki93}\cite{kief93}\cite{leka93}\cite{lekkb93}\cite{zhgh93}\cite{zhgu93}\\
...
2006: \cite{nake06}\\
2007: \cite{nake07}\cite{dadh07}\cite{copb07}\cite{elta07}\cite{lohd07}\cite{nake07}\cite{reki07}\\
2008: \cite{hash08}\\
2009: \cite{faho09}\cite{heea09}\cite{king09}\cite{leki09}\cite{wazh09}\\
...
2015: \cite{duay15}\cite{uewg15}\cite{rula15}\cite{gesb15}\cite{rula15}\cite{kocb15}\cite{hevg15}\\
