...
Redmond \& King (2004) \cite{reki04}, Li \& Kiefer \cite{liki07}.
...
\item[\twothousandfive] \cite{grlt05}, Farnetani \& Samuel \cite{fasa05}
...
\item[\twothousandtwo] Bunge \etal \cite{burb02}, Stegman \etal \cite{strb02}
...
\item[\twothousandeight] Heidbach \etal \cite{heib08}, Shahnas \etal \cite{shlj08}
\item[\twothousandnine] \cite{phbs09}, \cite{wodd09}
                        \cite{gows09}, \cite{iabu09}
                        \cite{scbs09}, \cite{scbs09b}
                        \cite{scbr09}, \cite{oebm09}
\item[\twothousandten] Yanagisawa \etal \cite{yayh10}
\item[\twothousandeleven] Wolstencroft \& Davies \cite{woda11}, Iaffaldano \etal \cite{iahb11}
\item[\twothousandtwelve] Davies \etal \cite{dagd12}, Shepard \etal \cite{shbs12}
\item[\twothousandthirteen] Davies \etal \cite{dadb13}, O'Farrell \cite{oflb13}
...
\item[\twothousandtwentyone] Korchinski \etal \cite{kotr21}, Qi \etal \cite{qizx21},
                             Strak \& Schellart \cite{stsc21}, Zhang \etal \cite{zhzl21}
\end{itemize}
\end{scriptsize}
