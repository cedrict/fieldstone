...
\section{Subduction}
   ...
   \item [\twothousandten]  Convergent plate margin dynamics \cite{scra10} 
...
and HP/UHP exhumation of crustal rocks during continental collision \cite{bufa14}
   ...
   \item [\twothousandtwentythree] The thermal structure of subduction zones \cite{vawi23,wiva23,vawi23b}
   \end{itemize}
...
\section{Orogeny}
   ...
   \item [2025] A revisit to continental collision between India and Asia \cite{zhen25}
   \end{itemize}
...
\section{Mantle \& plates}
   ...
   \begin{itemize}
   \item [\twothousand] The relation between mantle dynamics and plate tectonics \cite{berr00} 
...
%=======================
\section{Plumes and hotspots}

   \begin{itemize}
   \item[\nineteenseventyseven] Old paper with very funny cartoons \cite{hovo77}
   \item[\twothousandfourteen] Hotspot swells \cite{kiad14}
   \item[\twothousandtwentyone] Mantle plumes and their role in Earth processes \cite{kobj21}
   \item[\twothousandtwentysix] Mantle plume-lithosphere interaction \cite{lewl26}
   \end{itemize}
...
%=========================
\section{(Exo)Planets, planetary evolution}

   \begin{itemize}
   \item[2023] Venus, the Planet: Introduction to the Evolution of Earth’s Sister Planet \cite{orwb23}
   \item[2025] Evolution of Terrestrial Planetary Bodies and Implications for Habitability \cite{casc25}
   \end{itemize}
...
\section{Rheology}
   ...
   \item [\twothousandseven] Plasticity and geophysical flows \cite{ance07}
   ...
   \item [\twothousandten] Rheology of the Earth's mantle: A historical review \cite{kara10b}
...
\section{The lithosphere}
   ...
   \item[\twothousandtwentysix] Formation and Evolution of Planetary Stagnant Lids and Crusts \cite{midl26}
   \end{itemize}

%====================================
\section{Gravity \& Geoid studies}
   \begin{itemize}
   \item[1981] Long wavelength gravity and topography anomalies \cite{wada81}
   \item[1985] The geological significance of the geoid \cite{chas85}
   \item[2006] Gravity observations and 3D structure of the Earth \cite{ricl06}
   \item[2013] A Brief Tour into the History of Gravity: From Emocritus to Einstein \cite{pamo13}
   \item[2015] Observing Global Mass Transport to Understand Global Change and to benefit society \cite{pabb15}
   \item[2017] Understandin deep earth dynamics: a numerical modelling approach \cite{siag17}
   \end{itemize}

%=========================
\section{Salt tectonics}
   \begin{itemize}
   \item[1994] Structural dynamics of salt systems \cite{javs94}
   \item[2007] Understanding salt tectonics \cite{huja07}
   \item[2011] Salt tectonics at passive margins: Geology versus models \cite{brfo11}
   \item[2023] The Role of Salt Tectonics in the Energy Transition \cite{duhp23}
   \end{itemize}
...
\section{Early Earth}
   \begin{itemize}
   \item[2014] Precambrian geodynamics: concepts and models \cite{gery14}
   \item[2022] Archean crust-mantle geodynamic regimes \cite{libs22}
   \end{itemize}
