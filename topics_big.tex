...
\item Subduction
   \begin{itemize}
   \item [\nineteeneightytwo] \fullcite{crpi82}
   \item [\nineteenninetyfive] \fullcite{kinc95}
   \item [\twothousandone] \fullcite{fuwo01}
   \item [\twothousandone] \fullcite{befa09}
   \item [\twothousandtwo] \fullcite{ster02}
   \item [\twothousandeight] \fullcite{bill08}
   \item [\twothousandnine] \fullcite{agyj09}
   \item [\twothousandnine] \fullcite{befa09}
   \item [\twothousandnine] \fullcite{fuon09}
   \item [\twothousandten]  \fullcite{bill10}
   \item [\twothousandeleven] \fullcite{gery11}
   \item [\twothousandthirteen] \fullcite{bufv13}
   \item [\twothousandfourteen] \fullcite{bufa14}
   \item [\twothousandfourteen] \fullcite{bufy14b}
   \item [\twothousandsixteen] \fullcite{zhch16}
