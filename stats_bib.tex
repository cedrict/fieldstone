...
\begin{center}
\includegraphics[width=5cm]{statistics_biblio/journal_natureJ}
\includegraphics[width=5cm]{statistics_biblio/journal_natureC}
\includegraphics[width=5cm]{statistics_biblio/journal_natureG}
\end{center}
