{\tiny \date{\today} - C.T.}
\index{angular velocity} \index{angular momentum} \index{moment of inertia}
...
\begin{equation}
{\vec H} = \int_\Omega \rho(\vec r) \, {\vec r} \times {\vec v}\; d\vec r
\end{equation}
...
\end{eqnarray}
with $det(\bm I)=I_{xx}I_{yy}I_{zz}-I_{yx}I_{xy}I_{zz}$.
