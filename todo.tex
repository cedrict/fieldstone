...
\item structural geology: 2 and 3 layer (non)linear viscous folding, a la Frehner MSc/PhD thesis and papers 
...
\item deformation around rigid particles \fullcite{ilma93}
\item crater modelling, see papers in the 80s with the MANTLE code.
\item ask student to gather all setup figures of subduction, rifting, etc ... similarities, differences... 
check availability of bc, rheology, etc ...
\end{itemize}
...
\item axisymmetric stokes benchmark \textcite{lezh10} (2010), links to \textcite{zhha03} (2003)
\item 
\end{itemize}
...
\item stream function formulation, non isoviscous. Eg \cite{sagy13}
...
\item salt tectonics wirh Ernst \cite{veja92,dacl94,vasv93,maar96,istt04,maqs06,maqs07,bakp14,feka14a}
...
\cite{haoc78,haoc81,riha84,zhon96,mohc98,zhzu00,lezh08,leha08,mofm07,mibb09,fope91,lizh13,bugo94} 
...
\item "Numerical model of crustal accretion and cooling rates of fast-spreading mid-ocean ridges". Mass conservation
(stream-function), momentum (vorticity) and temperature equations are solved in 2-D cartesian geometry 
using 2-D, alternate direction, implicit and semi-implicit finite-difference scheme.
...
\item rebuild wach25 2d citcom setup in aspect 
\end{itemize}
