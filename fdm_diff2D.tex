...
Write a function which takes $x$, $y$, $t$, $T_{max}$, $\kappa$ and $\sigma$ as argument 
...
presecribe on the boundary the analytical solution.  
...
Same exercise as exercise FDM-7, but now with implicit method.
