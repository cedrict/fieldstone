...
hence
\[
\tilde{\rho} = -\alpha \rho_0 \alpha \tilde{T}  +  K_T^{-1} \rho_0 \tilde{p}  
\]
...
Some terms then cancel in the general equations; no approximations have been made. This leads to:
...
field. We derive here the pertinent equations in the Boussinesq approximation and the
