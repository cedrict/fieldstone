...
\begin{equation}
\vec\nabla^4 = -\Ranb \frac{\partial {\color{violet}T_1}}{\partial x} 
\label{eq:md83}
\end{equation}
...
Making the remaining substitutions in \eqref{eq:md82} and \eqref{md83} leads to the
