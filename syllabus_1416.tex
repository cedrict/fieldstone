...
%----------------------------------------------------------
\subsection{The basic equations of continuum mechanics}
...
\subsubsection{The general equation of motion (momentum equation)}
...
\subsubsection{Pressure and stress}
...
\eqref{eq:md12} reduces to the hydrostatic equation
\begin{equation}
\vec\nabla p = \rho \vec{g} 
\qquad
\text{or}
...
Relation (20) demonstrates clearly that for a Newtonian fluid the difference between
...
Then, according to (20): $p = \overline{p}$. Furthermore, (17)
...
\subsubsection{Non-linear rheology} 
...
(internal friction) is due to body forces and/or applied tractions (cf. 12). In regions of
...
A constitutive equation, more detailed than (23), encompassing both power law creep and
...
Recalling the general equation of motion (12)
\[
\rho \frac{D\upnu_i}{Dt} = \rho g_i + \frac{\partial \sigma_{ij}}{\partial x_j}
\]
and the separation of
the total stress in the thermodynamic pressure and mechanical stress (13)
\[
\sigma_{ij} = -p \delta_{ij} + \tau_{ij},
\]
...
Determine its value using 4.10 19 Pas for the viscosity, 100 km thickness for the
lithosphere and for the asthenosphere and a lithosphere velocity of 5 cm/yr.
}
\end{exercise}
\end{minipage}
}
...
\subsubsection{Density perturbations as a driving force for mantle convection}
...
%...................................................................................................
\subsubsection{Two-dimensional formulation for incompressible fluids: the stream function approach}
...
\upnu_y &=&-\frac{\partial \psi}{\partial x} \nn\\
\end{eqnarray}
...
convection (this will be demonstrated later). Then, the Navier-Stokes equation (33)
reduces to:
\begin{eqnarray}
...
\subsubsection{Application of the stream function approach: Post-glacial rebound}
...
approach originally due to \textcite{hask35} (1935). This analysis will lead to a first estimate of the
...
\begin{exercise}
{\small \it 
Derive equations \eqref{eq:md46}.
}
\end{exercise}
\end{minipage}
}
...
\label{eq:md55}
\end{equation}
By substituting the Cauchy relation \eqref{eq:md2}, $t_i^n = \sigma_{ij}n_j$, 
...
Combining equations \eqref{eq:md60}, \eqref{md:eq57}, and
