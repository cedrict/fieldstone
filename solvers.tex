...
are those involving the matrix inverse (in our case the inverse of the Schur complement matrix).
We start the iterations with a guess pressure $\vec{\cal P}_0$ (and an initial guess velocity 
...
These two preconditioners and two other variants are implement in \stone 16 for 
