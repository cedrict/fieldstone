...
aside from the costs of building it explicitly using a direct solver would require {\it way}
...
Note that this algorithm is presented in \cite{zivt85} in the context of viscoplastic flow.
