...
Saddle point preconditioners have been extensively discussed and 
studied \cite{bewa08}, \cite{dewu04}
...
The same algorithm with our notations ($\SSS\cdot \vec{\cal P}=\underline{\vec{f}}$):\\
...
if $\vec{r}_{k+1}$ is sufficiently small, exit loop.\\
...
\begin{center}
\frame{\includegraphics[width=10cm]{images/solvers/saad}}
\end{center}
