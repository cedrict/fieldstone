...
Before we can write out the SIMPLE algorithm, we must first take a small detour via 
...
The iteration loop then looks like
\[
\left(
\begin{array}{c}
V^{k+1} \\ P^{k+1}
...
Finally, the SIMPLE algorithm is as follows:
\begin{itemize}
